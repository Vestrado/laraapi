...
/*eslint-disable*/
/*jshint ignore:start*/
(function(){function oa(h,m){h.prototype=db(m.prototype);h.prototype.constructor=h;h.base=m.prototype}function db(h){function m(){}m.prototype=h;return new m}function Xa(h,m,E){"millisecond"===E?h.setMilliseconds(h.getMilliseconds()+1*m):"second"===E?h.setSeconds(h.getSeconds()+1*m):"minute"===E?h.setMinutes(h.getMinutes()+1*m):"hour"===E?h.setHours(h.getHours()+1*m):"day"===E?h.setDate(h.getDate()+1*m):"week"===E?h.setDate(h.getDate()+7*m):"month"===E?h.setMonth(h.getMonth()+1*m):"year"===E&&h.setFullYear(h.getFullYear()+
1*m);return h}function ba(h,m){var E=!1;0>h&&(E=!0,h*=-1);h=""+h;for(m=m?m:1;h.length<m;)h="0"+h;return E?"-"+h:h}function Ga(h){if(!h)return h;h=h.replace(/^\s\s*/,"");for(var m=/\s/,E=h.length;m.test(h.charAt(--E)););return h.slice(0,E+1)}function Ca(h){h.roundRect=function(h,E,s,w,pa,A,B,v){B&&(this.fillStyle=B);v&&(this.strokeStyle=v);"undefined"===typeof pa&&(pa=5);this.lineWidth=A;this.beginPath();this.moveTo(h+pa,E);this.lineTo(h+s-pa,E);this.quadraticCurveTo(h+s,E,h+s,E+pa);this.lineTo(h+
s,E+w-pa);this.quadraticCurveTo(h+s,E+w,h+s-pa,E+w);this.lineTo(h+pa,E+w);this.quadraticCurveTo(h,E+w,h,E+w-pa);this.lineTo(h,E+pa);this.quadraticCurveTo(h,E,h+pa,E);this.closePath();B&&this.fill();v&&0<A&&this.stroke()}}function Ra(h,m){return h-m}function X(h){var m=((h&16711680)>>16).toString(16),E=((h&65280)>>8).toString(16);h=((h&255)>>0).toString(16);m=2>m.length?"0"+m:m;E=2>E.length?"0"+E:E;h=2>h.length?"0"+h:h;return"#"+m+E+h}function eb(h,m){var E=this.length>>>0,s=Number(m)||0,s=0>s?Math.ceil(s):
Math.floor(s);for(0>s&&(s+=E);s<E;s++)if(s in this&&this[s]===h)return s;return-1}function s(h){return null===h||"undefined"===typeof h}function Da(h){h.indexOf||(h.indexOf=eb);return h}function fb(h){if(Ha.fSDec)h[ia("`eeDwdouMhrudods")](ia("e`u`@ohl`uhnoHuds`uhnoDoe"),function(){Ha._fTWm&&Ha._fTWm(h)})}function Ya(h,m,E){E=E||"normal";var s=h+"_"+m+"_"+E,w=Za[s];if(isNaN(w)){try{if(!qa){var pa=document.body;qa=document.createElement("span");qa.innerHTML="";var A=document.createTextNode("Mpgyi");
qa.appendChild(A);pa.appendChild(qa)}qa.style.display="";V(qa,{position:"absolute",left:"0px",top:"-20000px",padding:"0px",margin:"0px",border:"none",whiteSpace:"pre",lineHeight:"normal",fontFamily:h,fontSize:m+"px",fontWeight:E});w=Math.round(qa.offsetHeight);qa.style.display="none"}catch(B){w=Math.ceil(1.1*m)}w=Math.max(w,m);Za[s]=w}return w}function J(h,m){var E=[];if(E={solid:[],shortDash:[3,1],shortDot:[1,1],shortDashDot:[3,1,1,1],shortDashDotDot:[3,1,1,1,1,1],dot:[1,2],dash:[4,2],dashDot:[4,
2,1,2],longDash:[8,2],longDashDot:[8,2,1,2],longDashDotDot:[8,2,1,2,1,2]}[h||"solid"])for(var s=0;s<E.length;s++)E[s]*=m;else E=[];return E}function P(h,m,E,w,ha){w=w||[];ha=s(ha)?gb?{passive:!1,capture:!1}:!1:ha;w.push([h,m,E,ha]);return h.addEventListener?(h.addEventListener(m,E,ha),E):h.attachEvent?(w=function(m){m=m||window.event;m.preventDefault=m.preventDefault||function(){m.returnValue=!1};m.stopPropagation=m.stopPropagation||function(){m.cancelBubble=!0};E.call(h,m)},h.attachEvent("on"+m,
...
m,E){h*=la;m*=la;h=E.getImageData(h,m,2,2).data;m=!0;for(E=0;4>E;E++)if(h[E]!==h[E+4]|h[E]!==h[E+8]|h[E]!==h[E+12]){m=!1;break}return m?h[0]<<16|h[1]<<8|h[2]:0}function ma(h,m,E){return h in m?m[h]:E[h]}function Na(h,m,E,wa){w&&ab?(wa=!s(wa)&&wa?h.getContext("2d",{willReadFrequently:!0}):h.getContext("2d"),Oa=wa.webkitBackingStorePixelRatio||wa.mozBackingStorePixelRatio||wa.msBackingStorePixelRatio||wa.oBackingStorePixelRatio||wa.backingStorePixelRatio||1,la=Sa/Oa,h.width=m*la,h.height=E*la,Sa!==
Oa&&(h.style.width=m+"px",h.style.height=E+"px",wa.scale(la,la))):(h.width=m,h.height=E)}function ib(h){if(!jb){var m=!1,E=!1;"undefined"===typeof ta.Chart.creditHref?(h.creditHref=ia("iuuqr;..b`ow`rkr/bnl."),h.creditText=ia("B`ow`rKR/bnl")):(m=h.updateOption("creditText"),E=h.updateOption("creditHref"));if(h.creditHref&&h.creditText){h._creditLink||(h._creditLink=document.createElement("a"),h._creditLink.setAttribute("class","canvasjs-chart-credit"),h._creditLink.setAttribute("title","JavaScript Charts"),
...
h._canvasJSContainer.appendChild(h._creditLink),h._creditLink.style.top=h.height-14+"px"):h._creditLink.parentElement&&h._canvasJSContainer.removeChild(h._creditLink)}}}function ua(h,m,E){Ia&&(this.canvasCount|=0,window.console.log(++this.canvasCount));var s=document.createElement("canvas");s.setAttribute("class","canvasjs-chart-canvas");Na(s,h,m,E);w||"undefined"===typeof G_vmlCanvasManager||G_vmlCanvasManager.initElement(s);return s}function V(h,m){for(var s in m)h.style[s]=m[s]}function ra(h,m,
s){m.getAttribute("state")||(m.style.backgroundColor=h.toolbar.itemBackgroundColor,m.style.color=h.toolbar.fontColor,m.style.border="none",V(m,{WebkitUserSelect:"none",MozUserSelect:"none",msUserSelect:"none",userSelect:"none"}));m.getAttribute("state")!==s&&(m.setAttribute("state",s),m.setAttribute("type","button"),V(m,{padding:"5px 12px",cursor:"pointer","float":"left",width:"40px",height:"25px",outline:"0px",verticalAlign:"baseline",lineHeight:"0"}),m.innerHTML="<img src='"+kb[s].image+"' alt='"+
h._cultureInfo[s+"Text"]+"' />",V(m.childNodes[0],{height:"95%",pointerEvents:"none"}));m.setAttribute("title",h._cultureInfo[s+"Text"])}function Ma(){for(var h=null,m=0;m<arguments.length;m++)h=arguments[m],h.style&&(h.style.display="inline")}function va(){for(var h=null,m=0;m<arguments.length;m++)(h=arguments[m])&&h.style&&(h.style.display="none")}function Ta(h,m,s,w,ha){if(null===h||"undefined"===typeof h)return"undefined"===typeof s?m:s;h=parseFloat(h.toString())*(0<=h.toString().indexOf("%")?
m/100:1);"undefined"!==typeof w&&(h=Math.min(w,h),"undefined"!==typeof ha&&(h=Math.max(ha,h)));return!isNaN(h)&&h<=m&&0<=h?h:"undefined"===typeof s?m:s}function G(h,m,E,w,ha){this._defaultsKey=h;this._themeOptionsKey=m;this._index=w;this.parent=ha;this._eventListeners=[];h={};this.theme&&s(this.parent)&&s(m)&&s(w)?h=s(this.predefinedThemes[this.theme])?this.predefinedThemes.light1:this.predefinedThemes[this.theme]:this.parent&&(this.parent.themeOptions&&this.parent.themeOptions[m])&&(null===w?h=this.parent.themeOptions[m]:
0<this.parent.themeOptions[m].length&&(w=Math.min(this.parent.themeOptions[m].length-1,w),h=this.parent.themeOptions[m][w]));this.themeOptions=h;this.options=E?E:{_isPlaceholder:!0};this.setOptions(this.options,h)}function Ea(h,m,s,w,ha){"undefined"===typeof ha&&(ha=0);this._padding=ha;this._x1=h;this._y1=m;this._x2=s;this._y2=w;this._rightOccupied=this._leftOccupied=this._bottomOccupied=this._topOccupied=this._padding}function ja(h,m){ja.base.constructor.call(this,"TextBlock",null,m,null,null);this.ctx=
h;this._isDirty=!0;this._wrappedText=null;this._initialize()}function Ua(h,m){Ua.base.constructor.call(this,"Toolbar","toolbar",m,null,h);this.chart=h;this.canvas=h.canvas;this.ctx=this.chart.ctx;this.optionsName="toolbar"}function ya(h,m){ya.base.constructor.call(this,"Title","title",m,null,h);this.chart=h;this.canvas=h.canvas;this.ctx=this.chart.ctx;this.optionsName="title";if(s(this.options.margin)&&h.options.subtitles)for(var E=h.options.subtitles,w=0;w<E.length;w++)if((s(E[w].horizontalAlign)&&
"center"===this.horizontalAlign||E[w].horizontalAlign===this.horizontalAlign)&&(s(E[w].verticalAlign)&&"top"===this.verticalAlign||E[w].verticalAlign===this.verticalAlign)&&!E[w].dockInsidePlotArea===!this.dockInsidePlotArea){this.margin=0;break}"undefined"===typeof this.options.fontSize&&(this.fontSize=this.chart.getAutoFontSize(this.fontSize));this.height=this.width=null;this.bounds={x1:null,y1:null,x2:null,y2:null}}function Ja(h,m,s){Ja.base.constructor.call(this,"Subtitle","subtitles",m,s,h);
this.chart=h;this.canvas=h.canvas;this.ctx=this.chart.ctx;this.optionsName="subtitles";this.isOptionsInArray=!0;"undefined"===typeof this.options.fontSize&&(this.fontSize=this.chart.getAutoFontSize(this.fontSize));this.height=this.width=null;this.bounds={x1:null,y1:null,x2:null,y2:null}}function Va(){this.pool=[]}function Ka(h){var m;h&&La[h]&&(m=La[h]);Ka.base.constructor.call(this,"CultureInfo",null,m,null,null)}var Ia=!1,Ha={},w=!!document.createElement("canvas").getContext,ta={Chart:{width:500,
...
gb=function(){var h=!1;try{var m=Object.defineProperty&&Object.defineProperty({},"passive",{get:function(){h=!0;return!1}});window.addEventListener&&(window.addEventListener("test",null,m),window.removeEventListener("test",null,m))}catch(s){h=!1}return h}(),Za={},qa=null,lb=function(){this.ctx.clearRect(0,0,this.width,this.height);this.backgroundColor&&(this.ctx.fillStyle=this.backgroundColor,this.ctx.fillRect(0,0,this.width,this.height))},xa=function(h){h.width=1;h.height=1;h.getContext("2d")&&h.getContext("2d").clearRect(0,
0,1,1)},mb=function(h,m,s){m=Math.min(this.width,this.height);return Math.max("theme4"===this.theme?0:300<=m?12:11,Math.round(m*(h/400)))},Aa=function(){var h=/D{1,4}|M{1,4}|Y{1,4}|h{1,2}|H{1,2}|m{1,2}|s{1,2}|f{1,3}|t{1,2}|T{1,2}|K|z{1,3}|"[^"]*"|'[^']*'/g,m="Sunday Monday Tuesday Wednesday Thursday Friday Saturday".split(" "),s="Sun Mon Tue Wed Thu Fri Sat".split(" "),w="January February March April May June July August September October November December".split(" "),ha="Jan Feb Mar Apr May Jun Jul Aug Sep Oct Nov Dec".split(" "),
B=/\b(?:[PMCEA][SDP]T|(?:Pacific|Mountain|Central|Eastern|Atlantic) (?:Standard|Daylight|Prevailing) Time|(?:GMT|UTC)(?:[-+]\d{4})?)\b/g,A=/[^-+\dA-Z]/g;return function(v,J,O){var K=O?O.days:m,X=O?O.months:w,P=O?O.shortDays:s,T=O?O.shortMonths:ha;O="";var V=!1;v=v&&v.getTime?v:v?new Date(v):new Date;if(isNaN(v))throw SyntaxError("invalid date");"UTC:"===J.slice(0,4)&&(J=J.slice(4),V=!0);O=V?"getUTC":"get";var G=v[O+"Date"](),M=v[O+"Day"](),W=v[O+"Month"](),a=v[O+"FullYear"](),d=v[O+"Hours"](),c=v[O+
"Minutes"](),b=v[O+"Seconds"](),e=v[O+"Milliseconds"](),f=V?0:v.getTimezoneOffset();return O=J.replace(h,function(l){switch(l){case "D":return G;case "DD":return ba(G,2);case "DDD":return P[M];case "DDDD":return K[M];case "M":return W+1;case "MM":return ba(W+1,2);case "MMM":return T[W];case "MMMM":return X[W];case "Y":return parseInt(String(a).slice(-2));case "YY":return ba(String(a).slice(-2),2);case "YYY":return ba(String(a).slice(-3),3);case "YYYY":return ba(a,4);case "h":return d%12||12;case "hh":return ba(d%
...
60);case "zz":return(0<f?"-":"+")+ba(Math.floor(Math.abs(f)/60),2);case "zzz":return(0<f?"-":"+")+ba(Math.floor(Math.abs(f)/60),2)+ba(Math.abs(f)%60,2);default:return l.slice(1,l.length-1)}})}}(),nb=function(h){var m=0>h;if(1>Math.abs(h)){var s=parseInt(h.toString().split("e-")[1]);s&&(h=(m?-1*h:h)*Math.pow(10,s-1),h="0."+Array(s).join("0")+h.toString().substring(2),h=m?"-"+h:h)}else s=parseInt(h.toString().split("+")[1]),20<s&&(s-=20,h/=Math.pow(10,s),h=h.toString()+Array(s+1).join("0"));return String(h)},
ca=function(h,m,s){if(null===h)return"";if(!isFinite(h))return h;h=Number(h);var w=0>h?!0:!1;w&&(h*=-1);var B=s?s.decimalSeparator:".",v=s?s.digitGroupSeparator:",",A="";m=String(m);var A=1,J=s="",K=-1,O=[],X=[],P=0,T=0,V=0,G=!1,Q=0,J=m.match(/"[^"]*"|'[^']*'|[eE][+-]*[0]+|[,]+[.]|\u2030|./g);m=null;for(var M=0;J&&M<J.length;M++)if(m=J[M],"."===m&&0>K)K=M;else{if("%"===m)A*=100;else if("\u2030"===m){A*=1E3;continue}else if(","===m[0]&&"."===m[m.length-1]){A/=Math.pow(1E3,m.length-1);K=M+m.length-
1;continue}else"E"!==m[0]&&"e"!==m[0]||"0"!==m[m.length-1]||(G=!0);0>K?(O.push(m),"#"===m||"0"===m?P++:","===m&&V++):(X.push(m),"#"!==m&&"0"!==m||T++)}G&&(m=Math.floor(h),J=-Math.floor(Math.log(h)/Math.LN10+1),Q=0===h?0:0===m?-(P+J):nb(m).length-P,A/=Math.pow(10,Q));0>K&&(K=M);A=(h*A).toFixed(T);m=A.split(".");A=(m[0]+"").split("");h=(m[1]+"").split("");A&&"0"===A[0]&&A.shift();for(G=J=M=T=K=0;0<O.length;)if(m=O.pop(),"#"===m||"0"===m)if(K++,K===P){var W=A,A=[];if("0"===m)for(m=P-T-(W?W.length:0);0<
m;)W.unshift("0"),m--;for(;0<W.length;)s=W.pop()+s,G++,0===G%J&&(M===V&&0<W.length)&&(s=v+s)}else 0<A.length?(s=A.pop()+s,T++,G++):"0"===m&&(s="0"+s,T++,G++),0===G%J&&(M===V&&0<A.length)&&(s=v+s);else"E"!==m[0]&&"e"!==m[0]||"0"!==m[m.length-1]||!/[eE][+-]*[0]+/.test(m)?","===m?(M++,J=G,G=0,0<A.length&&(s=v+s)):s=1<m.length&&('"'===m[0]&&'"'===m[m.length-1]||"'"===m[0]&&"'"===m[m.length-1])?m.slice(1,m.length-1)+s:m+s:(m=0>Q?m.replace("+","").replace("-",""):m.replace("-",""),s+=m.replace(/[0]+/,function(a){return ba(Q,
a.length)}));v="";for(O=!1;0<X.length;)m=X.shift(),"#"===m||"0"===m?0<h.length&&0!==Number(h.join(""))?(v+=h.shift(),O=!0):"0"===m&&(v+="0",O=!0):1<m.length&&('"'===m[0]&&'"'===m[m.length-1]||"'"===m[0]&&"'"===m[m.length-1])?v+=m.slice(1,m.length-1):"E"!==m[0]&&"e"!==m[0]||"0"!==m[m.length-1]||!/[eE][+-]*[0]+/.test(m)?v+=m:(m=0>Q?m.replace("+","").replace("-",""):m.replace("-",""),v+=m.replace(/[0]+/,function(a){return ba(Q,a.length)}));s+=(O?B:"")+v;return w?"-"+s:s},Pa=function(h){var m=0,s=0;h=
h||window.event;h.offsetX||0===h.offsetX?(m=h.offsetX,s=h.offsetY):h.layerX||0==h.layerX?(m=h.layerX,s=h.layerY):(m=h.pageX-h.target.offsetLeft,s=h.pageY-h.target.offsetTop);return{x:m,y:s}},ab=!0,Sa=window.devicePixelRatio||1,Oa=1,la=ab?Sa/Oa:1,Y=function(h,m,s,w,v,B,A,J,K,O,X,T,P){"undefined"===typeof P&&(P=1);A=A||0;J=J||"black";var G=15<w-m&&15<v-s?8:0.35*Math.min(w-m,v-s);h.beginPath();h.moveTo(m,s);h.save();h.fillStyle=B;h.globalAlpha=P;h.fillRect(m,s,w-m,v-s);h.globalAlpha=1;0<A&&(P=0===A%
2?0:0.5,h.beginPath(),h.lineWidth=A,h.strokeStyle=J,h.moveTo(m,s),h.rect(m-P,s-P,w-m+2*P,v-s+2*P),h.stroke());h.restore();!0===K&&(h.save(),h.beginPath(),h.moveTo(m,s),h.lineTo(m+G,s+G),h.lineTo(w-G,s+G),h.lineTo(w,s),h.closePath(),A=h.createLinearGradient((w+m)/2,s+G,(w+m)/2,s),A.addColorStop(0,B),A.addColorStop(1,"rgba(255, 255, 255, .4)"),h.fillStyle=A,h.fill(),h.restore());!0===O&&(h.save(),h.beginPath(),h.moveTo(m,v),h.lineTo(m+G,v-G),h.lineTo(w-G,v-G),h.lineTo(w,v),h.closePath(),A=h.createLinearGradient((w+
m)/2,v-G,(w+m)/2,v),A.addColorStop(0,B),A.addColorStop(1,"rgba(255, 255, 255, .4)"),h.fillStyle=A,h.fill(),h.restore());!0===X&&(h.save(),h.beginPath(),h.moveTo(m,s),h.lineTo(m+G,s+G),h.lineTo(m+G,v-G),h.lineTo(m,v),h.closePath(),A=h.createLinearGradient(m+G,(v+s)/2,m,(v+s)/2),A.addColorStop(0,B),A.addColorStop(1,"rgba(255, 255, 255, 0.1)"),h.fillStyle=A,h.fill(),h.restore());!0===T&&(h.save(),h.beginPath(),h.moveTo(w,s),h.lineTo(w-G,s+G),h.lineTo(w-G,v-G),h.lineTo(w,v),A=h.createLinearGradient(w-
G,(v+s)/2,w,(v+s)/2),A.addColorStop(0,B),A.addColorStop(1,"rgba(255, 255, 255, 0.1)"),h.fillStyle=A,A.addColorStop(0,B),A.addColorStop(1,"rgba(255, 255, 255, 0.1)"),h.fillStyle=A,h.fill(),h.closePath(),h.restore())},ia=function(h){for(var m="",s=0;s<h.length;s++)m+=String.fromCharCode(Math.ceil(h.length/57/5)^h.charCodeAt(s));return m},jb=window&&(window[ia("mnb`uhno")]&&window[ia("mnb`uhno")].href&&window[ia("mnb`uhno")].href.indexOf&&(-1!==window[ia("mnb`uhno")].href.indexOf(ia("b`ow`rkr/bnl"))||
...
G.prototype.setOptions=function(h,m){if(ta[this._defaultsKey]){var s=ta[this._defaultsKey],w;for(w in s)"publicProperties"!==w&&s.hasOwnProperty(w)&&(this[w]=h&&w in h?h[w]:m&&w in m?m[w]:s[w])}else Ia&&window.console&&console.log("defaults not set")};G.prototype.get=function(h){var m=ta[this._defaultsKey];if("options"===h)return this.options&&this.options._isPlaceholder?null:this.options;if(m.hasOwnProperty(h)||m.publicProperties&&m.publicProperties.hasOwnProperty(h))return this[h];window.console&&
window.console.log('Property "'+h+"\" doesn't exist. Please check for typo.")};G.prototype.set=function(h,m,s){s="undefined"===typeof s?!0:s;var w=ta[this._defaultsKey];if("options"===h)this.createUserOptions(m);else if(w.hasOwnProperty(h)||w.publicProperties&&w.publicProperties.hasOwnProperty(h)&&"readWrite"===w.publicProperties[h])this.options._isPlaceholder&&this.createUserOptions(),this.options[h]=m;else{window.console&&(w.publicProperties&&w.publicProperties.hasOwnProperty(h)&&"readOnly"===w.publicProperties[h]?
window.console.log('Property "'+h+'" is read-only.'):window.console.log('Property "'+h+"\" doesn't exist. Please check for typo."));return}s&&(this.stockChart||this.chart||this).render()};G.prototype.addTo=function(h,m,s,w){w="undefined"===typeof w?!0:w;var v=ta[this._defaultsKey];v.hasOwnProperty(h)||v.publicProperties&&v.publicProperties.hasOwnProperty(h)&&"readWrite"===v.publicProperties[h]?(this.options._isPlaceholder&&this.createUserOptions(),"undefined"===typeof this.options[h]&&(this.options[h]=
...
m=s):m=void 0,h[m]=this.options};G.prototype.remove=function(h){h="undefined"===typeof h?!0:h;if(this.isOptionsInArray){var m=this.parent.options[this.optionsName];Da(m);var s=m.indexOf(this.options);0<=s&&m.splice(s,1)}else delete this.parent.options[this.optionsName];h&&(this.stockChart||this.chart||this).render()};G.prototype.updateOption=function(h){!ta[this._defaultsKey]&&(Ia&&window.console)&&console.log("defaults not set");var m=ta[this._defaultsKey],w={},v=this[h],B=this._themeOptionsKey,
...
this._eventListeners[h]||[],this._eventListeners[h].push({context:s||this,eventHandler:m}))};G.prototype.removeEventListener=function(h,m){if(h&&m&&this._eventListeners[h])for(var s=this._eventListeners[h],w=0;w<s.length;w++)if(s[w].eventHandler===m){s[w].splice(w,1);break}};G.prototype.removeAllEventListeners=function(){this._eventListeners=[]};G.prototype.dispatchEvent=function(h,m,s){if(h&&this._eventListeners[h]){m=m||{};for(var w=this._eventListeners[h],v=0;v<w.length;v++)w[v].eventHandler.call(w[v].context,
...
this.rightPadding=this.bottomPadding=this.leftPadding=Number(this.padding)|0:(this.topPadding=s(this.padding.top)?0:Number(this.padding.top)|0,this.rightPadding=s(this.padding.right)?0:Number(this.padding.right)|0,this.bottomPadding=s(this.padding.bottom)?0:Number(this.padding.bottom)|0,this.leftPadding=s(this.padding.left)?0:Number(this.padding.left)|0)};ja.prototype.render=function(h){if(0!==this.fontSize){h&&this.ctx.save();var m=this.ctx.font;this.ctx.textBaseline=this.textBaseline;var s=0;this._isDirty&&
this.measureText(this.ctx);this.ctx.translate(this.x,this.y+s);"middle"===this.textBaseline&&(s=-this._lineHeight/2);this.ctx.font=this._getFontString();this.ctx.rotate(Math.PI/180*this.angle);var w=0,v=this.topPadding,B=null;this.ctx.roundRect||Ca(this.ctx);(0<this.borderThickness&&this.borderColor||this.backgroundColor)&&this.ctx.roundRect(0,s,this.width,this.height,this.cornerRadius,this.borderThickness,this.backgroundColor,this.borderColor);this.ctx.fillStyle=this.fontColor;for(s=0;s<this._wrappedText.lines.length;s++){B=
...
null};ja.prototype.measureText=function(){this._lineHeight=Ya(this.fontFamily,this.fontSize,this.fontWeight);if(null===this.maxWidth)throw"Please set maxWidth and height for TextBlock";this._wrapText(this.ctx);this._isDirty=!1;return{width:this.width,height:this.height}};ja.prototype._getLineWithWidth=function(h,m,s){h=String(h);if(!h)return{text:"",width:0};var w=s=0,v=h.length-1,B=Infinity;for(this.ctx.font=this._getFontString();w<=v;){var B=Math.floor((w+v)/2),A=h.substr(0,B+1);s=this.ctx.measureText(A).width;
if(s<m)w=B+1;else if(s>m)v=B-1;else break}s>m&&1<A.length&&(A=A.substr(0,A.length-1),s=this.ctx.measureText(A).width);m=!0;if(A.length===h.length||" "===h[A.length])m=!1;m&&(h=A.split(" "),1<h.length&&h.pop(),A=h.join(" "),s=this.ctx.measureText(A).width);return{text:A,width:s}};ja.prototype._wrapText=function(){var h=new String(Ga(String(this.text))),s=[],w=this.ctx.font,v=0,B=0;this.ctx.font=this._getFontString();if(0===this.frontSize)B=v=0;else for(;0<h.length;){var J=this.maxHeight-(this.topPadding+
this.bottomPadding),A=this._getLineWithWidth(h,this.maxWidth-(this.leftPadding+this.rightPadding),!1);A.height=this._lineHeight;s.push(A);var G=B,B=Math.max(B,A.width),v=v+A.height,h=Ga(h.slice(A.text.length,h.length));J&&v>J&&(A=s.pop(),v-=A.height,B=G)}this._wrappedText={lines:s,width:B,height:v};this.width=B+(this.leftPadding+this.rightPadding);this.height=v+(this.topPadding+this.bottomPadding);this.ctx.font=w};ja.prototype._getFontString=function(){var h;h=""+(this.fontStyle?this.fontStyle+" ":
"");h+=this.fontWeight?this.fontWeight+" ":"";h+=this.fontSize?this.fontSize+"px ":"";var s=this.fontFamily?this.fontFamily+"":"";!w&&s&&(s=s.split(",")[0],"'"!==s[0]&&'"'!==s[0]&&(s="'"+s+"'"));return h+=s};oa(Ua,G);oa(ya,G);ya.prototype.setLayout=function(){if(this.text){var h=this.dockInsidePlotArea?this.chart.plotArea:this.chart,m=h.layoutManager.getFreeSpace(),w=m.x1,v=m.y1,B=0,J=0,A=this.chart._menuButton&&this.chart.exportEnabled&&"top"===this.verticalAlign?22:0,G,K;"top"===this.verticalAlign||
"bottom"===this.verticalAlign?(null===this.maxWidth&&(this.maxWidth=m.width-4-A*("center"===this.horizontalAlign?2:1)),J=0.5*m.height-this.margin-2,B=0):"center"===this.verticalAlign&&("left"===this.horizontalAlign||"right"===this.horizontalAlign?(null===this.maxWidth&&(this.maxWidth=m.height-4),J=0.5*m.width-this.margin-2):"center"===this.horizontalAlign&&(null===this.maxWidth&&(this.maxWidth=m.width-4),J=0.5*m.height-4));var O;s(this.padding)||"number"!==typeof this.padding?s(this.padding)||"object"!==
...
Va.prototype.get=function(h,s){var w=null;0<this.pool.length?(w=this.pool.pop(),Na(w,h,s)):w=ua(h,s);return w};Va.prototype.release=function(h){this.pool.push(h)};oa(Ka,G);var Qa={addTheme:function(h,s){cb[h]=s},addColorSet:function(h,s){za[h]=s},addCultureInfo:function(h,s){La[h]=s},formatNumber:function(h,s,w){w=w||"en";if(La[w])return ca(h,s||"#,##0.##",new Ka(w));throw"Unknown Culture Name";},formatDate:function(h,s,w){w=w||"en";if(La[w])return Aa(h,s||"DD MMM YYYY",new Ka(w));throw"Unknown Culture Name";
}};"undefined"!==typeof module&&"undefined"!==typeof module.exports?module.exports=Qa:"function"===typeof define&&define.amd?define([],function(){return Qa}):(window.CanvasJS&&window.console&&window.console.log("CanvasJS namespace already exists. If you are loading both chart and stockchart scripts, just load stockchart alone as it includes all chart features."),window.CanvasJS=window.CanvasJS?window.CanvasJS:Qa);B=Qa.Chart=function(){function h(a,d){return a.x-d.x}function m(a,d,c){d=d||{};s(c)?
...
this.allDOMEventHandlers),this.toolTip=new U(this,this.options.toolTip),this.data=null,this.axisX=[],this.axisX2=[],this.axisY=[],this.axisY2=[],this.sessionVariables={axisX:[],axisX2:[],axisY:[],axisY2:[]})):window.console&&window.console.log('CanvasJS Error: Chart Container with id "'+this._containerId+'" was not found')}function v(a,d){for(var c=[],b,e=0;e<a.length;e++)if(0==e)c.push(a[0]);else{var f,l,u;u=e-1;f=0===u?0:u-1;l=u===a.length-1?u:u+1;b=Math.abs((a[l].x-a[f].x)/(0===a[l].x-a[u].x?0.01:
a[l].x-a[u].x))*(d-1)/2+1;var D=(a[l].x-a[f].x)/b;b=(a[l].y-a[f].y)/b;c[c.length]=a[u].x>a[f].x&&0<D||a[u].x<a[f].x&&0>D?{x:a[u].x+D/3,y:a[u].y+b/3}:{x:a[u].x,y:a[u].y+b/9};u=e;f=0===u?0:u-1;l=u===a.length-1?u:u+1;b=Math.abs((a[l].x-a[f].x)/(0===a[u].x-a[f].x?0.01:a[u].x-a[f].x))*(d-1)/2+1;D=(a[l].x-a[f].x)/b;b=(a[l].y-a[f].y)/b;c[c.length]=a[u].x>a[f].x&&0<D||a[u].x<a[f].x&&0>D?{x:a[u].x-D/3,y:a[u].y-b/3}:{x:a[u].x,y:a[u].y-b/9};c[c.length]=a[e]}return c}function B(a,d,c,b,e,f,l,u,D,k){var n=0;k?
(l.color=f,u.color=f):k=1;n=D?Math.abs(e-c):Math.abs(b-d);n=0<l.trimLength?Math.abs(n*l.trimLength/100):Math.abs(n-l.length);D?(c+=n/2,e-=n/2):(d+=n/2,b-=n/2);var n=1===Math.round(l.thickness)%2?0.5:0,p=1===Math.round(u.thickness)%2?0.5:0;a.save();a.globalAlpha=k;a.strokeStyle=u.color||f;a.lineWidth=u.thickness||2;a.setLineDash&&a.setLineDash(J(u.dashType,u.thickness));a.beginPath();D&&0<u.thickness?(a.moveTo(b-l.thickness/2,Math.round((c+e)/2)-p),a.lineTo(d+l.thickness/2,Math.round((c+e)/2)-p)):
0<u.thickness&&(a.moveTo(Math.round((d+b)/2)-p,c+l.thickness/2),a.lineTo(Math.round((d+b)/2)-p,e-l.thickness/2));a.stroke();a.strokeStyle=l.color||f;a.lineWidth=l.thickness||2;a.setLineDash&&a.setLineDash(J(l.dashType,l.thickness));a.beginPath();D&&0<l.thickness?(a.moveTo(b-n,c),a.lineTo(b-n,e),a.moveTo(d+n,c),a.lineTo(d+n,e)):0<l.thickness&&(a.moveTo(d,c+n),a.lineTo(b,c+n),a.moveTo(d,e-n),a.lineTo(b,e-n));a.stroke();a.restore()}function K(a,d){K.base.constructor.call(this,"Legend","legend",d,null,
...
this._eventManager.reset();this.plotInfo={axisPlacement:null,plotTypes:[]};this.layoutManager=new Ea(0,0,this.width,this.height,this.isNavigator?0:2);this.plotArea.layoutManager&&this.plotArea.layoutManager.reset();this.data=[];this.title=null;this.subtitles=[];var a=0,d=null;if(this.options.data){for(var c=0;c<this.options.data.length;c++)if(a++,!this.options.data[c].type||0<=m._supportedChartTypes.indexOf(this.options.data[c].type)){var b=new Q(this,this.options.data[c],a-1,++this._eventManager.lastObjectId);
...
this._preRenderCanvas.getContext("2d");"normal"!==this.plotInfo.axisPlacement&&"xySwapped"!==this.plotInfo.axisPlacement||A.setLayout(this.axisX,this.axisX2,this.axisY,this.axisY2,this.plotInfo.axisPlacement,this.layoutManager.getFreeSpace())};m.prototype.renderElements=function(){if(this.height){var a=this._plotAreaElements;this.title&&!this.title.dockInsidePlotArea&&this.title.render();for(var d=0;d<this.subtitles.length;d++)this.subtitles[d].dockInsidePlotArea||this.subtitles[d].render();this.legend.dockInsidePlotArea||
...
D){if(a.axisX.logarithmic){var r=b/u.dataPoints[D-1].x;1>r&&(r=1/r);c.minDiff>r&&1!==r&&(c.minDiff=r)}else r=b-u.dataPoints[D-1].x,0>r&&(r*=-1),c.minDiff>r&&0!==r&&(c.minDiff=r);null!==e&&null!==u.dataPoints[D-1].y&&(a.axisY.logarithmic?(r=e/u.dataPoints[D-1].y,1>r&&(r=1/r),d.minDiff>r&&1!==r&&(d.minDiff=r)):(r=e-u.dataPoints[D-1].y,0>r&&(r*=-1),d.minDiff>r&&0!==r&&(d.minDiff=r)))}if(b<q&&!k)null!==e&&(p=b);else{if(!k&&(k=!0,0<D)){D-=2;continue}if(b>g&&!n)n=!0;else if(b>g&&n)continue;u.dataPoints[D].label&&
(a.axisX.labels[b]=u.dataPoints[D].label);b<c.viewPortMin&&(c.viewPortMin=b);b>c.viewPortMax&&(c.viewPortMax=b);null===e?c.viewPortMin===b&&p<b&&(c.viewPortMin=p):(e<d.viewPortMin&&"number"===typeof e&&(d.viewPortMin=e),e>d.viewPortMax&&"number"===typeof e&&(d.viewPortMax=e))}}u.axisX.valueType=u.xValueType=f?"dateTime":"number"}};m.prototype._processStackedPlotUnit=function(a){if(a.dataSeriesIndexes&&!(1>a.dataSeriesIndexes.length)){for(var d=a.axisY.dataInfo,c=a.axisX.dataInfo,b,e,f=!1,l=[],u=[],
D=Infinity,k=-Infinity,n=0;n<a.dataSeriesIndexes.length;n++){var p=this.data[a.dataSeriesIndexes[n]],q=0,g=!1,r=!1,h;if("normal"===p.axisPlacement||"xySwapped"===p.axisPlacement)var da=a.axisX.sessionVariables.newViewportMinimum?a.axisX.sessionVariables.newViewportMinimum:a.axisX.options&&a.axisX.options.viewportMinimum?a.axisX.options.viewportMinimum:a.axisX.options&&a.axisX.options.minimum?a.axisX.options.minimum:-Infinity,t=a.axisX.sessionVariables.newViewportMaximum?a.axisX.sessionVariables.newViewportMaximum:
...
!r)r=!0;else if(b>t&&r)continue;p.dataPoints[q].label&&(a.axisX.labels[b]=p.dataPoints[q].label);b<c.viewPortMin&&(c.viewPortMin=b);b>c.viewPortMax&&(c.viewPortMax=b);null===p.dataPoints[q].y?c.viewPortMin===b&&h<b&&(c.viewPortMin=h):(a.yTotals[b]=(a.yTotals[b]?a.yTotals[b]:0)+e,a.yAbsTotals[b]=(a.yAbsTotals[b]?a.yAbsTotals[b]:0)+Math.abs(e),0<=e?l[b]?l[b]+=e:(l[b]=e,D=Math.min(e,D)):u[b]?u[b]+=e:(u[b]=e,k=Math.max(e,k)))}}a.axisY.scaleBreaks&&(a.axisY.scaleBreaks.autoCalculate&&1<=a.axisY.scaleBreaks.maxNumberOfAutoBreaks)&&
(d.dataPointYPositiveSums?(d.dataPointYPositiveSums.push.apply(d.dataPointYPositiveSums,l),d.dataPointYNegativeSums.push.apply(d.dataPointYPositiveSums,u)):(d.dataPointYPositiveSums=l,d.dataPointYNegativeSums=u));p.axisX.valueType=p.xValueType=f?"dateTime":"number"}for(q in l)l.hasOwnProperty(q)&&!isNaN(q)&&(a=l[q],a<d.min&&(d.min=Math.min(a,D)),a>d.max&&(d.max=a),q<c.viewPortMin||q>c.viewPortMax||(a<d.viewPortMin&&(d.viewPortMin=Math.min(a,D)),a>d.viewPortMax&&(d.viewPortMax=a)));for(q in u)u.hasOwnProperty(q)&&
!isNaN(q)&&(a=u[q],a<d.min&&(d.min=a),a>d.max&&(d.max=Math.max(a,k)),q<c.viewPortMin||q>c.viewPortMax||(a<d.viewPortMin&&(d.viewPortMin=a),a>d.viewPortMax&&(d.viewPortMax=Math.max(a,k))))}};m.prototype._processStacked100PlotUnit=function(a){if(a.dataSeriesIndexes&&!(1>a.dataSeriesIndexes.length)){for(var d=a.axisY.dataInfo,c=a.axisX.dataInfo,b,e,f=!1,l=!1,u=!1,D=[],k=0;k<a.dataSeriesIndexes.length;k++){var n=this.data[a.dataSeriesIndexes[k]],p=0,q=!1,g=!1,r;if("normal"===n.axisPlacement||"xySwapped"===
...
1].x,0>t&&(t*=-1),c.minDiff>t&&0!==t&&(c.minDiff=t);s(e)||null===n.dataPoints[p-1].y||(a.axisY.logarithmic?0<e&&(t=e/n.dataPoints[p-1].y,1>t&&(t=1/t),d.minDiff>t&&1!==t&&(d.minDiff=t)):(t=e-n.dataPoints[p-1].y,0>t&&(t*=-1),d.minDiff>t&&0!==t&&(d.minDiff=t)))}if(b<h&&!q)null!==e&&(r=b);else{if(!q&&(q=!0,0<p)){p-=2;continue}if(b>da&&!g)g=!0;else if(b>da&&g)continue;n.dataPoints[p].label&&(a.axisX.labels[b]=n.dataPoints[p].label);b<c.viewPortMin&&(c.viewPortMin=b);b>c.viewPortMax&&(c.viewPortMax=b);
null===e?c.viewPortMin===b&&r<b&&(c.viewPortMin=r):(a.yTotals[b]=(a.yTotals[b]?a.yTotals[b]:0)+e,a.yAbsTotals[b]=(a.yAbsTotals[b]?a.yAbsTotals[b]:0)+Math.abs(e),0<=e?l=!0:0>e&&(u=!0),D[b]=D[b]?D[b]+Math.abs(e):Math.abs(e))}}n.axisX.valueType=n.xValueType=f?"dateTime":"number"}a.axisY.logarithmic?(d.max=s(d.viewPortMax)?99*Math.pow(a.axisY.logarithmBase,-0.05):Math.max(d.viewPortMax,99*Math.pow(a.axisY.logarithmBase,-0.05)),d.min=s(d.viewPortMin)?1:Math.min(d.viewPortMin,1)):l&&!u?(d.max=s(d.viewPortMax)?
...
c=a.axisX.dataInfo,b,e,f,l,u=!1,D=0;D<a.dataSeriesIndexes.length;D++){var k=this.data[a.dataSeriesIndexes[D]],n=0,p=!1,q=!1,g,r,h;if("normal"===k.axisPlacement||"xySwapped"===k.axisPlacement)var s=a.axisX.sessionVariables.newViewportMinimum?a.axisX.sessionVariables.newViewportMinimum:a.axisX.options&&a.axisX.options.viewportMinimum?a.axisX.options.viewportMinimum:a.axisX.options&&a.axisX.options.minimum?a.axisX.options.minimum:a.axisX.logarithmic?0:-Infinity,t=a.axisX.sessionVariables.newViewportMaximum?
...
e.length){f=Math.min.apply(null,e);l=Math.max.apply(null,e);r=!0;for(var x=0;x<e.length;x++)null===e.k&&(r=!1);r&&(p||(h=g),g=b)}b<c.min&&(c.min=b);b>c.max&&(c.max=b);f<d.min&&(d.min=f);l>d.max&&(d.max=l);0<n&&(a.axisX.logarithmic?(r=b/k.dataPoints[n-1].x,1>r&&(r=1/r),c.minDiff>r&&1!==r&&(c.minDiff=r)):(r=b-k.dataPoints[n-1].x,0>r&&(r*=-1),c.minDiff>r&&0!==r&&(c.minDiff=r)),e&&(null!==e[0]&&k.dataPoints[n-1].y&&null!==k.dataPoints[n-1].y[0])&&(a.axisY.logarithmic?(r=e[0]/k.dataPoints[n-1].y[0],1>
r&&(r=1/r),d.minDiff>r&&1!==r&&(d.minDiff=r)):(r=e[0]-k.dataPoints[n-1].y[0],0>r&&(r*=-1),d.minDiff>r&&0!==r&&(d.minDiff=r))));if(!(b<s)||p){if(!p&&(p=!0,0<n)){n-=2;g=h;continue}if(b>t&&!q)q=!0;else if(b>t&&q)continue;k.dataPoints[n].label&&(a.axisX.labels[b]=k.dataPoints[n].label);b<c.viewPortMin&&(c.viewPortMin=b);b>c.viewPortMax&&(c.viewPortMax=b);if(c.viewPortMin===b&&e)for(x=0;x<e.length;x++)if(null===e[x]&&g<b){c.viewPortMin=g;break}null===e?c.viewPortMin===b&&g<b&&(c.viewPortMin=g):(f<d.viewPortMin&&
(d.viewPortMin=f),l>d.viewPortMax&&(d.viewPortMax=l))}}k.axisX.valueType=k.xValueType=u?"dateTime":"number"}};m.prototype._processSpecificPlotUnit=function(a){if("waterfall"===a.type&&a.dataSeriesIndexes&&!(1>a.dataSeriesIndexes.length))for(var d=a.axisY.dataInfo,c=a.axisX.dataInfo,b,e,f=!1,l=0;l<a.dataSeriesIndexes.length;l++){var u=this.data[a.dataSeriesIndexes[l]],D=0,k=!1,n=!1,p=b=0;if("normal"===u.axisPlacement||"xySwapped"===u.axisPlacement)var q=a.axisX.sessionVariables.newViewportMinimum?
...
(d.viewPortMin=u.dataPointEOs[D-1].cumulativeSum),u.dataPointEOs[D-1].cumulativeSum>d.viewPortMax&&(d.viewPortMax=u.dataPointEOs[D-1].cumulativeSum));u.dataPointEOs[D].cumulativeSum<d.viewPortMin&&(d.viewPortMin=u.dataPointEOs[D].cumulativeSum);u.dataPointEOs[D].cumulativeSum>d.viewPortMax&&(d.viewPortMax=u.dataPointEOs[D].cumulativeSum)}u.axisX.valueType=u.xValueType=f?"dateTime":"number"}};m.prototype.calculateAutoBreaks=function(){function a(a,b,c,e){if(e)return c=Math.pow(Math.min(c*a/b,b/a),
...
g=a.axisX.dataInfo,f,l=g.min,k=g.max,n=d.min,p=d.max,g=g._dataRanges,d=d._dataRanges,q,u=0,D=0;D<a.dataSeriesIndexes.length;D++){var h=e.data[a.dataSeriesIndexes[D]];if(!(4>h.dataPoints.length))for(u=0;u<h.dataPoints.length;u++)if(b&&(q=(k+1-l)*Math.max(parseFloat(a.axisX.scaleBreaks.collapsibleThreshold)||10,10)/100,f=h.dataPoints[u].x.getTime?h.dataPoints[u].x.getTime():h.dataPoints[u].x,q=Math.floor((f-l)/q),f<g[q].min&&(g[q].min=f),f>g[q].max&&(g[q].max=f)),c){var m=(p+1-n)*Math.max(parseFloat(a.axisY.scaleBreaks.collapsibleThreshold)||
10,10)/100;if((f="waterfall"===a.type?h.dataPointEOs[u].cumulativeSum:h.dataPoints[u].y)&&f.length)for(var w=0;w<f.length;w++)q=Math.floor((f[w]-n)/m),f[w]<d[q].min&&(d[q].min=f[w]),f[w]>d[q].max&&(d[q].max=f[w]);else s(f)||(q=Math.floor((f-n)/m),f<d[q].min&&(d[q].min=f),f>d[q].max&&(d[q].max=f))}}}}function c(a){if(a.dataSeriesIndexes&&!(1>a.dataSeriesIndexes.length)&&a.axisX.scaleBreaks&&a.axisX.scaleBreaks.autoCalculate&&1<=a.axisX.scaleBreaks.maxNumberOfAutoBreaks)for(var b=a.axisX.dataInfo,c=
b.min,d=b.max,g=b._dataRanges,f,l=0,k=0;k<a.dataSeriesIndexes.length;k++){var n=e.data[a.dataSeriesIndexes[k]];if(!(4>n.dataPoints.length))for(l=0;l<n.dataPoints.length;l++)f=(d+1-c)*Math.max(parseFloat(a.axisX.scaleBreaks.collapsibleThreshold)||10,10)/100,b=n.dataPoints[l].x.getTime?n.dataPoints[l].x.getTime():n.dataPoints[l].x,f=Math.floor((b-c)/f),b<g[f].min&&(g[f].min=b),b>g[f].max&&(g[f].max=b)}}for(var b,e=this,f=!1,l=0;l<this._axes.length;l++)if(this._axes[l].scaleBreaks&&this._axes[l].scaleBreaks.autoCalculate&&
...
10,10)/100;var k=this._axes[l].dataInfo._dataRanges,n,p,f=[];if(this._axes[l].dataInfo.dataPointYPositiveSums){var q=this._axes[l].dataInfo.dataPointYPositiveSums;n=k;for(u in q)if(q.hasOwnProperty(u)&&!isNaN(u)&&(p=q[u],!s(p))){var g=Math.floor((p-D)/b);p<n[g].min&&(n[g].min=p);p>n[g].max&&(n[g].max=p)}delete this._axes[l].dataInfo.dataPointYPositiveSums}if(this._axes[l].dataInfo.dataPointYNegativeSums){q=this._axes[l].dataInfo.dataPointYNegativeSums;n=k;for(u in q)q.hasOwnProperty(u)&&!isNaN(u)&&
(p=-1*q[u],s(p)||(g=Math.floor((p-D)/b),p<n[g].min&&(n[g].min=p),p>n[g].max&&(n[g].max=p)));delete this._axes[l].dataInfo.dataPointYNegativeSums}for(u=0;u<k.length-1;u++)if(n=k[u].max,isFinite(n))for(;u<k.length-1;)if(D=k[u+1].min,isFinite(D)){p=D-n;p>b&&f.push({diff:p,start:n,end:D});break}else u++;if(this._axes[l].scaleBreaks.customBreaks)for(u=0;u<this._axes[l].scaleBreaks.customBreaks.length;u++)for(b=0;b<f.length;b++)if(this._axes[l].scaleBreaks.customBreaks[u].startValue<=f[b].start&&f[b].start<=
...
"area"!==b[c].dataSeries.type&&"stepArea"!==b[c].dataSeries.type||(a?b[c].distance<=a.distance&&(a=b[c]):a=b[c]);return a};m.prototype.getObjectAtXY=function(a,d,c){var b=null;if(c=this.getDataPointAtXY(a,d,c||!1))b=c.dataSeries.dataPointIds[c.dataPointIndex];else if(w)b=$a(a,d,this._eventManager.ghostCtx);else for(c=0;c<this.legend.items.length;c++){var e=this.legend.items[c];a>=e.x1&&(a<=e.x2&&d>=e.y1&&d<=e.y2)&&(b=e.id)}return b};m.prototype.getAutoFontSize=mb;m.prototype.resetOverlayedCanvas=
function(){this.overlaidCanvasCtx.clearRect(0,0,this.width,this.height)};m.prototype.clearCanvas=lb;m.prototype.attachEvent=function(a){this._events.push(a)};m.prototype._touchEventHandler=function(a){if(a.changedTouches&&this.interactivityEnabled){var d=[],c=a.changedTouches,b=c?c[0]:a,e=null;switch(a.type){case "touchstart":case "MSPointerDown":d=["mousemove","mousedown"];this._lastTouchData=Pa(b);this._lastTouchData.time=new Date;break;case "touchmove":case "MSPointerMove":d=["mousemove"];break;
...
!0;this.dragStartPoint={x:a,y:d}};m.prototype._plotAreaMouseUp=function(a,d){if(("normal"===this.plotInfo.axisPlacement||"xySwapped"===this.plotInfo.axisPlacement)&&this.isDrag){var c=d-this.dragStartPoint.y,b=a-this.dragStartPoint.x,e=0<=this.zoomType.indexOf("x"),f=0<=this.zoomType.indexOf("y"),l=!1;this.resetOverlayedCanvas();if("xySwapped"===this.plotInfo.axisPlacement)var u=f,f=e,e=u;if(this.panEnabled||this.zoomEnabled){if(this.panEnabled)for(e=f=0;e<this._axes.length;e++)c=this._axes[e],c.logarithmic?
...
this.stockChart._rangeEventParameter,this.stockChart)),this.render(),this._dispatchRangeEvent("rangeChanged","zoom"),this.stockChart&&(this.stockChart.navigator&&this.stockChart.navigator.enabled)&&(this.stockChart._rangeEventParameter.type="rangeChanged",this.stockChart.dispatchEvent("rangeChanged",this.stockChart._rangeEventParameter,this.stockChart)),l&&(this.zoomEnabled&&"none"===this._zoomButton.style.display)&&(Ma(this._zoomButton,this._resetButton),ra(this,this._zoomButton,"pan"),ra(this,this._resetButton,
...
(p.logarithmic&&r<Math.pow(p.dataInfo.minDiff,3)||!p.logarithmic&&r<3*Math.abs(p.dataInfo.minDiff))||q<p.minimum||g>p.maximum))D.push(p),n.push({val1:q,val2:g}),u=!0;else if(!e){u=!1;break}}return{isValid:u,axesWithValidRange:D,axesRanges:n}};m.prototype.preparePlotArea=function(){var a=this.plotArea;!w&&(0<a.x1||0<a.y1)&&a.ctx.translate(a.x1,a.y1);if((this.axisX[0]||this.axisX2[0])&&(this.axisY[0]||this.axisY2[0])){var d=this.axisX[0]?this.axisX[0].lineCoordinates:this.axisX2[0].lineCoordinates;
...
b=0,e=0,f=0,l=f=e=0,u=0,D=b=0,k=0;for(a=0;a<this._indexLabels.length;a++){var n=this._indexLabels[a],p=n.chartType.toLowerCase(),q,g,l=ma("indexLabelFontColor",n.dataPoint,n.dataSeries),r=ma("indexLabelFontSize",n.dataPoint,n.dataSeries),u=ma("indexLabelFontFamily",n.dataPoint,n.dataSeries),D=ma("indexLabelFontStyle",n.dataPoint,n.dataSeries),k=ma("indexLabelFontWeight",n.dataPoint,n.dataSeries),h=ma("indexLabelBackgroundColor",n.dataPoint,n.dataSeries);q=ma("indexLabelMaxWidth",n.dataPoint,n.dataSeries);
g=ma("indexLabelWrap",n.dataPoint,n.dataSeries);var da=ma("indexLabelLineDashType",n.dataPoint,n.dataSeries),t=ma("indexLabelLineColor",n.dataPoint,n.dataSeries),x=s(n.dataPoint.indexLabelLineThickness)?s(n.dataSeries.options.indexLabelLineThickness)?0:n.dataSeries.options.indexLabelLineThickness:n.dataPoint.indexLabelLineThickness,b=0<x?Math.min(10,("normal"===this.plotInfo.axisPlacement?this.plotArea.height:this.plotArea.width)<<0):0,m={percent:null,total:null},z=null;if(0<=n.dataSeries.type.indexOf("stacked")||
...
z?0:-90,text:H,padding:0,backgroundColor:h,textAlign:C,fontSize:r,fontFamily:u,fontWeight:k,fontColor:l,fontStyle:D,textBaseline:"middle"});h.measureText();n.dataSeries.indexLabelMaxWidth=h.maxWidth;if("stackedarea100"===p){if(n.point.x<c.x1||n.point.x>c.x2||n.point.y<c.y1-1||n.point.y>c.y2+1)continue}else if("rangearea"===p||"rangesplinearea"===p){if(n.dataPoint.x<e.viewportMinimum||n.dataPoint.x>e.viewportMaximum||Math.max.apply(null,n.dataPoint.y)<f.viewportMinimum||Math.min.apply(null,n.dataPoint.y)>
...
p){if(n.dataPoint.x<e.viewportMinimum||n.dataPoint.x>e.viewportMaximum||n.bounds.x1>c.x2||n.bounds.x2<c.x1)continue}else if("candlestick"===p||"ohlc"===p){if(n.dataPoint.x<e.viewportMinimum||n.dataPoint.x>e.viewportMaximum||Math.max.apply(null,n.dataPoint.y)<f.viewportMinimum||Math.min.apply(null,n.dataPoint.y)>f.viewportMaximum)continue}else if(n.dataPoint.x<e.viewportMinimum||n.dataPoint.x>e.viewportMaximum)continue;l=u=2;"horizontal"===z?(D=h.width,k=h.height):(k=h.width,D=h.height);if("normal"===
this.plotInfo.axisPlacement){if(0<=p.indexOf("line")||0<=p.indexOf("area"))m="auto",u=4;else if(0<=p.indexOf("stacked"))"auto"===m&&(m="inside");else if("bubble"===p||"scatter"===p)m="inside";q=n.point.x-("horizontal"===z?D/2:D/2-r/2);"inside"!==m?(e=c.y1,f=c.y2,0<v?(g=n.point.y+("horizontal"===z?r/2:0)-k-u-b,g<e&&(g="auto"===m?Math.max(n.point.y,e)+r/2+u:e+r/2+u,A=g+k>n.point.y)):(g=n.point.y+r/2+u+b,g>f-k&&(g="auto"===m?Math.min(n.point.y,f)+r/2-k-u:f+r/2-k,A=g<n.point.y))):(e=Math.max(n.bounds.y1,
c.y1),f=Math.min(n.bounds.y2,c.y2-k+r/2),b=0<=p.indexOf("range")||"error"===p?0<v?Math.max(n.bounds.y1,c.y1)+r/2+u:Math.min(n.bounds.y2,c.y2)+r/2-k+u:(Math.max(n.bounds.y1,c.y1)+Math.min(n.bounds.y2,c.y2))/2-k/2+r/2+("horizontal"===z?u:0),0<v?(g=Math.max(n.point.y,b),g<e&&("bubble"===p||"scatter"===p)&&(g=Math.max(n.point.y-k-u,c.y1+u))):(g=Math.min(n.point.y,b),g>f-k-u&&("bubble"===p||"scatter"===p)&&(g=Math.min(n.point.y+u,c.y2-k-u))),g=Math.min(g,f))}else 0<=p.indexOf("line")||0<=p.indexOf("area")||
0<=p.indexOf("scatter")?(m="auto",l=4):0<=p.indexOf("stacked")?"auto"===m&&(m="inside"):"bubble"===p&&(m="inside"),g=n.point.y+r/2-k/2+u,"inside"!==m?(e=c.x1,f=c.x2,0>v?(q=n.point.x-("horizontal"===z?D:D-r/2)-l-b,q<e&&(q="auto"===m?Math.max(n.point.x,e)+l:e+l,A=q+D>n.point.x)):(q=n.point.x+("horizontal"===z?0:r/2)+l+b,q>f-D-l-b&&(q="auto"===m?Math.min(n.point.x,f)-("horizontal"===z?D:D/2)-l:f-D-l,A=q<n.point.x))):(e=Math.max(n.bounds.x1,c.x1),Math.min(n.bounds.x2,c.x2),b=0<=p.indexOf("range")||"error"===
p?0>v?Math.max(n.bounds.x1,c.x1)+r/2+l:Math.min(n.bounds.x2,c.x2)-D/2-l+("horizontal"===z?0:r/2):(Math.max(n.bounds.x1,c.x1)+Math.min(n.bounds.x2,c.x2))/2+("horizontal"===z?0:r/2),q=0>v?Math.max(n.point.x,b)-("horizontal"===z?D/2:0):Math.min(n.point.x,b)-D/2,q=Math.max(q,e));"vertical"===z&&(g+=k-r/2);h.x=q;h.y=g;h.render(!0);x&&("inside"!==m&&(0>p.indexOf("bar")&&("error"!==p||!n.axisSwapped)&&n.point.x>c.x1&&n.point.x<c.x2||!A)&&(0>p.indexOf("column")&&("error"!==p||n.axisSwapped)&&n.point.y>c.y1&&
n.point.y<c.y2||!A))&&(d.lineWidth=x,d.strokeStyle=t?t:"gray",d.setLineDash&&d.setLineDash(J(da,x)),d.beginPath(),d.moveTo(n.point.x,n.point.y),0<=p.indexOf("bar")||"error"===p&&n.axisSwapped?d.lineTo(q+(0<n.direction?-l:D+l)+("vertical"===z?-r/2:0),g+("vertical"===z?-k/2:k/2-r/2)-u):0<=p.indexOf("column")||"error"===p&&!n.axisSwapped?d.lineTo(q+D/2-("horizontal"===z?0:r/2),g+("vertical"===z?(g-k<n.point.y?0:-k)+u:(g-r/2<n.point.y?k:0)-r/2)):d.lineTo(q+D/2-("horizontal"===z?0:r/2),g+("vertical"===
...
dataSeriesIndex:D};r=X(r);b.strokeStyle=r;b.lineWidth=0<k.lineThickness?Math.max(k.lineThickness,4):0;var r=k._colorSet,h=r=k.lineColor=k.options.lineColor?k.options.lineColor:r[0];c.strokeStyle=r;var s=!0,t=0,m,y;c.beginPath();if(0<n.length){for(var z=!1,t=0;t<n.length;t++)if(m=n[t].x.getTime?n[t].x.getTime():n[t].x,!(m<a.axisX.dataInfo.viewPortMin||m>a.axisX.dataInfo.viewPortMax&&(!k.connectNullData||!z)))if("number"!==typeof n[t].y)0<t&&!(k.connectNullData||z||s)&&(c.stroke(),w&&b.stroke()),z=
!0;else{m=a.axisX.convertValueToPixel(m);y=a.axisY.convertValueToPixel(n[t].y);var H=k.dataPointIds[t];this._eventManager.objectMap[H]={id:H,objectType:"dataPoint",dataSeriesIndex:D,dataPointIndex:t,x1:m,y1:y};s||z?(!s&&k.connectNullData?(c.setLineDash&&(k.options.nullDataLineDashType||p===k.lineDashType&&k.lineDashType!==k.nullDataLineDashType)&&(c.stroke(),c.beginPath(),c.moveTo(l.x,l.y),p=k.nullDataLineDashType,c.setLineDash(q)),c.lineTo(m,y),w&&b.lineTo(m,y)):(c.beginPath(),c.moveTo(m,y),w&&(b.beginPath(),
b.moveTo(m,y))),z=s=!1):(c.lineTo(m,y),w&&b.lineTo(m,y),0==t%500&&(c.stroke(),c.beginPath(),c.moveTo(m,y),w&&(b.stroke(),b.beginPath(),b.moveTo(m,y))));l={x:m,y:y};t<n.length-1&&(h!==(n[t].lineColor||r)||p!==(n[t].lineDashType||k.lineDashType))&&(c.stroke(),c.beginPath(),c.moveTo(m,y),h=n[t].lineColor||r,c.strokeStyle=h,c.setLineDash&&(n[t].lineDashType?(p=n[t].lineDashType,c.setLineDash(J(p,k.lineThickness))):(p=k.lineDashType,c.setLineDash(g))));if(0!==n[t].markerSize&&(0<n[t].markerSize||0<k.markerSize)){var C=
k.getMarkerProperties(t,m,y,c);f.push(C);H=X(H);w&&f.push({x:m,y:y,ctx:b,type:C.type,size:C.size,color:H,borderColor:H,borderThickness:C.borderThickness})}(n[t].indexLabel||k.indexLabel||n[t].indexLabelFormatter||k.indexLabelFormatter)&&this._indexLabels.push({chartType:"line",dataPoint:n[t],dataSeries:k,point:{x:m,y:y},direction:0>n[t].y===a.axisY.reversed?1:-1,color:r})}c.stroke();w&&b.stroke()}}W.drawMarkers(f);w&&(d.drawImage(this._preRenderCanvas,0,0,this.width,this.height),c.globalCompositeOperation=
...
k.id;this._eventManager.objectMap[r]={objectType:"dataSeries",dataSeriesIndex:D};r=X(r);b.strokeStyle=r;b.lineWidth=0<k.lineThickness?Math.max(k.lineThickness,4):0;var r=k._colorSet,h=r=k.lineColor=k.options.lineColor?k.options.lineColor:r[0];c.strokeStyle=r;var s=!0,t=0,m,y;c.beginPath();if(0<n.length){for(var z=!1,t=0;t<n.length;t++)if(m=n[t].getTime?n[t].x.getTime():n[t].x,!(m<a.axisX.dataInfo.viewPortMin||m>a.axisX.dataInfo.viewPortMax&&(!k.connectNullData||!z)))if("number"!==typeof n[t].y)0<
t&&!(k.connectNullData||z||s)&&(c.stroke(),w&&b.stroke()),z=!0;else{var H=y;m=a.axisX.convertValueToPixel(m);y=a.axisY.convertValueToPixel(n[t].y);var C=k.dataPointIds[t];this._eventManager.objectMap[C]={id:C,objectType:"dataPoint",dataSeriesIndex:D,dataPointIndex:t,x1:m,y1:y};s||z?(!s&&k.connectNullData?(c.setLineDash&&(k.options.nullDataLineDashType||p===k.lineDashType&&k.lineDashType!==k.nullDataLineDashType)&&(c.stroke(),c.beginPath(),c.moveTo(l.x,l.y),p=k.nullDataLineDashType,c.setLineDash(q)),
c.lineTo(m,H),c.lineTo(m,y),w&&(b.lineTo(m,H),b.lineTo(m,y))):(c.beginPath(),c.moveTo(m,y),w&&(b.beginPath(),b.moveTo(m,y))),z=s=!1):(c.lineTo(m,H),w&&b.lineTo(m,H),c.lineTo(m,y),w&&b.lineTo(m,y),0==t%500&&(c.stroke(),c.beginPath(),c.moveTo(m,y),w&&(b.stroke(),b.beginPath(),b.moveTo(m,y))));l={x:m,y:y};t<n.length-1&&(h!==(n[t].lineColor||r)||p!==(n[t].lineDashType||k.lineDashType))&&(c.stroke(),c.beginPath(),c.moveTo(m,y),h=n[t].lineColor||r,c.strokeStyle=h,c.setLineDash&&(n[t].lineDashType?(p=n[t].lineDashType,
c.setLineDash(J(p,k.lineThickness))):(p=k.lineDashType,c.setLineDash(g))));0!==n[t].markerSize&&(0<n[t].markerSize||0<k.markerSize)&&(H=k.getMarkerProperties(t,m,y,c),f.push(H),C=X(C),w&&f.push({x:m,y:y,ctx:b,type:H.type,size:H.size,color:C,borderColor:C,borderThickness:H.borderThickness}));(n[t].indexLabel||k.indexLabel||n[t].indexLabelFormatter||k.indexLabelFormatter)&&this._indexLabels.push({chartType:"stepLine",dataPoint:n[t],dataSeries:k,point:{x:m,y:y},direction:0>n[t].y===a.axisY.reversed?
...
this._eventManager.ghostCtx;b.save();var f=this.plotArea;b.beginPath();b.rect(f.x1,f.y1,f.width,f.height);b.clip();for(var l=[],u=0;u<a.dataSeriesIndexes.length;u++){var D=a.dataSeriesIndexes[u],k=this.data[D];b.lineWidth=k.lineThickness;var n=k.dataPoints,p="solid";if(b.setLineDash){var q=J(k.nullDataLineDashType,k.lineThickness),p=k.lineDashType,g=J(p,k.lineThickness);b.setLineDash(g)}var r=k.id;this._eventManager.objectMap[r]={objectType:"dataSeries",dataSeriesIndex:D};r=X(r);e.strokeStyle=r;e.lineWidth=
0<k.lineThickness?Math.max(k.lineThickness,4):0;var r=k._colorSet,h=r=k.lineColor=k.options.lineColor?k.options.lineColor:r[0];b.strokeStyle=r;var m=0,t,s,y=[];b.beginPath();if(0<n.length)for(s=!1,m=0;m<n.length;m++)if(t=n[m].getTime?n[m].x.getTime():n[m].x,!(t<a.axisX.dataInfo.viewPortMin||t>a.axisX.dataInfo.viewPortMax&&(!k.connectNullData||!s)))if("number"!==typeof n[m].y)0<m&&!s&&(k.connectNullData?b.setLineDash&&(0<y.length&&(k.options.nullDataLineDashType||!n[m-1].lineDashType))&&(y[y.length-
1].newLineDashArray=q,p=k.nullDataLineDashType):(d(y),y=[])),s=!0;else{t=a.axisX.convertValueToPixel(t);s=a.axisY.convertValueToPixel(n[m].y);var z=k.dataPointIds[m];this._eventManager.objectMap[z]={id:z,objectType:"dataPoint",dataSeriesIndex:D,dataPointIndex:m,x1:t,y1:s};y[y.length]={x:t,y:s};m<n.length-1&&(h!==(n[m].lineColor||r)||p!==(n[m].lineDashType||k.lineDashType))&&(h=n[m].lineColor||r,y[y.length-1].newStrokeStyle=h,b.setLineDash&&(n[m].lineDashType?(p=n[m].lineDashType,y[y.length-1].newLineDashArray=
J(p,k.lineThickness)):(p=k.lineDashType,y[y.length-1].newLineDashArray=g)));if(0!==n[m].markerSize&&(0<n[m].markerSize||0<k.markerSize)){var H=k.getMarkerProperties(m,t,s,b);l.push(H);z=X(z);w&&l.push({x:t,y:s,ctx:e,type:H.type,size:H.size,color:z,borderColor:z,borderThickness:H.borderThickness})}(n[m].indexLabel||k.indexLabel||n[m].indexLabelFormatter||k.indexLabelFormatter)&&this._indexLabels.push({chartType:"spline",dataPoint:n[m],dataSeries:k,point:{x:t,y:s},direction:0>n[m].y===a.axisY.reversed?
1:-1,color:r});s=!1}d(y)}W.drawMarkers(l);w&&(c.drawImage(this._preRenderCanvas,0,0,this.width,this.height),b.globalCompositeOperation="source-atop",a.axisX.maskCanvas&&b.drawImage(a.axisX.maskCanvas,0,0,this.width,this.height),a.axisY.maskCanvas&&b.drawImage(a.axisY.maskCanvas,0,0,this.width,this.height),this._breaksCanvasCtx&&this._breaksCanvasCtx.drawImage(this._preRenderCanvas,0,0,this.width,this.height),b.clearRect(f.x1,f.y1,f.width,f.height),e.beginPath());b.restore();b.beginPath();return{source:c,
dest:this.plotArea.ctx,animationCallback:M.xClipAnimation,easingFunction:M.easing.linear,animationBase:0}}};m.prototype.renderColumn=function(a){var d=a.targetCanvasCtx||this.plotArea.ctx,c=w?this._preRenderCtx:d;if(!(0>=a.dataSeriesIndexes.length)){var b=null,e=this.plotArea,f=0,l,u,D,k=a.axisY.convertValueToPixel(a.axisY.logarithmic?a.axisY.viewportMinimum:0),f=this.options.dataPointMinWidth?this.dataPointMinWidth:this.options.dataPointWidth?this.dataPointWidth:1,n=this.options.dataPointMaxWidth?
...
g=this.data[q],r=g.dataPoints;if(0<r.length)for(var h=5<p&&g.bevelEnabled?!0:!1,f=0;f<r.length;f++)if(r[f].getTime?D=r[f].x.getTime():D=r[f].x,!(D<a.axisX.dataInfo.viewPortMin||D>a.axisX.dataInfo.viewPortMax)&&"number"===typeof r[f].y){l=a.axisX.convertValueToPixel(D);u=a.axisY.convertValueToPixel(r[f].y);l=a.axisX.reversed?l+a.plotType.totalDataSeries*p/2-(a.previousDataSeriesCount+n)*p<<0:l-a.plotType.totalDataSeries*p/2+(a.previousDataSeriesCount+n)*p<<0;var m=a.axisX.reversed?l-p<<0:l+p<<0,t;
0<=r[f].y?t=k:(t=u,u=k);u>t&&(b=u,u=t,t=b);b=r[f].color?r[f].color:g._colorSet[f%g._colorSet.length];Y(c,a.axisX.reversed?m:l,u,a.axisX.reversed?l:m,t,b,0,null,h&&(a.axisY.reversed?0>r[f].y:0<=r[f].y),(a.axisY.reversed?0<=r[f].y:0>r[f].y)&&h,!1,!1,g.fillOpacity);b=g.dataPointIds[f];this._eventManager.objectMap[b]={id:b,objectType:"dataPoint",dataSeriesIndex:q,dataPointIndex:f,x1:l,y1:u,x2:m,y2:t};b=X(b);w&&Y(this._eventManager.ghostCtx,a.axisX.reversed?m:l,u,a.axisX.reversed?l:m,t,b,0,null,!1,!1,
!1,!1);(r[f].indexLabel||g.indexLabel||r[f].indexLabelFormatter||g.indexLabelFormatter)&&this._indexLabels.push({chartType:"column",dataPoint:r[f],dataSeries:g,point:{x:l+(m-l)/2,y:0>r[f].y===a.axisY.reversed?u:t},direction:0>r[f].y===a.axisY.reversed?1:-1,bounds:{x1:l,y1:Math.min(u,t),x2:m,y2:Math.max(u,t)},color:b})}}w&&(d.drawImage(this._preRenderCanvas,0,0,this.width,this.height),c.globalCompositeOperation="source-atop",a.axisX.maskCanvas&&c.drawImage(a.axisX.maskCanvas,0,0,this.width,this.height),
...
c.beginPath();c.rect(e.x1,e.y1,e.width,e.height);c.clip();w&&(this._eventManager.ghostCtx.beginPath(),this._eventManager.ghostCtx.rect(e.x1,e.y1,e.width,e.height),this._eventManager.ghostCtx.clip());for(g=0;g<a.dataSeriesIndexes.length;g++){var h=a.dataSeriesIndexes[g],m=this.data[h],t=m.dataPoints;if(0<t.length){var s=5<r&&m.bevelEnabled?!0:!1;c.strokeStyle="#4572A7 ";for(k=0;k<t.length;k++)if(b=t[k].x.getTime?t[k].x.getTime():t[k].x,!(b<a.axisX.dataInfo.viewPortMin||b>a.axisX.dataInfo.viewPortMax)&&
"number"===typeof t[k].y){n=a.axisX.convertValueToPixel(b);n=n-a.plotType.plotUnits.length*r/2+a.index*r<<0;var y=n+r<<0,z;if(a.axisY.logarithmic||a.axisY.scaleBreaks&&0<a.axisY.scaleBreaks._appliedBreaks.length&&0<t[k].y)u[b]=t[k].y+(u[b]?u[b]:0),0<u[b]&&(p=a.axisY.convertValueToPixel(u[b]),z="undefined"!==typeof f[b]?f[b]:q,f[b]=p);else if(a.axisY.scaleBreaks&&0<a.axisY.scaleBreaks._appliedBreaks.length&&0>=t[k].y)D[b]=t[k].y+(D[b]?D[b]:0),z=a.axisY.convertValueToPixel(D[b]),p="undefined"!==typeof l[b]?
l[b]:q,l[b]=z;else if(p=a.axisY.convertValueToPixel(t[k].y),0<=t[k].y){var H="undefined"!==typeof f[b]?f[b]:0;p-=H;z=q-H;f[b]=H+(z-p)}else H=l[b]?l[b]:0,z=p+H,p=q+H,l[b]=H+(z-p);b=t[k].color?t[k].color:m._colorSet[k%m._colorSet.length];Y(c,n,a.axisY.reversed?z:p,y,a.axisY.reversed?p:z,b,0,null,s&&(a.axisY.reversed?0>t[k].y:0<=t[k].y),(a.axisY.reversed?0<=t[k].y:0>t[k].y)&&s,!1,!1,m.fillOpacity);b=m.dataPointIds[k];this._eventManager.objectMap[b]={id:b,objectType:"dataPoint",dataSeriesIndex:h,dataPointIndex:k,
x1:n,y1:p,x2:y,y2:z};b=X(b);w&&Y(this._eventManager.ghostCtx,n,p,y,z,b,0,null,!1,!1,!1,!1);(t[k].indexLabel||m.indexLabel||t[k].indexLabelFormatter||m.indexLabelFormatter)&&this._indexLabels.push({chartType:"stackedColumn",dataPoint:t[k],dataSeries:m,point:{x:n+(y-n)/2,y:0<=t[k].y?p:z},direction:0>t[k].y===a.axisY.reversed?1:-1,bounds:{x1:n,y1:Math.min(p,z),x2:y,y2:Math.max(p,z)},color:b})}}}w&&(d.drawImage(this._preRenderCanvas,0,0,this.width,this.height),c.globalCompositeOperation="source-atop",
...
-Infinity,k));r<k&&(r=k);r>g&&(r=g);c.save();w&&this._eventManager.ghostCtx.save();c.beginPath();c.rect(e.x1,e.y1,e.width,e.height);c.clip();w&&(this._eventManager.ghostCtx.beginPath(),this._eventManager.ghostCtx.rect(e.x1,e.y1,e.width,e.height),this._eventManager.ghostCtx.clip());for(g=0;g<a.dataSeriesIndexes.length;g++){var h=a.dataSeriesIndexes[g],m=this.data[h],t=m.dataPoints;if(0<t.length)for(var s=5<r&&m.bevelEnabled?!0:!1,k=0;k<t.length;k++)if(b=t[k].x.getTime?t[k].x.getTime():t[k].x,!(b<a.axisX.dataInfo.viewPortMin||
b>a.axisX.dataInfo.viewPortMax)&&"number"===typeof t[k].y){n=a.axisX.convertValueToPixel(b);p=0!==a.dataPointYSums[b]?100*(t[k].y/a.dataPointYSums[b]):0;n=n-a.plotType.plotUnits.length*r/2+a.index*r<<0;var y=n+r<<0,z;if(a.axisY.logarithmic||a.axisY.scaleBreaks&&0<a.axisY.scaleBreaks._appliedBreaks.length&&0<t[k].y){u[b]=p+("undefined"!==typeof u[b]?u[b]:0);if(0>=u[b])continue;p=a.axisY.convertValueToPixel(u[b]);z=f[b]?f[b]:q;f[b]=p}else if(a.axisY.scaleBreaks&&0<a.axisY.scaleBreaks._appliedBreaks.length&&
0>=t[k].y)D[b]=p+("undefined"!==typeof D[b]?D[b]:0),z=a.axisY.convertValueToPixel(D[b]),p=l[b]?l[b]:q,l[b]=z;else if(p=a.axisY.convertValueToPixel(p),0<=t[k].y){var H="undefined"!==typeof f[b]?f[b]:0;p-=H;z=q-H;a.dataSeriesIndexes.length-1===g&&1>=Math.abs(e.y1-p)&&(p=e.y1);f[b]=H+(z-p)}else H="undefined"!==typeof l[b]?l[b]:0,z=p+H,p=q+H,a.dataSeriesIndexes.length-1===g&&1>=Math.abs(e.y2-z)&&(z=e.y2),l[b]=H+(z-p);b=t[k].color?t[k].color:m._colorSet[k%m._colorSet.length];Y(c,n,a.axisY.reversed?z:p,
y,a.axisY.reversed?p:z,b,0,null,s&&(a.axisY.reversed?0>t[k].y:0<=t[k].y),(a.axisY.reversed?0<=t[k].y:0>t[k].y)&&s,!1,!1,m.fillOpacity);b=m.dataPointIds[k];this._eventManager.objectMap[b]={id:b,objectType:"dataPoint",dataSeriesIndex:h,dataPointIndex:k,x1:n,y1:p,x2:y,y2:z};b=X(b);w&&Y(this._eventManager.ghostCtx,n,p,y,z,b,0,null,!1,!1,!1,!1);(t[k].indexLabel||m.indexLabel||t[k].indexLabelFormatter||m.indexLabelFormatter)&&this._indexLabels.push({chartType:"stackedColumn100",dataPoint:t[k],dataSeries:m,
...
c.clearRect(e.x1,e.y1,e.width,e.height),this._eventManager.ghostCtx.restore());c.restore();return{source:d,dest:this.plotArea.ctx,animationCallback:M.yScaleAnimation,easingFunction:M.easing.easeOutQuart,animationBase:q<a.axisY.bounds.y1?a.axisY.bounds.y1:q>a.axisY.bounds.y2?a.axisY.bounds.y2:q}}};m.prototype.renderBar=function(a){var d=a.targetCanvasCtx||this.plotArea.ctx,c=w?this._preRenderCtx:d;if(!(0>=a.dataSeriesIndexes.length)){var b=null,e=this.plotArea,f=0,l,u,D,k=a.axisY.convertValueToPixel(a.axisY.logarithmic?
...
e.y1,e.width,e.height),this._eventManager.ghostCtx.clip());for(n=0;n<a.dataSeriesIndexes.length;n++){var q=a.dataSeriesIndexes[n],g=this.data[q],r=g.dataPoints;if(0<r.length){var h=5<p&&g.bevelEnabled?!0:!1;c.strokeStyle="#4572A7 ";for(f=0;f<r.length;f++)if(r[f].getTime?D=r[f].x.getTime():D=r[f].x,!(D<a.axisX.dataInfo.viewPortMin||D>a.axisX.dataInfo.viewPortMax)&&"number"===typeof r[f].y){u=a.axisX.convertValueToPixel(D);l=a.axisY.convertValueToPixel(r[f].y);u=a.axisX.reversed?u+a.plotType.totalDataSeries*
p/2-(a.previousDataSeriesCount+n)*p<<0:u-a.plotType.totalDataSeries*p/2+(a.previousDataSeriesCount+n)*p<<0;var m=a.axisX.reversed?u-p<<0:u+p<<0,t;0<=r[f].y?t=k:(t=l,l=k);b=r[f].color?r[f].color:g._colorSet[f%g._colorSet.length];Y(c,a.axisY.reversed?l:t,a.axisX.reversed?m:u,a.axisY.reversed?t:l,a.axisX.reversed?u:m,b,0,null,h,!1,!1,!1,g.fillOpacity);b=g.dataPointIds[f];this._eventManager.objectMap[b]={id:b,objectType:"dataPoint",dataSeriesIndex:q,dataPointIndex:f,x1:t,y1:u,x2:l,y2:m};b=X(b);w&&Y(this._eventManager.ghostCtx,
t,a.axisX.reversed?m:u,l,a.axisX.reversed?u:m,b,0,null,!1,!1,!1,!1);(r[f].indexLabel||g.indexLabel||r[f].indexLabelFormatter||g.indexLabelFormatter)&&this._indexLabels.push({chartType:"bar",dataPoint:r[f],dataSeries:g,point:{x:0<=r[f].y?l:t,y:u+(m-u)/2},direction:0>r[f].y===a.axisY.reversed?1:-1,bounds:{x1:Math.min(t,l),y1:u,x2:Math.max(t,l),y2:m},color:b})}}}w&&(d.drawImage(this._preRenderCanvas,0,0,this.width,this.height),c.globalCompositeOperation="source-atop",a.axisX.maskCanvas&&c.drawImage(a.axisX.maskCanvas,
...
(r=k);r>g&&(r=g);c.save();w&&this._eventManager.ghostCtx.save();c.beginPath();c.rect(e.x1,e.y1,e.width,e.height);c.clip();w&&(this._eventManager.ghostCtx.beginPath(),this._eventManager.ghostCtx.rect(e.x1,e.y1,e.width,e.height),this._eventManager.ghostCtx.clip());for(g=0;g<a.dataSeriesIndexes.length;g++){var h=a.dataSeriesIndexes[g],m=this.data[h],t=m.dataPoints;if(0<t.length){var s=5<r&&m.bevelEnabled?!0:!1;c.strokeStyle="#4572A7 ";for(k=0;k<t.length;k++)if(b=t[k].x.getTime?t[k].x.getTime():t[k].x,
!(b<a.axisX.dataInfo.viewPortMin||b>a.axisX.dataInfo.viewPortMax)&&"number"===typeof t[k].y){p=a.axisX.convertValueToPixel(b);p=p-a.plotType.plotUnits.length*r/2+a.index*r<<0;var y=p+r<<0,z;if(a.axisY.logarithmic||a.axisY.scaleBreaks&&0<a.axisY.scaleBreaks._appliedBreaks.length&&0<t[k].y)u[b]=t[k].y+(u[b]?u[b]:0),0<u[b]&&(z=f[b]?f[b]:q,f[b]=n=a.axisY.convertValueToPixel(u[b]));else if(a.axisY.scaleBreaks&&0<a.axisY.scaleBreaks._appliedBreaks.length&&0>=t[k].y)D[b]=t[k].y+(D[b]?D[b]:0),n=l[b]?l[b]:
q,l[b]=z=a.axisY.convertValueToPixel(D[b]);else if(n=a.axisY.convertValueToPixel(t[k].y),0<=t[k].y){var H=f[b]?f[b]:0;z=q+H;n+=H;f[b]=H+(n-z)}else H=l[b]?l[b]:0,z=n-H,n=q-H,l[b]=H+(n-z);b=t[k].color?t[k].color:m._colorSet[k%m._colorSet.length];Y(c,a.axisY.reversed?n:z,p,a.axisY.reversed?z:n,y,b,0,null,s,!1,!1,!1,m.fillOpacity);b=m.dataPointIds[k];this._eventManager.objectMap[b]={id:b,objectType:"dataPoint",dataSeriesIndex:h,dataPointIndex:k,x1:z,y1:p,x2:n,y2:y};b=X(b);w&&Y(this._eventManager.ghostCtx,
z,p,n,y,b,0,null,!1,!1,!1,!1);(t[k].indexLabel||m.indexLabel||t[k].indexLabelFormatter||m.indexLabelFormatter)&&this._indexLabels.push({chartType:"stackedBar",dataPoint:t[k],dataSeries:m,point:{x:0<=t[k].y?n:z,y:p+(y-p)/2},direction:0>t[k].y===a.axisY.reversed?1:-1,bounds:{x1:Math.min(z,n),y1:p,x2:Math.max(z,n),y2:y},color:b})}}}w&&(d.drawImage(this._preRenderCanvas,0,0,this.width,this.height),c.globalCompositeOperation="source-atop",a.axisX.maskCanvas&&c.drawImage(a.axisX.maskCanvas,0,0,this.width,
...
this._eventManager.ghostCtx.save();c.beginPath();c.rect(e.x1,e.y1,e.width,e.height);c.clip();w&&(this._eventManager.ghostCtx.beginPath(),this._eventManager.ghostCtx.rect(e.x1,e.y1,e.width,e.height),this._eventManager.ghostCtx.clip());for(g=0;g<a.dataSeriesIndexes.length;g++){var h=a.dataSeriesIndexes[g],m=this.data[h],t=m.dataPoints;if(0<t.length){var s=5<r&&m.bevelEnabled?!0:!1;c.strokeStyle="#4572A7 ";for(k=0;k<t.length;k++)if(b=t[k].x.getTime?t[k].x.getTime():t[k].x,!(b<a.axisX.dataInfo.viewPortMin||
b>a.axisX.dataInfo.viewPortMax)&&"number"===typeof t[k].y){p=a.axisX.convertValueToPixel(b);var y;y=0!==a.dataPointYSums[b]?100*(t[k].y/a.dataPointYSums[b]):0;p=p-a.plotType.plotUnits.length*r/2+a.index*r<<0;var z=p+r<<0;if(a.axisY.logarithmic||a.axisY.scaleBreaks&&0<a.axisY.scaleBreaks._appliedBreaks.length&&0<t[k].y){u[b]=y+(u[b]?u[b]:0);if(0>=u[b])continue;y=f[b]?f[b]:q;f[b]=n=a.axisY.convertValueToPixel(u[b])}else if(a.axisY.scaleBreaks&&0<a.axisY.scaleBreaks._appliedBreaks.length&&0>=t[k].y)D[b]=
y+(D[b]?D[b]:0),n=l[b]?l[b]:q,l[b]=y=a.axisY.convertValueToPixel(D[b]);else if(n=a.axisY.convertValueToPixel(y),0<=t[k].y){var H=f[b]?f[b]:0;y=q+H;n+=H;a.dataSeriesIndexes.length-1===g&&1>=Math.abs(e.x2-n)&&(n=e.x2);f[b]=H+(n-y)}else H=l[b]?l[b]:0,y=n-H,n=q-H,a.dataSeriesIndexes.length-1===g&&1>=Math.abs(e.x1-y)&&(y=e.x1),l[b]=H+(n-y);b=t[k].color?t[k].color:m._colorSet[k%m._colorSet.length];Y(c,a.axisY.reversed?n:y,p,a.axisY.reversed?y:n,z,b,0,null,s,!1,!1,!1,m.fillOpacity);b=m.dataPointIds[k];this._eventManager.objectMap[b]=
{id:b,objectType:"dataPoint",dataSeriesIndex:h,dataPointIndex:k,x1:y,y1:p,x2:n,y2:z};b=X(b);w&&Y(this._eventManager.ghostCtx,y,p,n,z,b,0,null,!1,!1,!1,!1);(t[k].indexLabel||m.indexLabel||t[k].indexLabelFormatter||m.indexLabelFormatter)&&this._indexLabels.push({chartType:"stackedBar100",dataPoint:t[k],dataSeries:m,point:{x:0<=t[k].y?n:y,y:p+(z-p)/2},direction:0>t[k].y===a.axisY.reversed?1:-1,bounds:{x1:Math.min(y,n),y1:p,x2:Math.max(y,n),y2:z},color:b})}}}w&&(d.drawImage(this._preRenderCanvas,0,0,
...
animationBase:q<a.axisY.bounds.x1?a.axisY.bounds.x1:q>a.axisY.bounds.x2?a.axisY.bounds.x2:q}}};m.prototype.renderArea=function(a){var d,c;function b(){H&&(0<g.lineThickness&&f.stroke(),a.axisY.logarithmic||0>=a.axisY.viewportMinimum&&0<=a.axisY.viewportMaximum?z=y:0>a.axisY.viewportMaximum?z=u.y1:0<a.axisY.viewportMinimum&&(z=y),f.lineTo(m,z),f.lineTo(H.x,z),f.closePath(),f.globalAlpha=g.fillOpacity,f.fill(),f.globalAlpha=1,w&&(l.lineTo(m,z),l.lineTo(H.x,z),l.closePath(),l.fill()),f.beginPath(),f.moveTo(m,
t),l.beginPath(),l.moveTo(m,t),H={x:m,y:t})}var e=a.targetCanvasCtx||this.plotArea.ctx,f=w?this._preRenderCtx:e;if(!(0>=a.dataSeriesIndexes.length)){var l=this._eventManager.ghostCtx,u=a.axisY.lineCoordinates,D=[],k=this.plotArea,n;f.save();w&&l.save();f.beginPath();f.rect(k.x1,k.y1,k.width,k.height);f.clip();w&&(l.beginPath(),l.rect(k.x1,k.y1,k.width,k.height),l.clip());for(var p=0;p<a.dataSeriesIndexes.length;p++){var q=a.dataSeriesIndexes[p],g=this.data[q],r=g.dataPoints,D=g.id;this._eventManager.objectMap[D]=
{objectType:"dataSeries",dataSeriesIndex:q};D=X(D);l.fillStyle=D;D=[];d=!0;var h=0,m,t,s,y=a.axisY.convertValueToPixel(a.axisY.logarithmic?a.axisY.viewportMinimum:0),z,H=null;if(0<r.length){var C=g._colorSet[h%g._colorSet.length],v=g.lineColor=g.options.lineColor||C,A=v;f.fillStyle=C;f.strokeStyle=v;f.lineWidth=g.lineThickness;c="solid";if(f.setLineDash){var L=J(g.nullDataLineDashType,g.lineThickness);c=g.lineDashType;var S=J(c,g.lineThickness);f.setLineDash(S)}for(var ea=!0;h<r.length;h++)if(s=r[h].x.getTime?
r[h].x.getTime():r[h].x,!(s<a.axisX.dataInfo.viewPortMin||s>a.axisX.dataInfo.viewPortMax&&(!g.connectNullData||!ea)))if("number"!==typeof r[h].y)g.connectNullData||(ea||d)||b(),ea=!0;else{m=a.axisX.convertValueToPixel(s);t=a.axisY.convertValueToPixel(r[h].y);d||ea?(!d&&g.connectNullData?(f.setLineDash&&(g.options.nullDataLineDashType||c===g.lineDashType&&g.lineDashType!==g.nullDataLineDashType)&&(d=m,c=t,m=n.x,t=n.y,b(),f.moveTo(n.x,n.y),m=d,t=c,H=n,c=g.nullDataLineDashType,f.setLineDash(L)),f.lineTo(m,
t),w&&l.lineTo(m,t)):(f.beginPath(),f.moveTo(m,t),w&&(l.beginPath(),l.moveTo(m,t)),H={x:m,y:t}),ea=d=!1):(f.lineTo(m,t),w&&l.lineTo(m,t),0==h%250&&b());n={x:m,y:t};h<r.length-1&&(A!==(r[h].lineColor||v)||c!==(r[h].lineDashType||g.lineDashType))&&(b(),A=r[h].lineColor||v,f.strokeStyle=A,f.setLineDash&&(r[h].lineDashType?(c=r[h].lineDashType,f.setLineDash(J(c,g.lineThickness))):(c=g.lineDashType,f.setLineDash(S))));var $=g.dataPointIds[h];this._eventManager.objectMap[$]={id:$,objectType:"dataPoint",
dataSeriesIndex:q,dataPointIndex:h,x1:m,y1:t};0!==r[h].markerSize&&(0<r[h].markerSize||0<g.markerSize)&&(s=g.getMarkerProperties(h,m,t,f),D.push(s),$=X($),w&&D.push({x:m,y:t,ctx:l,type:s.type,size:s.size,color:$,borderColor:$,borderThickness:s.borderThickness}));(r[h].indexLabel||g.indexLabel||r[h].indexLabelFormatter||g.indexLabelFormatter)&&this._indexLabels.push({chartType:"area",dataPoint:r[h],dataSeries:g,point:{x:m,y:t},direction:0>r[h].y===a.axisY.reversed?1:-1,color:C})}b();W.drawMarkers(D)}}w&&
...
0<=a.axisY.viewportMaximum?s=m:0>a.axisY.viewportMaximum?s=f.y1:0<a.axisY.viewportMinimum&&(s=m);t={x:c[0].x,y:c[0].y};b.lineTo(c[c.length-1].x,s);b.lineTo(t.x,s);b.closePath();b.globalAlpha=n.fillOpacity;b.fill();b.globalAlpha=1;w&&(e.lineTo(c[c.length-1].x,s),e.lineTo(t.x,s),e.closePath(),e.fill())}}var c=a.targetCanvasCtx||this.plotArea.ctx,b=w?this._preRenderCtx:c;if(!(0>=a.dataSeriesIndexes.length)){var e=this._eventManager.ghostCtx,f=a.axisY.lineCoordinates,l=[],u=this.plotArea;b.save();w&&
e.save();b.beginPath();b.rect(u.x1,u.y1,u.width,u.height);b.clip();w&&(e.beginPath(),e.rect(u.x1,u.y1,u.width,u.height),e.clip());for(var h=0;h<a.dataSeriesIndexes.length;h++){var k=a.dataSeriesIndexes[h],n=this.data[k],p=n.dataPoints,l=n.id;this._eventManager.objectMap[l]={objectType:"dataSeries",dataSeriesIndex:k};l=X(l);e.fillStyle=l;var l=[],q=0,g,r,m=a.axisY.convertValueToPixel(a.axisY.logarithmic?a.axisY.viewportMinimum:0),s,t=null,x=[];if(0<p.length){var y=n._colorSet[q%n._colorSet.length],
z=n.lineColor=n.options.lineColor||y,H=z;b.fillStyle=y;b.strokeStyle=z;b.lineWidth=n.lineThickness;var C="solid";if(b.setLineDash){var A=J(n.nullDataLineDashType,n.lineThickness),C=n.lineDashType,B=J(C,n.lineThickness);b.setLineDash(B)}for(r=!1;q<p.length;q++)if(g=p[q].x.getTime?p[q].x.getTime():p[q].x,!(g<a.axisX.dataInfo.viewPortMin||g>a.axisX.dataInfo.viewPortMax&&(!n.connectNullData||!r)))if("number"!==typeof p[q].y)0<q&&!r&&(n.connectNullData?b.setLineDash&&(0<x.length&&(n.options.nullDataLineDashType||
!p[q-1].lineDashType))&&(x[x.length-1].newLineDashArray=A,C=n.nullDataLineDashType):(d(),x=[])),r=!0;else{g=a.axisX.convertValueToPixel(g);r=a.axisY.convertValueToPixel(p[q].y);var L=n.dataPointIds[q];this._eventManager.objectMap[L]={id:L,objectType:"dataPoint",dataSeriesIndex:k,dataPointIndex:q,x1:g,y1:r};x[x.length]={x:g,y:r};q<p.length-1&&(H!==(p[q].lineColor||z)||C!==(p[q].lineDashType||n.lineDashType))&&(H=p[q].lineColor||z,x[x.length-1].newStrokeStyle=H,b.setLineDash&&(p[q].lineDashType?(C=
p[q].lineDashType,x[x.length-1].newLineDashArray=J(C,n.lineThickness)):(C=n.lineDashType,x[x.length-1].newLineDashArray=B)));if(0!==p[q].markerSize&&(0<p[q].markerSize||0<n.markerSize)){var S=n.getMarkerProperties(q,g,r,b);l.push(S);L=X(L);w&&l.push({x:g,y:r,ctx:e,type:S.type,size:S.size,color:L,borderColor:L,borderThickness:S.borderThickness})}(p[q].indexLabel||n.indexLabel||p[q].indexLabelFormatter||n.indexLabelFormatter)&&this._indexLabels.push({chartType:"splineArea",dataPoint:p[q],dataSeries:n,
point:{x:g,y:r},direction:0>p[q].y===a.axisY.reversed?1:-1,color:y});r=!1}d();W.drawMarkers(l)}}w&&(c.drawImage(this._preRenderCanvas,0,0,this.width,this.height),b.globalCompositeOperation="source-atop",a.axisX.maskCanvas&&b.drawImage(a.axisX.maskCanvas,0,0,this.width,this.height),a.axisY.maskCanvas&&b.drawImage(a.axisY.maskCanvas,0,0,this.width,this.height),this._breaksCanvasCtx&&this._breaksCanvasCtx.drawImage(this._preRenderCanvas,0,0,this.width,this.height),b.clearRect(u.x1,u.y1,u.width,u.height),
this._eventManager.ghostCtx.restore());b.restore();return{source:c,dest:this.plotArea.ctx,animationCallback:M.xClipAnimation,easingFunction:M.easing.linear,animationBase:0}}};m.prototype.renderStepArea=function(a){var d,c;function b(){H&&(0<g.lineThickness&&f.stroke(),a.axisY.logarithmic||0>=a.axisY.viewportMinimum&&0<=a.axisY.viewportMaximum?z=y:0>a.axisY.viewportMaximum?z=u.y1:0<a.axisY.viewportMinimum&&(z=y),f.lineTo(s,z),f.lineTo(H.x,z),f.closePath(),f.globalAlpha=g.fillOpacity,f.fill(),f.globalAlpha=
1,w&&(l.lineTo(s,z),l.lineTo(H.x,z),l.closePath(),l.fill()),f.beginPath(),f.moveTo(s,t),l.beginPath(),l.moveTo(s,t),H={x:s,y:t})}var e=a.targetCanvasCtx||this.plotArea.ctx,f=w?this._preRenderCtx:e;if(!(0>=a.dataSeriesIndexes.length)){var l=this._eventManager.ghostCtx,u=a.axisY.lineCoordinates,h=[],k=this.plotArea,n;f.save();w&&l.save();f.beginPath();f.rect(k.x1,k.y1,k.width,k.height);f.clip();w&&(l.beginPath(),l.rect(k.x1,k.y1,k.width,k.height),l.clip());for(var p=0;p<a.dataSeriesIndexes.length;p++){var q=
a.dataSeriesIndexes[p],g=this.data[q],r=g.dataPoints,h=g.id;this._eventManager.objectMap[h]={objectType:"dataSeries",dataSeriesIndex:q};h=X(h);l.fillStyle=h;h=[];d=!0;var m=0,s,t,x,y=a.axisY.convertValueToPixel(a.axisY.logarithmic?a.axisY.viewportMinimum:0),z,H=null;c=!1;if(0<r.length){var C=g._colorSet[m%g._colorSet.length],v=g.lineColor=g.options.lineColor||C,A=v;f.fillStyle=C;f.strokeStyle=v;f.lineWidth=g.lineThickness;var L="solid";if(f.setLineDash){var S=J(g.nullDataLineDashType,g.lineThickness),
L=g.lineDashType,B=J(L,g.lineThickness);f.setLineDash(B)}for(;m<r.length;m++)if(x=r[m].x.getTime?r[m].x.getTime():r[m].x,!(x<a.axisX.dataInfo.viewPortMin||x>a.axisX.dataInfo.viewPortMax&&(!g.connectNullData||!c))){var $=t;"number"!==typeof r[m].y?(g.connectNullData||(c||d)||b(),c=!0):(s=a.axisX.convertValueToPixel(x),t=a.axisY.convertValueToPixel(r[m].y),d||c?(!d&&g.connectNullData?(f.setLineDash&&(g.options.nullDataLineDashType||L===g.lineDashType&&g.lineDashType!==g.nullDataLineDashType)&&(d=s,
c=t,s=n.x,t=n.y,b(),f.moveTo(n.x,n.y),s=d,t=c,H=n,L=g.nullDataLineDashType,f.setLineDash(S)),f.lineTo(s,$),f.lineTo(s,t),w&&(l.lineTo(s,$),l.lineTo(s,t))):(f.beginPath(),f.moveTo(s,t),w&&(l.beginPath(),l.moveTo(s,t)),H={x:s,y:t}),c=d=!1):(f.lineTo(s,$),w&&l.lineTo(s,$),f.lineTo(s,t),w&&l.lineTo(s,t),0==m%250&&b()),n={x:s,y:t},m<r.length-1&&(A!==(r[m].lineColor||v)||L!==(r[m].lineDashType||g.lineDashType))&&(b(),A=r[m].lineColor||v,f.strokeStyle=A,f.setLineDash&&(r[m].lineDashType?(L=r[m].lineDashType,
f.setLineDash(J(L,g.lineThickness))):(L=g.lineDashType,f.setLineDash(B)))),x=g.dataPointIds[m],this._eventManager.objectMap[x]={id:x,objectType:"dataPoint",dataSeriesIndex:q,dataPointIndex:m,x1:s,y1:t},0!==r[m].markerSize&&(0<r[m].markerSize||0<g.markerSize)&&($=g.getMarkerProperties(m,s,t,f),h.push($),x=X(x),w&&h.push({x:s,y:t,ctx:l,type:$.type,size:$.size,color:x,borderColor:x,borderThickness:$.borderThickness})),(r[m].indexLabel||g.indexLabel||r[m].indexLabelFormatter||g.indexLabelFormatter)&&
this._indexLabels.push({chartType:"stepArea",dataPoint:r[m],dataSeries:g,point:{x:s,y:t},direction:0>r[m].y===a.axisY.reversed?1:-1,color:C}))}b();W.drawMarkers(h)}}w&&(e.drawImage(this._preRenderCanvas,0,0,this.width,this.height),f.globalCompositeOperation="source-atop",a.axisX.maskCanvas&&f.drawImage(a.axisX.maskCanvas,0,0,this.width,this.height),a.axisY.maskCanvas&&f.drawImage(a.axisY.maskCanvas,0,0,this.width,this.height),this._breaksCanvasCtx&&this._breaksCanvasCtx.drawImage(this._preRenderCanvas,
0,0,this.width,this.height),f.clearRect(k.x1,k.y1,k.width,k.height),this._eventManager.ghostCtx.restore());f.restore();return{source:e,dest:this.plotArea.ctx,animationCallback:M.xClipAnimation,easingFunction:M.easing.linear,animationBase:0}}};m.prototype.renderStackedArea=function(a){function d(){if(!(1>k.length)){for(0<C.lineThickness&&b.stroke();0<k.length;){var a=k.pop();b.lineTo(a.x,a.y);w&&s.lineTo(a.x,a.y)}b.closePath();b.globalAlpha=C.fillOpacity;b.fill();b.globalAlpha=1;b.beginPath();w&&(s.closePath(),
s.fill(),s.beginPath());k=[]}}var c=a.targetCanvasCtx||this.plotArea.ctx,b=w?this._preRenderCtx:c;if(!(0>=a.dataSeriesIndexes.length)){var e=null,f=null,l=[],u=this.plotArea,h=[],k=[],n=[],p=[],q=0,g,r,m=a.axisY.convertValueToPixel(a.axisY.logarithmic?a.axisY.viewportMinimum:0),s=this._eventManager.ghostCtx,t,x,y;w&&s.beginPath();b.save();w&&s.save();b.beginPath();b.rect(u.x1,u.y1,u.width,u.height);b.clip();w&&(s.beginPath(),s.rect(u.x1,u.y1,u.width,u.height),s.clip());for(var e=[],z=0;z<a.dataSeriesIndexes.length;z++){var H=
a.dataSeriesIndexes[z],C=this.data[H],v=C.dataPoints;C.dataPointIndexes=[];for(q=0;q<v.length;q++)H=v[q].x.getTime?v[q].x.getTime():v[q].x,C.dataPointIndexes[H]=q,e[H]||(n.push(H),e[H]=!0);n.sort(Ra)}for(z=0;z<a.dataSeriesIndexes.length;z++){H=a.dataSeriesIndexes[z];C=this.data[H];v=C.dataPoints;x=!0;k=[];q=C.id;this._eventManager.objectMap[q]={objectType:"dataSeries",dataSeriesIndex:H};q=X(q);s.fillStyle=q;if(0<n.length){var e=C._colorSet[0],A=C.lineColor=C.options.lineColor||e,L=A;b.fillStyle=e;
...
h[f]?h[f]:0;if(a.axisY.logarithmic||a.axisY.scaleBreaks&&0<a.axisY.scaleBreaks._appliedBreaks.length){p[f]=ga.y+(p[f]?p[f]:0);if(0>=p[f]&&a.axisY.logarithmic)continue;r=a.axisY.convertValueToPixel(p[f])}else r=a.axisY.convertValueToPixel(ga.y),r-=na;k.push({x:g,y:m-na});h[f]=m-r;x||$?(!x&&C.connectNullData?(b.setLineDash&&(C.options.nullDataLineDashType||y===C.lineDashType&&C.lineDashType!==C.nullDataLineDashType)&&(x=k.pop(),y=k[k.length-1],d(),b.moveTo(t.x,t.y),k.push(y),k.push(x),y=C.nullDataLineDashType,
b.setLineDash(S)),b.lineTo(g,r),w&&s.lineTo(g,r)):(b.beginPath(),b.moveTo(g,r),w&&(s.beginPath(),s.moveTo(g,r))),$=x=!1):(b.lineTo(g,r),w&&s.lineTo(g,r),0==q%250&&(d(),b.moveTo(g,r),w&&s.moveTo(g,r),k.push({x:g,y:m-na})));t={x:g,y:r};q<v.length-1&&(L!==(v[q].lineColor||A)||y!==(v[q].lineDashType||C.lineDashType))&&(d(),b.beginPath(),b.moveTo(g,r),k.push({x:g,y:m-na}),L=v[q].lineColor||A,b.strokeStyle=L,b.setLineDash&&(v[q].lineDashType?(y=v[q].lineDashType,b.setLineDash(J(y,C.lineThickness))):(y=
C.lineDashType,b.setLineDash(B))));if(0<=C.dataPointIndexes[f]){var ka=C.dataPointIds[C.dataPointIndexes[f]];this._eventManager.objectMap[ka]={id:ka,objectType:"dataPoint",dataSeriesIndex:H,dataPointIndex:C.dataPointIndexes[f],x1:g,y1:r}}0<=C.dataPointIndexes[f]&&0!==ga.markerSize&&(0<ga.markerSize||0<C.markerSize)&&(na=C.getMarkerProperties(C.dataPointIndexes[f],g,r,b),l.push(na),f=X(ka),w&&l.push({x:g,y:r,ctx:s,type:na.type,size:na.size,color:f,borderColor:f,borderThickness:na.borderThickness}));
(ga.indexLabel||C.indexLabel||ga.indexLabelFormatter||C.indexLabelFormatter)&&this._indexLabels.push({chartType:"stackedArea",dataPoint:ga,dataSeries:C,point:{x:g,y:r},direction:0>v[q].y===a.axisY.reversed?1:-1,color:e})}}d();b.moveTo(g,r);w&&s.moveTo(g,r)}delete C.dataPointIndexes}W.drawMarkers(l);w&&(c.drawImage(this._preRenderCanvas,0,0,this.width,this.height),b.globalCompositeOperation="source-atop",a.axisX.maskCanvas&&b.drawImage(a.axisX.maskCanvas,0,0,this.width,this.height),a.axisY.maskCanvas&&
b.drawImage(a.axisY.maskCanvas,0,0,this.width,this.height),this._breaksCanvasCtx&&this._breaksCanvasCtx.drawImage(this._preRenderCanvas,0,0,this.width,this.height),b.clearRect(u.x1,u.y1,u.width,u.height),s.restore());b.restore();return{source:c,dest:this.plotArea.ctx,animationCallback:M.xClipAnimation,easingFunction:M.easing.linear,animationBase:0}}};m.prototype.renderStackedArea100=function(a){function d(){for(0<C.lineThickness&&b.stroke();0<k.length;){var a=k.pop();b.lineTo(a.x,a.y);w&&y.lineTo(a.x,
a.y)}b.closePath();b.globalAlpha=C.fillOpacity;b.fill();b.globalAlpha=1;b.beginPath();w&&(y.closePath(),y.fill(),y.beginPath());k=[]}var c=a.targetCanvasCtx||this.plotArea.ctx,b=w?this._preRenderCtx:c;if(!(0>=a.dataSeriesIndexes.length)){var e=null,f=null,l=this.plotArea,u=[],h=[],k=[],n=[],p=[],q=0,g,r,m,s,t,x=a.axisY.convertValueToPixel(a.axisY.logarithmic?a.axisY.viewportMinimum:0),y=this._eventManager.ghostCtx;b.save();w&&y.save();b.beginPath();b.rect(l.x1,l.y1,l.width,l.height);b.clip();w&&(y.beginPath(),
y.rect(l.x1,l.y1,l.width,l.height),y.clip());for(var e=[],z=0;z<a.dataSeriesIndexes.length;z++){var H=a.dataSeriesIndexes[z],C=this.data[H],v=C.dataPoints;C.dataPointIndexes=[];for(q=0;q<v.length;q++)H=v[q].x.getTime?v[q].x.getTime():v[q].x,C.dataPointIndexes[H]=q,e[H]||(n.push(H),e[H]=!0);n.sort(Ra)}for(z=0;z<a.dataSeriesIndexes.length;z++){H=a.dataSeriesIndexes[z];C=this.data[H];v=C.dataPoints;s=!0;e=C.id;this._eventManager.objectMap[e]={objectType:"dataSeries",dataSeriesIndex:H};e=X(e);y.fillStyle=
...
!$)))if("number"!==typeof ga.y)C.connectNullData||($||s)||d(),$=!0;else{var na;na=0!==a.dataPointYSums[f]?100*(ga.y/a.dataPointYSums[f]):0;g=a.axisX.convertValueToPixel(f);var ka=h[f]?h[f]:0;if(a.axisY.logarithmic||a.axisY.scaleBreaks&&0<a.axisY.scaleBreaks._appliedBreaks.length){p[f]=na+(p[f]?p[f]:0);if(0>=p[f]&&a.axisY.logarithmic)continue;r=a.axisY.convertValueToPixel(p[f])}else r=a.axisY.convertValueToPixel(na),r-=ka;k.push({x:g,y:x-ka});h[f]=x-r;s||$?(!s&&C.connectNullData?(b.setLineDash&&(C.options.nullDataLineDashType||
t===C.lineDashType&&C.lineDashType!==C.nullDataLineDashType)&&(s=k.pop(),t=k[k.length-1],d(),b.moveTo(m.x,m.y),k.push(t),k.push(s),t=C.nullDataLineDashType,b.setLineDash(S)),b.lineTo(g,r),w&&y.lineTo(g,r)):(b.beginPath(),b.moveTo(g,r),w&&(y.beginPath(),y.moveTo(g,r))),$=s=!1):(b.lineTo(g,r),w&&y.lineTo(g,r),0==q%250&&(d(),b.moveTo(g,r),w&&y.moveTo(g,r),k.push({x:g,y:x-ka})));m={x:g,y:r};q<v.length-1&&(L!==(v[q].lineColor||A)||t!==(v[q].lineDashType||C.lineDashType))&&(d(),b.beginPath(),b.moveTo(g,
r),k.push({x:g,y:x-ka}),L=v[q].lineColor||A,b.strokeStyle=L,b.setLineDash&&(v[q].lineDashType?(t=v[q].lineDashType,b.setLineDash(J(t,C.lineThickness))):(t=C.lineDashType,b.setLineDash(B))));if(0<=C.dataPointIndexes[f]){var F=C.dataPointIds[C.dataPointIndexes[f]];this._eventManager.objectMap[F]={id:F,objectType:"dataPoint",dataSeriesIndex:H,dataPointIndex:C.dataPointIndexes[f],x1:g,y1:r}}0<=C.dataPointIndexes[f]&&0!==ga.markerSize&&(0<ga.markerSize||0<C.markerSize)&&(ka=C.getMarkerProperties(q,g,r,
b),u.push(ka),f=X(F),w&&u.push({x:g,y:r,ctx:y,type:ka.type,size:ka.size,color:f,borderColor:f,borderThickness:ka.borderThickness}));(ga.indexLabel||C.indexLabel||ga.indexLabelFormatter||C.indexLabelFormatter)&&this._indexLabels.push({chartType:"stackedArea100",dataPoint:ga,dataSeries:C,point:{x:g,y:r},direction:0>v[q].y===a.axisY.reversed?1:-1,color:e})}}d();b.moveTo(g,r);w&&y.moveTo(g,r)}delete C.dataPointIndexes}W.drawMarkers(u);w&&(c.drawImage(this._preRenderCanvas,0,0,this.width,this.height),
...
s=X(t);w&&W.drawMarker(f,l,this._eventManager.ghostCtx,g.type,g.size,s,s,g.borderThickness);(q[e].indexLabel||p.indexLabel||q[e].indexLabelFormatter||p.indexLabelFormatter)&&this._indexLabels.push({chartType:"bubble",dataPoint:q[e],dataSeries:p,point:{x:f,y:l},direction:1,bounds:{x1:f-g.size/2,y1:l-g.size/2,x2:f+g.size/2,y2:l+g.size/2},color:null})}w&&(d.drawImage(this._preRenderCanvas,0,0,this.width,this.height),c.globalCompositeOperation="source-atop",a.axisX.maskCanvas&&c.drawImage(a.axisX.maskCanvas,
...
this.plotArea.height)||(p=k.dataPointIds[e],this._eventManager.objectMap[p]={id:p,objectType:"dataPoint",dataSeriesIndex:h,dataPointIndex:e,x1:f,y1:l},p=X(p),w&&W.drawMarker(g.x,g.y,this._eventManager.ghostCtx,g.type,g.size,p,p,g.borderThickness),(n[e].indexLabel||k.indexLabel||n[e].indexLabelFormatter||k.indexLabelFormatter)&&this._indexLabels.push({chartType:"scatter",dataPoint:n[e],dataSeries:k,point:{x:f,y:l},direction:1,bounds:{x1:f-g.size/2,y1:l-g.size/2,x2:f+g.size/2,y2:l+g.size/2},color:null}),
...
e&&(r=e);r>f&&(r=f);c.save();w&&b.save();c.beginPath();c.rect(l.x1,l.y1,l.width,l.height);c.clip();w&&(b.beginPath(),b.rect(l.x1,l.y1,l.width,l.height),b.clip());for(var m=0;m<a.dataSeriesIndexes.length;m++){var da=a.dataSeriesIndexes[m],t=this.data[da],x=t.dataPoints;if(0<x.length)for(var y=5<r&&t.bevelEnabled?!0:!1,u=0;u<x.length;u++)if(x[u].getTime?g=x[u].x.getTime():g=x[u].x,!(g<a.axisX.dataInfo.viewPortMin||g>a.axisX.dataInfo.viewPortMax)&&!s(x[u].y)&&x[u].y.length&&"number"===typeof x[u].y[0]&&
"number"===typeof x[u].y[1]&&"number"===typeof x[u].y[2]&&"number"===typeof x[u].y[3]){h=a.axisX.convertValueToPixel(g);k=a.axisY.convertValueToPixel(x[u].y[0]);n=a.axisY.convertValueToPixel(x[u].y[1]);p=a.axisY.convertValueToPixel(x[u].y[2]);q=a.axisY.convertValueToPixel(x[u].y[3]);var z=h-r/2<<0,H=z+r<<0,f=t.options.fallingColor?t.fallingColor:t._colorSet[0],e=x[u].color?x[u].color:t._colorSet[0],C=Math.round(Math.max(1,0.15*r)),v=0===C%2?0:0.5,A=t.dataPointIds[u];this._eventManager.objectMap[A]=
...
if(0<y.length)for(var z=5<r&&x.bevelEnabled?!0:!1,l=0;l<y.length;l++)if(y[l].getTime?g=y[l].x.getTime():g=y[l].x,!(g<a.axisX.dataInfo.viewPortMin||g>a.axisX.dataInfo.viewPortMax)&&!s(y[l].y)&&y[l].y.length&&"number"===typeof y[l].y[0]&&"number"===typeof y[l].y[1]&&"number"===typeof y[l].y[2]&&"number"===typeof y[l].y[3]&&"number"===typeof y[l].y[4]&&5===y[l].y.length){u=a.axisX.convertValueToPixel(g);h=a.axisY.convertValueToPixel(y[l].y[0]);k=a.axisY.convertValueToPixel(y[l].y[1]);n=a.axisY.convertValueToPixel(y[l].y[2]);
p=a.axisY.convertValueToPixel(y[l].y[3]);q=a.axisY.convertValueToPixel(y[l].y[4]);var v=u-r/2<<0,C=u+r/2<<0,e=y[l].color?y[l].color:x._colorSet[0],A=Math.round(Math.max(1,0.15*r)),B=0===A%2?0:0.5,L=y[l].whiskerColor?y[l].whiskerColor:y[l].color?x.whiskerColor?x.whiskerColor:y[l].color:x.whiskerColor?x.whiskerColor:e,S="number"===typeof y[l].whiskerThickness?y[l].whiskerThickness:"number"===typeof x.options.whiskerThickness?x.whiskerThickness:A,ea=y[l].whiskerDashType?y[l].whiskerDashType:x.whiskerDashType,
$=s(y[l].whiskerLength)?s(x.options.whiskerLength)?r:x.whiskerLength:y[l].whiskerLength,$="number"===typeof $?0>=$?0:$>=r?r:$:"string"===typeof $?parseInt($)*r/100>r?r:parseInt($)*r/100:r,ga=1===Math.round(S)%2?0.5:0,na=y[l].stemColor?y[l].stemColor:y[l].color?x.stemColor?x.stemColor:y[l].color:x.stemColor?x.stemColor:e,ka="number"===typeof y[l].stemThickness?y[l].stemThickness:"number"===typeof x.options.stemThickness?x.stemThickness:A,F=1===Math.round(ka)%2?0.5:0,E=y[l].stemDashType?y[l].stemDashType:
x.stemDashType,K=y[l].lineColor?y[l].lineColor:y[l].color?x.lineColor?x.lineColor:y[l].color:x.lineColor?x.lineColor:e,G="number"===typeof y[l].lineThickness?y[l].lineThickness:"number"===typeof x.options.lineThickness?x.lineThickness:A,O=y[l].lineDashType?y[l].lineDashType:x.lineDashType,N=1===Math.round(G)%2?0.5:0,P=x.upperBoxColor,Q=x.lowerBoxColor,sa=s(x.options.fillOpacity)?1:x.fillOpacity,R=x.dataPointIds[l];this._eventManager.objectMap[R]={id:R,objectType:"dataPoint",dataSeriesIndex:t,dataPointIndex:l,
x1:v,y1:h,x2:C,y2:k,x3:u,y3:n,x4:u,y4:p,y5:q,borderThickness:A,color:e,stemThickness:ka,stemColor:na,whiskerThickness:S,whiskerLength:$,whiskerColor:L,lineThickness:G,lineColor:K};c.save();0<ka&&(c.beginPath(),c.strokeStyle=na,c.lineWidth=ka,c.setLineDash&&c.setLineDash(J(E,ka)),c.moveTo(u-F,k),c.lineTo(u-F,h),c.stroke(),c.moveTo(u-F,p),c.lineTo(u-F,n),c.stroke());c.restore();b.lineWidth=Math.max(A,4);c.beginPath();Y(c,v,Math.min(q,k),C,Math.max(k,q),Q,0,e,m?z:!1,m?!1:z,!1,!1,sa);c.beginPath();Y(c,
v,Math.min(n,q),C,Math.max(q,n),P,0,e,m?!1:z,m?z:!1,!1,!1,sa);c.beginPath();c.lineWidth=A;c.strokeStyle=e;c.rect(v-B,Math.min(k,n)-B,C-v+2*B,Math.max(k,n)-Math.min(k,n)+2*B);c.stroke();c.save();0<G&&(c.beginPath(),c.globalAlpha=1,c.setLineDash&&c.setLineDash(J(O,G)),c.strokeStyle=K,c.lineWidth=G,c.moveTo(v,q-N),c.lineTo(C,q-N),c.stroke());c.restore();c.save();0<S&&(c.beginPath(),c.setLineDash&&c.setLineDash(J(ea,S)),c.strokeStyle=L,c.lineWidth=S,c.moveTo(u-$/2<<0,p-ga),c.lineTo(u+$/2<<0,p-ga),c.stroke(),
c.moveTo(u-$/2<<0,h+ga),c.lineTo(u+$/2<<0,h+ga),c.stroke());c.restore();w&&(e=X(R),b.strokeStyle=e,b.lineWidth=ka,0<ka&&(b.moveTo(u-B-F,k),b.lineTo(u-B-F,Math.max(h,p)),b.stroke(),b.moveTo(u-B-F,Math.min(h,p)),b.lineTo(u-B-F,n),b.stroke()),Y(b,v,Math.max(k,n),C,Math.min(k,n),e,0,null,!1,!1,!1,!1),0<S&&(b.beginPath(),b.lineWidth=S,b.moveTo(u+$/2,p-ga),b.lineTo(u-$/2,p-ga),b.stroke(),b.moveTo(u+$/2,h+ga),b.lineTo(u-$/2,h+ga),b.stroke()));(y[l].indexLabel||x.indexLabel||y[l].indexLabelFormatter||x.indexLabelFormatter)&&
...
n)*k<<0,da=a.axisX.reversed?m-k<<0:m+k<<0,b=g[f].color?g[f].color:q._colorSet[f%q._colorSet.length];if(l>u){var t=l;l=u;u=t}t=q.dataPointIds[f];this._eventManager.objectMap[t]={id:t,objectType:"dataPoint",dataSeriesIndex:p,dataPointIndex:f,x1:m,y1:l,x2:da,y2:u};Y(c,a.axisX.reversed?da:m,l,a.axisX.reversed?m:da,u,b,0,b,r,r,!1,!1,q.fillOpacity);b=X(t);w&&Y(this._eventManager.ghostCtx,a.axisX.reversed?da:m,l,a.axisX.reversed?m:da,u,b,0,null,!1,!1,!1,!1);if(g[f].indexLabel||q.indexLabel||g[f].indexLabelFormatter||
q.indexLabelFormatter)this._indexLabels.push({chartType:"rangeColumn",dataPoint:g[f],dataSeries:q,indexKeyword:0,point:{x:m+(da-m)/2,y:g[f].y[1]>=g[f].y[0]?u:l},direction:g[f].y[1]>=g[f].y[0]?-1:1,bounds:{x1:m,y1:Math.min(l,u),x2:da,y2:Math.max(l,u)},color:b}),this._indexLabels.push({chartType:"rangeColumn",dataPoint:g[f],dataSeries:q,indexKeyword:1,point:{x:m+(da-m)/2,y:g[f].y[1]>=g[f].y[0]?l:u},direction:g[f].y[1]>=g[f].y[0]?1:-1,bounds:{x1:m,y1:Math.min(l,u),x2:da,y2:Math.max(l,u)},color:b})}}w&&
...
(u=this.options.dataPointMaxWidth?this.dataPointMaxWidth:this.options.dataPointWidth?this.dataPointWidth:b?Math.min(0.15*this.height,0.9*(this.plotArea.height/(C?da:1)))<<0:0.03*this.width);t=this.options.dataPointWidth?this.dataPointWidth:0.9*((b?l.height:l.width)*(a.axisX.logarithmic?Math.log(m)/Math.log(a.axisX.range):Math.abs(m)/Math.abs(a.axisX.range))/(C?da:1))<<0;this.dataPointMaxWidth&&e>u&&(e=Math.min(this.options.dataPointWidth?this.dataPointWidth:Infinity,u));!this.dataPointMaxWidth&&(this.dataPointMinWidth&&
u<e)&&(u=Math.max(this.options.dataPointWidth?this.dataPointWidth:-Infinity,e));t<e&&(t=e);t>u&&(t=u);if(0<v.length)for(var E=z._colorSet,u=0;u<v.length;u++){var e=z.lineColor=z.options.color?z.options.color:E[0],L={color:v[u].whiskerColor?v[u].whiskerColor:v[u].color?z.whiskerColor?z.whiskerColor:v[u].color:z.whiskerColor?z.whiskerColor:e,thickness:s(v[u].whiskerThickness)?z.whiskerThickness:v[u].whiskerThickness,dashType:v[u].whiskerDashType?v[u].whiskerDashType:z.whiskerDashType,length:s(v[u].whiskerLength)?
s(z.options.whiskerLength)?t:z.options.whiskerLength:v[u].whiskerLength,trimLength:s(v[u].whiskerLength)?s(z.options.whiskerLength)?50:0:0};L.length="number"===typeof L.length?0>=L.length?0:L.length>=t?t:L.length:"string"===typeof L.length?parseInt(L.length)*t/100>t?t:parseInt(L.length)*t/100>t:t;L.thickness="number"===typeof L.thickness?0>L.thickness?0:Math.round(L.thickness):2;var S={color:v[u].stemColor?v[u].stemColor:v[u].color?z.stemColor?z.stemColor:v[u].color:z.stemColor?z.stemColor:e,thickness:v[u].stemThickness?
v[u].stemThickness:z.stemThickness,dashType:v[u].stemDashType?v[u].stemDashType:z.stemDashType};S.thickness="number"===typeof S.thickness?0>S.thickness?0:Math.round(S.thickness):2;v[u].getTime?r=v[u].x.getTime():r=v[u].x;if(!(r<a.axisX.dataInfo.viewPortMin||r>a.axisX.dataInfo.viewPortMax)&&!s(v[u].y)&&v[u].y.length&&"number"===typeof v[u].y[0]&&"number"===typeof v[u].y[1]){var ea=a.axisX.convertValueToPixel(r);b?k=ea:h=ea;ea=a.axisY.convertValueToPixel(v[u].y[0]);b?n=ea:q=ea;ea=a.axisY.convertValueToPixel(v[u].y[1]);
...
"number"===typeof r[f].y[1]){l=a.axisY.convertValueToPixel(r[f].y[0]);u=a.axisY.convertValueToPixel(r[f].y[1]);h=a.axisX.convertValueToPixel(k);h=a.axisX.reversed?h+a.plotType.totalDataSeries*n/2-(a.previousDataSeriesCount+p)*n<<0:h-a.plotType.totalDataSeries*n/2+(a.previousDataSeriesCount+p)*n<<0;var v=a.axisX.reversed?h-n<<0:h+n<<0;l>u&&(b=l,l=u,u=b);b=r[f].color?r[f].color:g._colorSet[f%g._colorSet.length];Y(c,l,a.axisX.reversed?v:h,u,a.axisX.reversed?h:v,b,0,null,m,!1,!1,!1,g.fillOpacity);b=g.dataPointIds[f];
this._eventManager.objectMap[b]={id:b,objectType:"dataPoint",dataSeriesIndex:q,dataPointIndex:f,x1:l,y1:h,x2:u,y2:v};b=X(b);w&&Y(this._eventManager.ghostCtx,l,a.axisX.reversed?v:h,u,a.axisX.reversed?h:v,b,0,null,!1,!1,!1,!1);if(r[f].indexLabel||g.indexLabel||r[f].indexLabelFormatter||g.indexLabelFormatter)this._indexLabels.push({chartType:"rangeBar",dataPoint:r[f],dataSeries:g,indexKeyword:0,point:{x:r[f].y[1]>=r[f].y[0]?l:u,y:h+(v-h)/2},direction:r[f].y[1]>=r[f].y[0]?-1:1,bounds:{x1:Math.min(l,u),
y1:h,x2:Math.max(l,u),y2:v},color:b}),this._indexLabels.push({chartType:"rangeBar",dataPoint:r[f],dataSeries:g,indexKeyword:1,point:{x:r[f].y[1]>=r[f].y[0]?u:l,y:h+(v-h)/2},direction:r[f].y[1]>=r[f].y[0]?1:-1,bounds:{x1:Math.min(l,u),y1:h,x2:Math.max(l,u),y2:v},color:b})}}}w&&(d.drawImage(this._preRenderCanvas,0,0,this.width,this.height),c.globalCompositeOperation="source-atop",a.axisX.maskCanvas&&c.drawImage(a.axisX.maskCanvas,0,0,this.width,this.height),a.axisY.maskCanvas&&c.drawImage(a.axisY.maskCanvas,
...
b.globalAlpha=n.fillOpacity;b.fill();b.globalAlpha=1;e.fill();if(0<n.lineThickness){b.beginPath();b.moveTo(a.x,a.y2);for(c=0;c<h.length;c++)a=h[c],b.lineTo(a.x,a.y2);b.moveTo(h[0].x,h[0].y1);for(c=0;c<h.length;c++)a=h[c],b.lineTo(a.x,a.y1);b.stroke()}b.beginPath();b.moveTo(r,m);e.beginPath();e.moveTo(r,m);x={x:r,y:m};h=[];h.push({x:r,y1:m,y2:s})}}var c=a.targetCanvasCtx||this.plotArea.ctx,b=w?this._preRenderCtx:c;if(!(0>=a.dataSeriesIndexes.length)){var e=this._eventManager.ghostCtx,f=[],l=this.plotArea;
b.save();w&&e.save();b.beginPath();b.rect(l.x1,l.y1,l.width,l.height);b.clip();w&&(e.beginPath(),e.rect(l.x1,l.y1,l.width,l.height),e.clip());for(var u=0;u<a.dataSeriesIndexes.length;u++){var h=[],k=a.dataSeriesIndexes[u],n=this.data[k],p=n.dataPoints,f=n.id;this._eventManager.objectMap[f]={objectType:"dataSeries",dataSeriesIndex:k};f=X(f);e.fillStyle=f;var f=[],q=!0,g=0,r,m,s,t,x=null;if(0<p.length){var y=n._colorSet[g%n._colorSet.length],v=n.lineColor=n.options.lineColor||y,A=v;b.fillStyle=y;b.strokeStyle=
v;b.lineWidth=n.lineThickness;var C="solid";if(b.setLineDash){var B=J(n.nullDataLineDashType,n.lineThickness),C=n.lineDashType,E=J(C,n.lineThickness);b.setLineDash(E)}for(var L=!0;g<p.length;g++)if(t=p[g].x.getTime?p[g].x.getTime():p[g].x,!(t<a.axisX.dataInfo.viewPortMin||t>a.axisX.dataInfo.viewPortMax&&(!n.connectNullData||!L)))if(null!==p[g].y&&p[g].y.length&&"number"===typeof p[g].y[0]&&"number"===typeof p[g].y[1]){r=a.axisX.convertValueToPixel(t);m=a.axisY.convertValueToPixel(p[g].y[0]);s=a.axisY.convertValueToPixel(p[g].y[1]);
q||L?(n.connectNullData&&!q?(b.setLineDash&&(n.options.nullDataLineDashType||C===n.lineDashType&&n.lineDashType!==n.nullDataLineDashType)&&(h[h.length-1].newLineDashArray=E,C=n.nullDataLineDashType,b.setLineDash(B)),b.lineTo(r,m),w&&e.lineTo(r,m),h.push({x:r,y1:m,y2:s})):(b.beginPath(),b.moveTo(r,m),x={x:r,y:m},h=[],h.push({x:r,y1:m,y2:s}),w&&(e.beginPath(),e.moveTo(r,m))),L=q=!1):(b.lineTo(r,m),h.push({x:r,y1:m,y2:s}),w&&e.lineTo(r,m),0==g%250&&d());t=n.dataPointIds[g];this._eventManager.objectMap[t]=
{id:t,objectType:"dataPoint",dataSeriesIndex:k,dataPointIndex:g,x1:r,y1:m,y2:s};g<p.length-1&&(A!==(p[g].lineColor||v)||C!==(p[g].lineDashType||n.lineDashType))&&(d(),A=p[g].lineColor||v,h[h.length-1].newStrokeStyle=A,b.strokeStyle=A,b.setLineDash&&(p[g].lineDashType?(C=p[g].lineDashType,h[h.length-1].newLineDashArray=J(C,n.lineThickness),b.setLineDash(h[h.length-1].newLineDashArray)):(C=n.lineDashType,h[h.length-1].newLineDashArray=E,b.setLineDash(E))));if(0!==p[g].markerSize&&(0<p[g].markerSize||
0<n.markerSize)){var S=n.getMarkerProperties(g,r,s,b);f.push(S);var ea=X(t);w&&f.push({x:r,y:s,ctx:e,type:S.type,size:S.size,color:ea,borderColor:ea,borderThickness:S.borderThickness});S=n.getMarkerProperties(g,r,m,b);f.push(S);ea=X(t);w&&f.push({x:r,y:m,ctx:e,type:S.type,size:S.size,color:ea,borderColor:ea,borderThickness:S.borderThickness})}if(p[g].indexLabel||n.indexLabel||p[g].indexLabelFormatter||n.indexLabelFormatter)this._indexLabels.push({chartType:"rangeArea",dataPoint:p[g],dataSeries:n,
indexKeyword:0,point:{x:r,y:m},direction:p[g].y[0]>p[g].y[1]===a.axisY.reversed?-1:1,color:y}),this._indexLabels.push({chartType:"rangeArea",dataPoint:p[g],dataSeries:n,indexKeyword:1,point:{x:r,y:s},direction:p[g].y[0]>p[g].y[1]===a.axisY.reversed?1:-1,color:y})}else L||q||d(),L=!0;d();W.drawMarkers(f)}}w&&(c.drawImage(this._preRenderCanvas,0,0,this.width,this.height),b.globalCompositeOperation="source-atop",a.axisX.maskCanvas&&b.drawImage(a.axisX.maskCanvas,0,0,this.width,this.height),a.axisY.maskCanvas&&
...
1].x,d[f+1].y,d[f+2].x,d[f+2].y,d[f+3].x,d[f+3].y),w&&e.bezierCurveTo(d[f+1].x,d[f+1].y,d[f+2].x,d[f+2].y,d[f+3].x,d[f+3].y);d=v(s,2);b.lineTo(s[s.length-1].x,s[s.length-1].y);for(f=d.length-1;2<f;f-=3)b.bezierCurveTo(d[f-1].x,d[f-1].y,d[f-2].x,d[f-2].y,d[f-3].x,d[f-3].y),w&&e.bezierCurveTo(d[f-1].x,d[f-1].y,d[f-2].x,d[f-2].y,d[f-3].x,d[f-3].y);b.closePath();b.globalAlpha=k.fillOpacity;b.fill();w&&(e.closePath(),e.fill());b.globalAlpha=1;if(0<k.lineThickness){b.strokeStyle=c;b.setLineDash&&b.setLineDash(a);
b.beginPath();b.moveTo(d[0].x,d[0].y);for(var g=f=0;f<d.length-3;f+=3,g++){if(m[g].newStrokeStyle||m[g].newLineDashArray)b.stroke(),b.beginPath(),b.moveTo(d[f].x,d[f].y),m[g].newStrokeStyle&&(b.strokeStyle=m[g].newStrokeStyle),m[g].newLineDashArray&&b.setLineDash(m[g].newLineDashArray);b.bezierCurveTo(d[f+1].x,d[f+1].y,d[f+2].x,d[f+2].y,d[f+3].x,d[f+3].y)}d=v(m,2);b.moveTo(d[0].x,d[0].y);for(g=f=0;f<d.length-3;f+=3,g++){if(m[g].newStrokeStyle||m[g].newLineDashArray)b.stroke(),b.beginPath(),b.moveTo(d[f].x,
d[f].y),m[g].newStrokeStyle&&(b.strokeStyle=m[g].newStrokeStyle),m[g].newLineDashArray&&b.setLineDash(m[g].newLineDashArray);b.bezierCurveTo(d[f+1].x,d[f+1].y,d[f+2].x,d[f+2].y,d[f+3].x,d[f+3].y)}b.stroke()}b.beginPath()}}var c=a.targetCanvasCtx||this.plotArea.ctx,b=w?this._preRenderCtx:c;if(!(0>=a.dataSeriesIndexes.length)){var e=this._eventManager.ghostCtx,f=[],l=this.plotArea;b.save();w&&e.save();b.beginPath();b.rect(l.x1,l.y1,l.width,l.height);b.clip();w&&(e.beginPath(),e.rect(l.x1,l.y1,l.width,
l.height),e.clip());for(var u=0;u<a.dataSeriesIndexes.length;u++){var h=a.dataSeriesIndexes[u],k=this.data[h],n=k.dataPoints,f=k.id;this._eventManager.objectMap[f]={objectType:"dataSeries",dataSeriesIndex:h};f=X(f);e.fillStyle=f;var f=[],p=0,q,g,r,m=[],s=[];if(0<n.length){var t=k._colorSet[p%k._colorSet.length],x=k.lineColor=k.options.lineColor||t,y=x;b.fillStyle=t;b.lineWidth=k.lineThickness;var z="solid",A;if(b.setLineDash){var C=J(k.nullDataLineDashType,k.lineThickness),z=k.lineDashType;A=J(z,
k.lineThickness)}for(g=!1;p<n.length;p++)if(q=n[p].x.getTime?n[p].x.getTime():n[p].x,!(q<a.axisX.dataInfo.viewPortMin||q>a.axisX.dataInfo.viewPortMax&&(!k.connectNullData||!g)))if(null!==n[p].y&&n[p].y.length&&"number"===typeof n[p].y[0]&&"number"===typeof n[p].y[1]){q=a.axisX.convertValueToPixel(q);g=a.axisY.convertValueToPixel(n[p].y[0]);r=a.axisY.convertValueToPixel(n[p].y[1]);var B=k.dataPointIds[p];this._eventManager.objectMap[B]={id:B,objectType:"dataPoint",dataSeriesIndex:h,dataPointIndex:p,
x1:q,y1:g,y2:r};m[m.length]={x:q,y:g};s[s.length]={x:q,y:r};p<n.length-1&&(y!==(n[p].lineColor||x)||z!==(n[p].lineDashType||k.lineDashType))&&(y=n[p].lineColor||x,m[m.length-1].newStrokeStyle=y,b.setLineDash&&(n[p].lineDashType?(z=n[p].lineDashType,m[m.length-1].newLineDashArray=J(z,k.lineThickness)):(z=k.lineDashType,m[m.length-1].newLineDashArray=A)));if(0!==n[p].markerSize&&(0<n[p].markerSize||0<k.markerSize)){var G=k.getMarkerProperties(p,q,g,b);f.push(G);var L=X(B);w&&f.push({x:q,y:g,ctx:e,type:G.type,
size:G.size,color:L,borderColor:L,borderThickness:G.borderThickness});G=k.getMarkerProperties(p,q,r,b);f.push(G);L=X(B);w&&f.push({x:q,y:r,ctx:e,type:G.type,size:G.size,color:L,borderColor:L,borderThickness:G.borderThickness})}if(n[p].indexLabel||k.indexLabel||n[p].indexLabelFormatter||k.indexLabelFormatter)this._indexLabels.push({chartType:"rangeSplineArea",dataPoint:n[p],dataSeries:k,indexKeyword:0,point:{x:q,y:g},direction:n[p].y[0]<=n[p].y[1]?-1:1,color:t}),this._indexLabels.push({chartType:"rangeSplineArea",
dataPoint:n[p],dataSeries:k,indexKeyword:1,point:{x:q,y:r},direction:n[p].y[0]<=n[p].y[1]?1:-1,color:t});g=!1}else 0<p&&!g&&(k.connectNullData?b.setLineDash&&(0<m.length&&(k.options.nullDataLineDashType||!n[p-1].lineDashType))&&(m[m.length-1].newLineDashArray=C,z=k.nullDataLineDashType):(d(A,x),m=[],s=[])),g=!0;d(A,x);W.drawMarkers(f)}}w&&(c.drawImage(this._preRenderCanvas,0,0,this.width,this.height),b.globalCompositeOperation="source-atop",a.axisX.maskCanvas&&b.drawImage(a.axisX.maskCanvas,0,0,this.width,
...
d;if(!(0>=a.dataSeriesIndexes.length)){var b=this._eventManager.ghostCtx,e=null,f=this.plotArea,l=0,h,m,k,n,p=a.axisY.convertValueToPixel(a.axisY.logarithmic?a.axisY.viewportMinimum:0),l=this.options.dataPointMinWidth?this.dataPointMinWidth:this.options.dataPointWidth?this.dataPointWidth:1;m=this.options.dataPointMaxWidth?this.dataPointMaxWidth:this.options.dataPointWidth?this.dataPointWidth:Math.min(0.15*this.width,0.9*(this.plotArea.width/a.plotType.totalDataSeries))<<0;var q=a.axisX.dataInfo.minDiff;
isFinite(q)||(q=0.3*Math.abs(a.axisX.range));q=this.options.dataPointWidth?this.dataPointWidth:0.6*(f.width*(a.axisX.logarithmic?Math.log(q)/Math.log(a.axisX.range):Math.abs(q)/Math.abs(a.axisX.range))/a.plotType.totalDataSeries)<<0;this.dataPointMaxWidth&&l>m&&(l=Math.min(this.options.dataPointWidth?this.dataPointWidth:Infinity,m));!this.dataPointMaxWidth&&(this.dataPointMinWidth&&m<l)&&(m=Math.max(this.options.dataPointWidth?this.dataPointWidth:-Infinity,l));q<l&&(q=l);q>m&&(q=m);c.save();w&&this._eventManager.ghostCtx.save();
...
1,x=1===Math.round(t)%2?-0.5:0;if(0<v.length)for(var y=5<q&&s.bevelEnabled?!0:!1,z=!1,A=null,C=null,l=0;l<v.length;l++)if(v[l].getTime?n=v[l].x.getTime():n=v[l].x,"number"!==typeof v[l].y){if(0<l&&!z&&s.connectNullData)var B=s.options.nullDataLineDashType||!v[l-1].lineDashType?s.nullDataLineDashType:v[l-1].lineDashType;z=!0}else{h=a.axisX.convertValueToPixel(n);m=0===s.dataPointEOs[l].cumulativeSum?p:a.axisY.convertValueToPixel(s.dataPointEOs[l].cumulativeSum);k=0===s.dataPointEOs[l].cumulativeSumYStartValue?
p:a.axisY.convertValueToPixel(s.dataPointEOs[l].cumulativeSumYStartValue);h=a.axisX.reversed?h+a.plotType.totalDataSeries*q/2-(a.previousDataSeriesCount+g)*q<<0:h-a.plotType.totalDataSeries*q/2+(a.previousDataSeriesCount+g)*q<<0;var E=a.axisX.reversed?h-q<<0:h+q<<0;m>k&&(e=m,m=k,k=e);a.axisY.reversed&&(e=m,m=k,k=e);e=s.dataPointIds[l];this._eventManager.objectMap[e]={id:e,objectType:"dataPoint",dataSeriesIndex:r,dataPointIndex:l,x1:h,y1:m,x2:E,y2:k};var L=v[l].color?v[l].color:0<v[l].y?s.risingColor:
s.fallingColor;Y(c,a.axisX.reversed?E:h,a.axisY.reversed?k:m,a.axisX.reversed?h:E,a.axisY.reversed?m:k,L,0,L,y,y,!1,!1,s.fillOpacity);e=X(e);w&&Y(this._eventManager.ghostCtx,a.axisX.reversed?E:h,m,a.axisX.reversed?h:E,k,e,0,null,!1,!1,!1,!1);var S,L=h;S="undefined"!==typeof v[l].isIntermediateSum&&!0===v[l].isIntermediateSum||"undefined"!==typeof v[l].isCumulativeSum&&!0===v[l].isCumulativeSum?0<v[l].y?m:k:0<v[l].y?k:m;0<l&&A&&(!z||s.connectNullData)&&(z&&c.setLineDash&&c.setLineDash(J(B,t)),c.beginPath(),
c.moveTo(A,C-x),c.lineTo(L,S-x),0<t&&c.stroke(),w&&(b.beginPath(),b.moveTo(A,C-x),b.lineTo(L,S-x),0<t&&b.stroke()));z=!1;A=E;C=0<v[l].y?m:k;L=v[l].lineDashType?v[l].lineDashType:s.options.lineDashType?s.options.lineDashType:"shortDash";c.strokeStyle=v[l].lineColor?v[l].lineColor:s.options.lineColor?s.options.lineColor:"#9e9e9e";c.lineWidth=t;c.setLineDash&&(L=J(L,t),c.setLineDash(L));(v[l].indexLabel||s.indexLabel||v[l].indexLabelFormatter||s.indexLabelFormatter)&&this._indexLabels.push({chartType:"waterfall",
dataPoint:v[l],dataSeries:s,point:{x:h+(E-h)/2,y:0<=v[l].y?m:k},direction:0>v[l].y===a.axisY.reversed?1:-1,bounds:{x1:h,y1:Math.min(m,k),x2:E,y2:Math.max(m,k)},color:e})}}w&&(d.drawImage(this._preRenderCanvas,0,0,this.width,this.height),c.globalCompositeOperation="source-atop",a.axisX.maskCanvas&&c.drawImage(a.axisX.maskCanvas,0,0,this.width,this.height),a.axisY.maskCanvas&&c.drawImage(a.axisY.maskCanvas,0,0,this.width,this.height),this._breaksCanvasCtx&&this._breaksCanvasCtx.drawImage(this._preRenderCanvas,
0,0,this.width,this.height),c.clearRect(f.x1,f.y1,f.width,f.height),this._eventManager.ghostCtx.restore());c.restore();return{source:d,dest:this.plotArea.ctx,animationCallback:M.fadeInAnimation,easingFunction:M.easing.easeInQuad,animationBase:0}}};var qa=function(a,d,c,b,e,f,l,h,m){if(!(0>c)){"undefined"===typeof h&&(h=1);if(!w){var k=Number((l%(2*Math.PI)).toFixed(8));Number((f%(2*Math.PI)).toFixed(8))===k&&(l-=1E-4)}a.save();a.globalAlpha=h;"pie"===e?(a.beginPath(),a.moveTo(d.x,d.y),a.arc(d.x,d.y,
...
{percent:null,total:null},u=null,p=m.getPercentAndTotal(k,f);if(k.indexLabelFormatter||f.indexLabelFormatter)u={chart:m.options,dataSeries:k,dataPoint:f,total:p.total,percent:p.percent};p=f.indexLabelFormatter?f.indexLabelFormatter(u):f.indexLabel?m.replaceKeywordsWithValue(f.indexLabel,f,k,e):k.indexLabelFormatter?k.indexLabelFormatter(u):k.indexLabel?m.replaceKeywordsWithValue(k.indexLabel,f,k,e):f.label?f.label:"";m._eventManager.objectMap[l]=h;h.center={x:y.x,y:y.y};h.y=f.y;h.radius=C;h.percentInnerRadius=
E;h.indexLabelText=p;h.indexLabelPlacement=k.indexLabelPlacement;h.indexLabelLineColor=f.indexLabelLineColor?f.indexLabelLineColor:k.options.indexLabelLineColor?k.options.indexLabelLineColor:f.color?f.color:k._colorSet[e%k._colorSet.length];h.indexLabelLineThickness=s(f.indexLabelLineThickness)?k.indexLabelLineThickness:f.indexLabelLineThickness;h.indexLabelLineDashType=f.indexLabelLineDashType?f.indexLabelLineDashType:k.indexLabelLineDashType;h.indexLabelFontColor=f.indexLabelFontColor?f.indexLabelFontColor:
...
(2*Math.PI);h.endAngle=h.startAngle+2*Math.PI/z*Math.abs(f.y);f=(h.endAngle+h.startAngle)/2;f=(f+2*Math.PI)%(2*Math.PI);h.midAngle=f;if(h.midAngle>Math.PI/2-t&&h.midAngle<Math.PI/2+t){if(0===a||g[c].midAngle>h.midAngle)c=e;a++}else if(h.midAngle>3*Math.PI/2-t&&h.midAngle<3*Math.PI/2+t){if(0===b||g[d].midAngle>h.midAngle)d=e;b++}h.hemisphere=f>Math.PI/2&&f<=3*Math.PI/2?"left":"right";h.indexLabelTextBlock=new ja(m.plotArea.ctx,{fontSize:h.indexLabelFontSize,fontFamily:h.indexLabelFontFamily,fontColor:h.indexLabelFontColor,
...
("right"===g[a].hemisphere?g[c].indexLabelTextBlock.y>=g[a].indexLabelTextBlock.y:g[c].indexLabelTextBlock.y<=g[a].indexLabelTextBlock.y)))break;else c=null;return c}function f(a,c,d){d=(d||0)+1;if(1E3<d)return 0;c=c||0;var l=0,k=y.y-1*w,h=y.y+1*w;if(0<=a&&a<n.length){var p=g[a];if(0>c&&p.indexLabelTextBlock.y<k||0<c&&p.indexLabelTextBlock.y>h)return 0;var q=0,m=0,m=q=q=0;0>c?p.indexLabelTextBlock.y-p.indexLabelTextBlock.height/2>k&&p.indexLabelTextBlock.y-p.indexLabelTextBlock.height/2+c<k&&(c=-(k-
(p.indexLabelTextBlock.y-p.indexLabelTextBlock.height/2+c))):p.indexLabelTextBlock.y+p.indexLabelTextBlock.height/2<k&&p.indexLabelTextBlock.y+p.indexLabelTextBlock.height/2+c>h&&(c=p.indexLabelTextBlock.y+p.indexLabelTextBlock.height/2+c-h);c=p.indexLabelTextBlock.y+c;k=0;k="right"===p.hemisphere?y.x+Math.sqrt(Math.pow(w,2)-Math.pow(c-y.y,2)):y.x-Math.sqrt(Math.pow(w,2)-Math.pow(c-y.y,2));m=y.x+C*Math.cos(p.midAngle);q=y.y+C*Math.sin(p.midAngle);q=Math.sqrt(Math.pow(k-m,2)+Math.pow(c-q,2));m=Math.acos(C/
w);q=Math.acos((w*w+C*C-q*q)/(2*C*w));c=q<m?c-p.indexLabelTextBlock.y:0;k=null;for(h=1;h<n.length;h++)if(k=(a-h+g.length)%g.length,g[k].hemisphere!==g[a].hemisphere){k=null;break}else if(g[k].indexLabelText&&g[k].hemisphere===g[a].hemisphere&&k!==a&&(0>b(g[k],g[a])||("right"===g[a].hemisphere?g[k].indexLabelTextBlock.y<=g[a].indexLabelTextBlock.y:g[k].indexLabelTextBlock.y>=g[a].indexLabelTextBlock.y)))break;else k=null;m=k;q=e(a);h=k=0;0>c?(h="right"===p.hemisphere?m:q,l=c,null!==h&&(m=-c,c=p.indexLabelTextBlock.y-
p.indexLabelTextBlock.height/2-(g[h].indexLabelTextBlock.y+g[h].indexLabelTextBlock.height/2),c-m<r&&(k=-m,h=f(h,k,d+1),+h.toFixed(x)>+k.toFixed(x)&&(l=c>r?-(c-r):-(m-(h-k)))))):0<c&&(h="right"===p.hemisphere?q:m,l=c,null!==h&&(m=c,c=g[h].indexLabelTextBlock.y-g[h].indexLabelTextBlock.height/2-(p.indexLabelTextBlock.y+p.indexLabelTextBlock.height/2),c-m<r&&(k=m,h=f(h,k,d+1),+h.toFixed(x)<+k.toFixed(x)&&(l=c>r?c-r:m-(k-h)))));l&&(d=p.indexLabelTextBlock.y+l,c=0,c="right"===p.hemisphere?y.x+Math.sqrt(Math.pow(w,
...
0;10>c&&(1>c||0<d);c++){if(k.radius||!k.radius&&"undefined"!==typeof k.innerRadius&&null!==k.innerRadius&&C-d<=B)l=!1;l&&(C-=d);d=0;if("inside"!==k.indexLabelPlacement){w=C*v;for(a=0;a<n.length;a++){var h=g[a];h.indexLabelTextBlock.x=y.x+w*Math.cos(h.midAngle);h.indexLabelTextBlock.y=y.y+w*Math.sin(h.midAngle);h.indexLabelAngle=h.midAngle;h.radius=C;h.percentInnerRadius=E}for(var u,s,a=0;a<n.length;a++){var h=g[a],t=e(a);if(null!==t){u=g[a];s=g[t];var z=0,z=b(u,s)-r;if(0>z){for(var A=s=0,H=0;H<n.length;H++)H!==
a&&g[H].hemisphere===h.hemisphere&&(g[H].indexLabelTextBlock.y<h.indexLabelTextBlock.y?s++:A++);s=z/(s+A||1)*A;var A=-1*(z-s),J=H=0;"right"===h.hemisphere?(H=f(a,s),A=-1*(z-H),J=f(t,A),+J.toFixed(x)<+A.toFixed(x)&&+H.toFixed(x)<=+s.toFixed(x)&&f(a,-(A-J))):(H=f(t,s),A=-1*(z-H),J=f(a,A),+J.toFixed(x)<+A.toFixed(x)&&+H.toFixed(x)<=+s.toFixed(x)&&f(t,-(A-J)))}}}}else for(a=0;a<n.length;a++)h=g[a],w="pie"===k.type?0.7*C:0.85*C,t=y.x+w*Math.cos(h.midAngle),s=y.y+w*Math.sin(h.midAngle),h.indexLabelTextBlock.x=
...
C,(C-1)/C);this.pieDoughnutClickHandler=function(a){m.isAnimating||!s(a.dataSeries.explodeOnClick)&&!a.dataSeries.explodeOnClick||(a=a.dataPoint,a.exploded=a.exploded?!1:!0,1<this.dataPoints.length&&m._animator.animate(0,500,function(a){c(a);h();m.dispatchEvent("dataAnimationIterationEnd",{chart:m});m.dispatchEvent("dataAnimationEnd",{chart:m})}))};d();l();l();l();l();this.disableToolTip=!0;this._animator.animate(0,this.animatedRender?this.animationDuration:0,function(a){var b=m.plotArea.ctx;b.clearRect(q.x1,
...
h+=n,h>e&&(h-=n,p=c,l=(b+p)*(e-h)/2,a-=l,n=e-h,h+=e-h,n+=a/p,h+=a/p,l=!0),b=p)),d.push(n);return d}function b(){if(t&&x){for(var a,b,c,d,e,f,k,l,h,n,p,q,m,u,r,D=[],y=[],v={percent:null,total:null},z=null,C=0;C<x.length;C++)r=R[C],r="undefined"!==typeof r.x5?(r.y2+r.y4)/2:(r.y2+r.y3)/2,r=g(r).x2+1,D[C]=K-r-X;r=0.5*X;for(var C=0,B=x.length-1;C<x.length||0<=B;C++,B--){b=t.reversed?x[B]:x[C];a=b.color?b.color:t.reversed?t._colorSet[(x.length-1-C)%t._colorSet.length]:t._colorSet[C%t._colorSet.length];
c=b.indexLabelPlacement||t.indexLabelPlacement||"outside";u=b.indexLabelTextAlign||t.indexLabelTextAlign||"left";d=b.indexLabelBackgroundColor||t.indexLabelBackgroundColor||(w?"transparent":null);e=b.indexLabelFontColor||t.indexLabelFontColor||"#979797";f=s(b.indexLabelFontSize)?t.indexLabelFontSize:b.indexLabelFontSize;k=b.indexLabelFontStyle||t.indexLabelFontStyle||"normal";l=b.indexLabelFontFamily||t.indexLabelFontFamily||"arial";h=b.indexLabelFontWeight||t.indexLabelFontWeight||"normal";a=b.indexLabelLineColor||
t.options.indexLabelLineColor||a;n="number"===typeof b.indexLabelLineThickness?b.indexLabelLineThickness:"number"===typeof t.indexLabelLineThickness?t.indexLabelLineThickness:2;p=b.indexLabelLineDashType||t.indexLabelLineDashType||"solid";q="undefined"!==typeof b.indexLabelWrap?b.indexLabelWrap:"undefined"!==typeof t.indexLabelWrap?t.indexLabelWrap:!0;m=t.dataPointIds[C];A._eventManager.objectMap[m]={id:m,objectType:"dataPoint",dataPointIndex:C,dataSeriesIndex:0,funnelSection:R[t.reversed?x.length-
1-C:C]};"inside"===t.indexLabelPlacement&&(D[C]=C!==ba?t.reversed?R[C].x2-R[C].x1:R[C].x3-R[C].x4:R[C].x3-R[C].x6,20>D[C]&&(D[C]=C!==ba?t.reversed?R[C].x3-R[C].x4:R[C].x2-R[C].x1:R[C].x2-R[C].x1,D[C]/=2));m=b.indexLabelMaxWidth?b.indexLabelMaxWidth:t.options.indexLabelMaxWidth?t.indexLabelMaxWidth:D[C];if(m>D[C]||0>m)m=D[C];y[C]="inside"===t.indexLabelPlacement?R[C].height:!1;v=A.getPercentAndTotal(t,b);if(t.indexLabelFormatter||b.indexLabelFormatter)z={chart:A.options,dataSeries:t,dataPoint:b,total:v.total,
percent:v.percent};b=b.indexLabelFormatter?b.indexLabelFormatter(z):b.indexLabel?A.replaceKeywordsWithValue(b.indexLabel,b,t,C):t.indexLabelFormatter?t.indexLabelFormatter(z):t.indexLabel?A.replaceKeywordsWithValue(t.indexLabel,b,t,C):b.label?b.label:"";0>=n&&(n=0);1E3>m&&1E3-m<r&&(m+=1E3-m);P.roundRect||Ca(P);c=new ja(P,{fontSize:f,fontFamily:l,fontColor:e,fontStyle:k,fontWeight:h,horizontalAlign:c,textAlign:u,backgroundColor:d,maxWidth:m,maxHeight:!1===y[C]?q?4.28571429*f:1.5*f:y[C],text:b,padding:ca});
c.measureText();I.push({textBlock:c,id:t.reversed?B:C,isDirty:!1,lineColor:a,lineThickness:n,lineDashType:p,height:c.height<c.maxHeight?c.height:c.maxHeight,width:c.width<c.maxWidth?c.width:c.maxWidth})}}}function e(){var a,b,c,d,e,f=[];e=!1;c=0;for(var g,k=K-V-X/2,k=t.options.indexLabelMaxWidth?t.indexLabelMaxWidth>k?k:t.indexLabelMaxWidth:k,l=I.length-1;0<=l;l--){g=x[I[l].id];c=I[l];d=c.textBlock;b=(a=q(l)<R.length?I[q(l)]:null)?a.textBlock:null;c=c.height;a&&d.y+c+ca>b.y&&(e=!0);c=g.indexLabelMaxWidth||
k;if(c>k||0>c)c=k;f.push(c)}if(e)for(l=I.length-1;0<=l;l--)a=R[l],I[l].textBlock.maxWidth=f[f.length-(l+1)],I[l].textBlock.measureText(),I[l].textBlock.x=K-k,c=I[l].textBlock.height<I[l].textBlock.maxHeight?I[l].textBlock.height:I[l].textBlock.maxHeight,e=I[l].textBlock.width<I[l].textBlock.maxWidth?I[l].textBlock.width:I[l].textBlock.maxWidth,I[l].height=c,I[l].width=e,c="undefined"!==typeof a.x5?(a.y2+a.y4)/2:(a.y2+a.y3)/2,I[l].textBlock.y=c-I[l].height/2,t.reversed?(I[l].textBlock.y+I[l].height>
...
n;for(var k,h=1;h<l;h++){e=h*f;for(var m=I.length-1;0<=m;m--)!I[m].isDirty&&(I[m].textBlock.y<e&&I[m].textBlock.y+I[m].height>e)&&(k=q(m),!(k>=I.length-1)&&I[m].textBlock.y+I[m].height+ca>I[k].textBlock.y&&(I[m].textBlock.y=I[m].textBlock.y+I[m].height-e>e-I[m].textBlock.y?e+1:e-I[m].height-1))}for(k=R.length-1;0<k;k--)if(!I[k].isDirty){e=p(k);if(0>e&&(e=0,I[e].isDirty))break;if(I[k].textBlock.y<I[e].textBlock.y+I[e].height){d=d||k;f=k;for(l=0;I[f].textBlock.y<I[e].textBlock.y+I[e].height+ca;){a=
...
2);var S=y.x1+B,K=y.x2-B,$=y.y1+z,O=y.y2-z,P=a.targetCanvasCtx||this.plotArea.ctx||this.ctx;if(0!=t.length&&(t.dataPoints&&t.visible)&&0!==x.length){var Q,F;a=75*G/100;var X=30*(K-a)/100;"funnel"===t.type?(Q=s(t.options.neckHeight)?0.35*E:t.neckHeight,F=s(t.options.neckWidth)?0.25*a:t.neckWidth,"string"===typeof Q&&Q.match(/%$/)?(Q=parseInt(Q),Q=Q*E/100):Q=parseInt(Q),"string"===typeof F&&F.match(/%$/)?(F=parseInt(F),F=F*a/100):F=parseInt(F),Q>E?Q=E:0>=Q&&(Q=0),F>a?F=a-0.5:0>=F&&(F=0)):"pyramid"===
...
1],x4:a[F+1],y4:G[F+1],id:F,height:G[F+1]-G[F],color:Y});var ca=2,I=[],ha=!1,Z=[],ia=[],S=!1;a=a=0;Da(Z);for(F=0;F<x.length;F++)x[F].exploded&&(S=!0,t.reversed?Z.push(x.length-1-F):Z.push(F));P.clearRect(y.x1,y.y1,y.width,y.height);P.fillStyle=A.backgroundColor;P.fillRect(y.x1,y.y1,y.width,y.height);if(L&&t.visible&&(b(),f(),e(),"inside"!==t.indexLabelPlacement)){l();for(F=0;F<x.length;F++)I[F].isDirty||(a=I[F].textBlock.x+I[F].width,a=(K-a)/2,0==F&&(C=a),C>a&&(C=a));for(F=0;F<R.length;F++)R[F].x1+=
C,R[F].x2+=C,R[F].x3+=C,R[F].x4+=C,R[F].x5&&(R[F].x5+=C,R[F].x6+=C),I[F].textBlock.x+=C}for(F=0;F<R.length;F++)C=R[F],ta(P,C,t.fillOpacity),ia.push(C.y1);v(P);L&&t.visible&&("inside"===t.indexLabelPlacement||A.animationEnabled||n(P),A.animationEnabled||r());if(!L)for(F=0;F<x.length;F++)C=t.dataPointIds[F],a={id:C,objectType:"dataPoint",dataPointIndex:F,dataSeriesIndex:0,funnelSection:R[t.reversed?x.length-1-F:F]},A._eventManager.objectMap[C]=a;!A.animationEnabled&&S?m(A,-1,0):A.animationEnabled&&
!A.animatedRender&&m(A,-1,0);this.funnelPyramidClickHandler=function(a){var b=-1;if(!ha&&!A.isAnimating&&(s(a.dataSeries.explodeOnClick)||a.dataSeries.explodeOnClick)&&(b=t.reversed?x.length-1-a.dataPointIndex:a.dataPointIndex,0<=b)){a=b;if("funnel"===t.type||"pyramid"===t.type)t.reversed?x[x.length-1-a].exploded=x[x.length-1-a].exploded?!1:!0:x[a].exploded=x[a].exploded?!1:!0;m(A,b,500)}};return{source:P,dest:this.plotArea.ctx,animationCallback:function(a,b){M.fadeInAnimation(a,b);1<=a&&(m(A,-1,
...
f.dispatchEvent?f.dispatchEvent(event):f.fireEvent&&f.fireEvent("onclick")}catch(n){d=window.open(),d.document.write("<img src='"+b+"'></img><div>Please right click on the image and save it to your device</div>"),d.document.close()}}};m.prototype.print=function(){var a=this.exportChart({toDataURL:!0}),d=document.createElement("iframe");d.setAttribute("class","canvasjs-chart-print-frame");V(d,{position:"absolute",width:"100%",border:"0px",margin:"0px 0px 0px 0px",padding:"0px 0px 0px 0px"});d.style.height=
...
"z"===a?ca(g,d.zValueFormatString?d.zValueFormatString:c.zValueFormatString?c.zValueFormatString:c.zValueFormatString="#,##0.########",f._cultureInfo):g})};oa(K,G);K.prototype.setLayout=function(){var a=this.dockInsidePlotArea?this.chart.plotArea:this.chart,d=a.layoutManager.getFreeSpace(),c=null,b=0,e=0,f=0,l=0,h=this.markerMargin=this.chart.options.legend&&!s(this.chart.options.legend.markerMargin)?this.chart.options.legend.markerMargin:0.3*this.fontSize;this.height=0;var m=[],k=[];if("top"===this.verticalAlign||
...
p.markerBorderColor,t=p.legendMarkerBorderThickness?p.legendMarkerBorderThickness:p.markerBorderThickness?Math.max(1,Math.round(0.2*w)):0;"error"===p.type&&this.errorMarkerColor.push(r);g=this.chart.replaceKeywordsWithValue(g,p.dataPoints[0],p,n);q={markerType:q,markerColor:r,text:g,textBlock:null,chartType:p.type,markerSize:w,lineColor:p._colorSet[0],dataSeriesIndex:p.index,dataPointIndex:null,markerBorderColor:v,markerBorderThickness:t};m.push(q)}else for(var x=0;x<p.dataPoints.length;x++){var y=
p.dataPoints[x],q=y.legendMarkerType?y.legendMarkerType:p.legendMarkerType?p.legendMarkerType:Q.getDefaultLegendMarker(p.type),g=y.legendText?y.legendText:p.legendText?p.legendText:this.itemTextFormatter?this.itemTextFormatter({chart:this.chart,legend:this.options,dataSeries:p,dataPoint:y}):y.name?y.name:"DataPoint: "+(x+1),r=y.legendMarkerColor?y.legendMarkerColor:p.legendMarkerColor?p.legendMarkerColor:y.color?y.color:p.color?p.color:p._colorSet[x%p._colorSet.length],w=0.75*this.lineHeight,v=y.legendMarkerBorderColor?
y.legendMarkerBorderColor:p.legendMarkerBorderColor?p.legendMarkerBorderColor:y.markerBorderColor?y.markerBorderColor:p.markerBorderColor,t=y.legendMarkerBorderThickness?y.legendMarkerBorderThickness:p.legendMarkerBorderThickness?p.legendMarkerBorderThickness:y.markerBorderThickness||p.markerBorderThickness?Math.max(1,Math.round(0.2*w)):0,g=this.chart.replaceKeywordsWithValue(g,y,p,x),q={markerType:q,markerColor:r,text:g,textBlock:null,chartType:p.type,markerSize:w,dataSeriesIndex:n,dataPointIndex:x,
markerBorderColor:v,markerBorderThickness:t};(y.showInLegend||p.showInLegend&&!1!==y.showInLegend)&&m.push(q)}}!0===this.reversed&&m.reverse();if(0<m.length){p=null;r=g=y=x=0;y=null!==this.itemWidth?null!==this.itemMaxWidth?Math.min(this.itemWidth,this.itemMaxWidth,f):this.itemMaxWidth=Math.min(this.itemWidth,f):null!==this.itemMaxWidth?Math.min(this.itemMaxWidth,f):this.itemMaxWidth=f;w=0===w?0.75*this.lineHeight:w;y-=w+h;for(n=0;n<m.length;n++){q=m[n];v=y;if("line"===q.chartType||"spline"===q.chartType||
...
this.ctx.lineWidth=f/8;this.ctx.beginPath();var w=g-0.08*this.lineHeight+0.1*this.lineHeight,t=r+0.15*this.lineHeight,x=0.7*this.lineHeight,v=x+0.02*this.lineHeight;this.ctx.moveTo(w,t);this.ctx.lineTo(w+x,t);this.ctx.stroke();this.ctx.beginPath();this.ctx.moveTo(w+x/2,t);this.ctx.lineTo(w+x/2,t+v);this.ctx.stroke();this.ctx.beginPath();this.ctx.moveTo(w,t+v);this.ctx.lineTo(w+x,t+v);this.ctx.stroke();this.errorMarkerColor.shift()}W.drawMarker(g+f/2,r+this.lineHeight/2,this.ctx,q.markerType,"error"===
q.chartType||"line"===q.chartType||"spline"===q.chartType?q.markerSize/2:q.markerSize,q.markerColor,q.markerBorderColor,q.markerBorderThickness);q.textBlock.x=g+c+f;if("line"===q.chartType||"stepLine"===q.chartType||"spline"===q.chartType)q.textBlock.x+=0.1*this.lineHeight;q.textBlock.y=Math.round(r+this.lineHeight/2);q.textBlock.render(!0);this.ctx.restore();n=0<p?Math.max(n,q.textBlock.height):q.textBlock.height;this.chart.data[q.dataSeriesIndex].visible||(this.ctx.globalAlpha=1);g=X(q.id);this.ghostCtx.fillStyle=
g;this.ghostCtx.beginPath();this.ghostCtx.fillRect(s,q.textBlock.y-this.lineHeight/2,q.textBlock.x+q.textBlock.width-s,q.textBlock.height);q.x1=this.chart._eventManager.objectMap[q.id].x1=s;q.y1=this.chart._eventManager.objectMap[q.id].y1=q.textBlock.y-this.lineHeight/2;q.x2=this.chart._eventManager.objectMap[q.id].x2=q.textBlock.x+q.textBlock.width;q.y2=this.chart._eventManager.objectMap[q.id].y2=q.textBlock.y+q.textBlock.height-this.lineHeight/2}h+=n}};oa(Q,G);Q.prototype.getDefaultAxisPlacement=
...
typeof this.options.labelMaxWidth?0.3*this.chart.width>>0:this.options.labelMaxWidth),l="undefined"===typeof this.options.labelWrap||this.labelWrap?0.3*this.chart.height>>0:1.5*this.labelFontSize;for(b=0;b<this._labels.length;b++){a=this._labels[b].textBlock;a.maxWidth=f;a.maxHeight=l;var r=a.measureText();m=r.height}e=[];q=p=0;if(this.labelAutoFit||this.options.labelAutoFit)if(s(this.labelAngle)||(this.labelAngle=(this.labelAngle%360+360)%360,90<this.labelAngle&&270>this.labelAngle?this.labelAngle-=
...
f,s(this.options.labelFontSize)&&12<g&&(g=Math.floor(12/13*g),a.measureText()),this.sessionVariables.labelFontSize=s(this.options.labelFontSize)?g:this.options.labelFontSize,this.sessionVariables.labelAngle=this.labelAngle):b>=2.2*f&&b<2.8*f?(this.sessionVariables.labelAngle=-25,this.sessionVariables.labelMaxWidth=n,this.sessionVariables.labelFontSize=g):b>=2.8*f&&b<3.2*f?(this.sessionVariables.labelMaxWidth=Math.max(f,q),this.sessionVariables.labelWrap=!0,s(this.options.labelFontSize)&&12<this.labelFontSize&&
(this.labelFontSize=Math.floor(12/13*this.labelFontSize),a.measureText()),this.sessionVariables.labelFontSize=s(this.options.labelFontSize)?g:this.options.labelFontSize,this.sessionVariables.labelAngle=this.labelAngle):b>=3.2*f&&b<3.6*f?(this.sessionVariables.labelAngle=-25,this.sessionVariables.labelWrap=!0,this.sessionVariables.labelMaxWidth=n,this.sessionVariables.labelFontSize=this.labelFontSize):b>3.6*f&&b<5*f?(s(this.options.labelFontSize)&&12<g&&(g=Math.floor(12/13*g),a.measureText()),this.sessionVariables.labelFontSize=
s(this.options.labelFontSize)?g:this.options.labelFontSize,this.sessionVariables.labelWrap=!0,this.sessionVariables.labelAngle=-25,this.sessionVariables.labelMaxWidth=n):b>5*f&&(this.sessionVariables.labelWrap=!0,this.sessionVariables.labelMaxWidth=f,this.sessionVariables.labelFontSize=g,this.sessionVariables.labelMaxHeight=l,this.sessionVariables.labelAngle=this.labelAngle));else if(v===c&&(0===v&&q+this._labels[v+1].textBlock.measureText().width-2*f>p||v===this._labels.length-1&&q+this._labels[v-
...
n;else if(0===p)for(this.sessionVariables.labelFontSize=s(this.options.labelFontSize)?g:this.options.labelFontSize,this.sessionVariables.labelWrap=!0,b=0;b<this._labels.length;b++)a=this._labels[b].textBlock,a.maxWidth=this.sessionVariables.labelMaxWidth=Math.min(Math.max(f,q),n),r=a.measureText(),b<this._labels.length-1&&(g=b+1,d=this._labels[g].textBlock,d.maxWidth=this.sessionVariables.labelMaxWidth=Math.min(Math.max(f,q),n),d=d.measureText(),r.width+d.width>>0>2*f&&(this.sessionVariables.labelAngle=
...
Math.sin(Math.PI/180*Math.abs(this.labelAngle))+(e.height-d.fontSize/2)*Math.cos(Math.PI/180*Math.abs(this.labelAngle)),a<f&&(a=f),this._stripLineLabels[c].effectiveHeight=f)}return(this.title?this._titleTextBlock.measureText().height+2:0)+a+("inside"===this.tickPlacement?0<this._index?this.tickLength:0:this.tickLength)+b};A.setLayout=function(a,d,c,b,e,f){var l,h,m,k,n=a[0]?a[0].chart:d[0].chart,p=n.isNavigator?0:10,q=n._axes;if(a&&0<a.length)for(var g=0;g<a.length;g++)a[g]&&a[g].calculateAxisParameters();
if(d&&0<d.length)for(g=0;g<d.length;g++)d[g].calculateAxisParameters();if(c&&0<c.length)for(g=0;g<c.length;g++)c[g].calculateAxisParameters();if(b&&0<b.length)for(g=0;g<b.length;g++)b[g].calculateAxisParameters();for(g=0;g<q.length;g++)if(q[g]&&q[g].scaleBreaks&&q[g].scaleBreaks._appliedBreaks.length)for(var r=q[g].scaleBreaks._appliedBreaks,w=0;w<r.length&&!(r[w].startValue>q[g].viewportMaximum);w++)r[w].endValue<q[g].viewportMinimum||(s(q[g].scaleBreaks.firstBreakIndex)&&(q[g].scaleBreaks.firstBreakIndex=
w),r[w].startValue>=q[g].viewPortMinimum&&(q[g].scaleBreaks.lastBreakIndex=w));for(var v=w=0,t=0,x=0,y=0,z=0,A=0,C,B,E=h=0,G,J,K,r=G=J=K=!1,g=0;g<q.length;g++)q[g]&&q[g].title&&(q[g]._titleTextBlock=new ja(q[g].ctx,{text:q[g].title,horizontalAlign:"center",fontSize:q[g].titleFontSize,fontFamily:q[g].titleFontFamily,fontWeight:q[g].titleFontWeight,fontColor:q[g].titleFontColor,fontStyle:q[g].titleFontStyle,borderColor:q[g].titleBorderColor,borderThickness:q[g].titleBorderThickness,backgroundColor:q[g].titleBackgroundColor,
...
0<b.length)for(A=[],g=aa=0;g<b.length;g++)A.push(Math.ceil(b[g]?b[g].createLabelsAndCalculateWidth():0)),aa+=A[g],Z+=b[g]?b[g].margin:0;else A.push(Math.ceil(b[0]?b[0].createLabelsAndCalculateWidth():0));P.push(A);l=Math.round(f.x1+R+N);m=Math.round(f.x2-aa-Z>n.width-p?n.width-p:f.x2-aa-Z);if(a&&0<a.length)for(x=[],g=W=0;g<a.length;g++)a[g]&&(a[g].lineCoordinates={}),a[g].lineCoordinates.width=Math.abs(m-l),a[g].title&&(a[g]._titleTextBlock.maxWidth=0<a[g].titleMaxWidth&&a[g].titleMaxWidth<a[g].lineCoordinates.width?
...
180*Math.abs(k.textBlock.angle))+(k.textBlock.height-h.textBlock.fontSize/2)*Math.sin(Math.PI/180*Math.abs(k.textBlock.angle)),t=h.textBlock.width*Math.cos(Math.PI/180*Math.abs(h.textBlock.angle))+(h.textBlock.height-h.textBlock.fontSize/2)*Math.sin(Math.PI/180*Math.abs(h.textBlock.angle))),!a[g]||(!a[g].labelAutoFit||s(C)||s(B)||n.isNavigator||n.stockChart)||(h=0,0<a[g].labelAngle?B+t>m&&(h+=0<a[g].labelAngle?B+t-m-aa:0):0>a[g].labelAngle?C-v<l&&C-v<a[g].viewportMinimum&&(E=l-(N+a[g].tickLength+
z+C-v+a[g].labelFontSize/2)):0===a[g].labelAngle&&(B+t>m&&(h=B+t/2-m-aa),C-v<l&&C-v<a[g].viewportMinimum&&(E=l-N-a[g].tickLength-z-C+v/2)),a[g].viewportMaximum===a[g].maximum&&a[g].viewportMinimum===a[g].minimum&&0<a[g].labelAngle&&0<h?m-=h:a[g].viewportMaximum===a[g].maximum&&a[g].viewportMinimum===a[g].minimum&&0>a[g].labelAngle&&0<E?l+=E:a[g].viewportMaximum===a[g].maximum&&a[g].viewportMinimum===a[g].minimum&&0===a[g].labelAngle&&(0<E&&(l+=E),0<h&&(m-=h))),n.panEnabled?W=s(n.sessionVariables.axisX.height)?
n.sessionVariables.axisX.height=W:n.sessionVariables.axisX.height:n.sessionVariables.axisX.height=W,h=Math.round(f.y2-W-e+F),k=Math.round(f.y2),a[g].lineCoordinates.x2=m,a[g].lineCoordinates.width=m-l,a[g].lineCoordinates.y1=h,a[g].lineCoordinates.y2=h+a[g].lineThickness/2,"inside"===a[g].labelPlacement&&0<g&&(a[g].lineCoordinates.y1=a[g].lineCoordinates.y1+x[g]-(a[g]._titleTextBlock?a[g]._titleTextBlock.height:0)-a[g].tickLength-a[g].margin-5,a[g].lineCoordinates.y2=a[g].lineCoordinates.y1+a[g].lineThickness/
2),"inside"===a[g].tickPlacement&&0<g&&(a[g].lineCoordinates.y1+=a[g].tickLength,a[g].lineCoordinates.y2=a[g].lineCoordinates.y1+a[g].lineThickness/2),a[g].bounds={x1:l,y1:h,x2:m,y2:k-(W+e-x[g]-F),width:m-l},a[g].bounds.height=a[g].bounds.y2-a[g].bounds.y1),F+=x[g]+a[g].margin;if(d&&0<d.length)for(g=0;g<d.length;g++)d[g].lineCoordinates.x1=Math.round(f.x1+R+N),d[g].lineCoordinates.x2=Math.round(f.x2-aa-Z>n.width-p?n.width-p:f.x2-aa-Z),d[g].lineCoordinates.width=Math.abs(m-l),d[g]._labels&&1<d[g]._labels.length&&
(k=d[g]._labels[1],h="dateTime"===d[g].valueType?d[g]._labels[d[g]._labels.length-2]:d[g]._labels[d[g]._labels.length-1],v=k.textBlock.width*Math.cos(Math.PI/180*Math.abs(k.textBlock.angle))+(k.textBlock.height-h.textBlock.fontSize/2)*Math.sin(Math.PI/180*Math.abs(k.textBlock.angle)),t=h.textBlock.width*Math.cos(Math.PI/180*Math.abs(h.textBlock.angle))+(h.textBlock.height-h.textBlock.fontSize/2)*Math.sin(Math.PI/180*Math.abs(h.textBlock.angle))),n.panEnabled?Y=s(n.sessionVariables.axisX2.height)?
n.sessionVariables.axisX2.height=Y:n.sessionVariables.axisX2.height:n.sessionVariables.axisX2.height=Y,h=Math.round(f.y1),k=d[g].lineCoordinates.y1=h+Y+V-X,d[g].lineCoordinates.y2=h,"inside"===d[g].labelPlacement&&0<g&&(d[g].lineCoordinates.y1-=y[g]-d[g].tickLength-(d[g]._titleTextBlock?d[g]._titleTextBlock.height:0)),"inside"===d[g].tickPlacement&&0<g&&(d[g].lineCoordinates.y1-=d[g].tickLength),d[g].bounds={x1:l,y1:h+(Y+V-y[g]-X),x2:m,y2:k,width:m-l},d[g].bounds.height=d[g].bounds.y2-d[g].bounds.y1,
X+=y[g]+d[g].margin;if(c&&0<c.length)for(g=0;g<c.length;g++)N=n.isNavigator?0:10,c[g]&&(l=Math.round(a[0]?a[0].lineCoordinates.x1:d[0].lineCoordinates.x1),N=c[g]._labels&&0<c[g]._labels.length?c[g]._labels[c[g]._labels.length-1].textBlock.height/2:p,h=Math.round(f.y1+Y+V<Math.max(N,p)?Math.max(N,p):f.y1+Y+V),m=Math.round(a[0]?a[0].lineCoordinates.x1:d[0].lineCoordinates.x1),N=0<a.length?0:c[g]._labels&&0<c[g]._labels.length?c[g]._labels[0].textBlock.height/2:p,k=Math.round(f.y2-W-e-N),c[g].lineCoordinates=
{x1:l-T,y1:h,x2:m-T,y2:k,height:Math.abs(k-h)},"inside"===c[g].labelPlacement&&0<g&&(c[g].lineCoordinates.x1=c[g].lineCoordinates.x1-(z[g]-(c[g]._titleTextBlock?c[g]._titleTextBlock.height:0))+c[g].tickLength,c[g].lineCoordinates.x2=c[g].lineCoordinates.x1+c[g].lineThickness/2),"inside"===c[g].tickPlacement&&0<g&&(c[g].lineCoordinates.x1-=c[g].tickLength,c[g].lineCoordinates.x2=c[g].lineCoordinates.x1+c[g].lineThickness/2),c[g].bounds={x1:l-(z[g]+T),y1:h,x2:m-T,y2:k,height:k-h},c[g].bounds.width=
c[g].bounds.x2-c[g].bounds.x1,c[g].title&&(c[g]._titleTextBlock.maxWidth=0<c[g].titleMaxWidth&&c[g].titleMaxWidth<c[g].lineCoordinates.height?c[g].titleMaxWidth:c[g].lineCoordinates.height),T+=z[g]+c[g].margin);if(b&&0<b.length)for(g=0;g<b.length;g++)b[g]&&(l=Math.round(a[0]?a[0].lineCoordinates.x2:d[0].lineCoordinates.x2),m=Math.round(l),N=b[g]._labels&&0<b[g]._labels.length?b[g]._labels[b[g]._labels.length-1].textBlock.height/2:0,h=Math.round(f.y1+Y+V<Math.max(N,p)?Math.max(N,p):f.y1+Y+V),N=0<a.length?
...
M[w-1][g]===M[w][g]?!0:!1;else r=!0;if(d&&0<d.length)for(g=0;g<d.length;g++)G=Q[w-1][g]===Q[w][g]?!0:!1;else G=!0;if(c&&0<c.length)for(g=0;g<c.length;g++)J=O[w-1][g]===O[w][g]?!0:!1;else J=!0;if(b&&0<b.length)for(g=0;g<b.length;g++)K=P[w-1][g]===P[w][g]?!0:!1;else K=!0}if(r&&G&&J&&K)break;w++}if(a&&0<a.length)for(g=0;g<a.length;g++)a[g].calculateStripLinesThicknessInValues(),a[g].calculateBreaksInPixels();if(d&&0<d.length)for(g=0;g<d.length;g++)d[g].calculateStripLinesThicknessInValues(),d[g].calculateBreaksInPixels();
...
0));M.push(E);if(d&&0<d.length)for(v=[],g=W=0;g<d.length;g++)v.push(Math.ceil(d[g]?d[g].createLabelsAndCalculateWidth():0)),W+=v[g],V+=d[g]?d[g].margin:0;else v.push(Math.ceil(d[0]?d[0].createLabelsAndCalculateWidth():0));Q.push(v);if(c&&0<c.length)for(g=0;g<c.length;g++)c[g].lineCoordinates={},l=Math.round(f.x1+U+e),m=Math.round(f.x2-W-V>n.width-10?n.width-10:f.x2-W-V),c[g].labelAutoFit&&!s(x)&&(0<!a.length&&(l=0>c[g].labelAngle?Math.max(l,x):0===c[g].labelAngle?Math.max(l,x/2):l),0<!d.length&&(m=
0<c[g].labelAngle?m-y/2:0===c[g].labelAngle?m-y/2:m)),c[g].lineCoordinates.x1=l,c[g].lineCoordinates.x2=m,c[g].lineCoordinates.width=Math.abs(m-l),c[g].title&&(c[g]._titleTextBlock.maxWidth=0<c[g].titleMaxWidth&&c[g].titleMaxWidth<c[g].lineCoordinates.width?c[g].titleMaxWidth:c[g].lineCoordinates.width);if(b&&0<b.length)for(g=0;g<b.length;g++)b[g].lineCoordinates={},l=Math.round(f.x1+U+e),m=Math.round(f.x2-W-V>b[g].chart.width-10?b[g].chart.width-10:f.x2-W-V),b[g]&&b[g].labelAutoFit&&!s(z)&&(0<!a.length&&
(l=0<b[g].labelAngle?Math.max(l,z):0===b[g].labelAngle?Math.max(l,z/2):l),0<!d.length&&(m-=A/2)),b[g].lineCoordinates.x1=l,b[g].lineCoordinates.x2=m,b[g].lineCoordinates.width=Math.abs(m-l),b[g].title&&(b[g]._titleTextBlock.maxWidth=0<b[g].titleMaxWidth&&b[g].titleMaxWidth<b[g].lineCoordinates.width?b[g].titleMaxWidth:b[g].lineCoordinates.width);if(c&&0<c.length)for(p=[],g=T=0;g<c.length;g++)p.push(Math.ceil(c[g]?c[g].createLabelsAndCalculateHeight():0)),T+=p[g]+c[g].margin,N+=c[g].margin;else p.push(Math.ceil(c[0]?
...
Math.cos(Math.PI/180*Math.abs(h.textBlock.angle))+(h.textBlock.height-h.textBlock.fontSize/2)*Math.sin(Math.PI/180*Math.abs(h.textBlock.angle)));if(n.panEnabled)for(g=0;g<c.length;g++)p[g]=s(n.sessionVariables.axisY.height)?n.sessionVariables.axisY.height=p[g]:n.sessionVariables.axisY.height;else for(g=0;g<c.length;g++)n.sessionVariables.axisY.height=p[g];if(c&&0<c.length)for(g=c.length-1;0<=g;g--)h=Math.round(f.y2),k=Math.round(f.y2>c[g].chart.height?c[g].chart.height:f.y2),c[g].lineCoordinates.y1=
h-(p[g]+c[g].margin+Y),c[g].lineCoordinates.y2=h-(p[g]+c[g].margin+Y),"inside"===c[g].labelPlacement&&0<g&&(c[g].lineCoordinates.y1=c[g].lineCoordinates.y1+p[g]-(c[g]._titleTextBlock?c[g]._titleTextBlock.height:0)-c[g].tickLength-5,c[g].lineCoordinates.y2=c[g].lineCoordinates.y1+c[g].lineThickness/2),"inside"===c[g].tickPlacement&&0<g&&(c[g].lineCoordinates.y1+=c[g].tickLength,c[g].lineCoordinates.y2=c[g].lineCoordinates.y1+c[g].lineThickness/2),c[g].bounds={x1:l,y1:h-(p[g]+Y+c[g].margin),x2:m,y2:k-
(Y+c[g].margin),width:m-l,height:p[g]},c[g].title&&(c[g]._titleTextBlock.maxWidth=0<c[g].titleMaxWidth&&c[g].titleMaxWidth<c[g].lineCoordinates.width?c[g].titleMaxWidth:c[g].lineCoordinates.width),Y+=p[g]+c[g].margin;if(b&&0<b.length)for(g=b.length-1;0<=g;g--)b[g]&&(h=Math.round(f.y1),k=Math.round(f.y1+(C[g]+b[g].margin+F)),b[g].lineCoordinates.y1=k,b[g].lineCoordinates.y2=k,"inside"===b[g].labelPlacement&&0<g&&(b[g].lineCoordinates.y1=k-C[g]+(b[g]._titleTextBlock?b[g]._titleTextBlock.height:0)+b[g].tickLength,
b[g].lineCoordinates.y2=b[g].lineCoordinates.y1-b[g].lineThickness/2),"inside"===b[g].tickPlacement&&0<g&&(b[g].lineCoordinates.y1-=b[g].tickLength,b[g].lineCoordinates.y2=b[g].lineCoordinates.y1-b[g].lineThickness/2),b[g].bounds={x1:l,y1:h+(b[g].margin+F),x2:m,y2:k,width:m-l},b[g].bounds.height=b[g].bounds.y2-b[g].bounds.y1,b[g].title&&(b[g]._titleTextBlock.maxWidth=0<b[g].titleMaxWidth&&b[g].titleMaxWidth<b[g].lineCoordinates.width?b[g].titleMaxWidth:b[g].lineCoordinates.width),F+=C[g]+b[g].margin);
if(a&&0<a.length)for(g=0;g<a.length;g++){N=a[g]._labels&&0<a[g]._labels.length?a[g]._labels[0].textBlock.fontSize/2:0;l=Math.round(f.x1+e);h=b&&0<b.length?Math.round(b[0]?b[0].lineCoordinates.y2:f.y1<Math.max(N,10)?Math.max(N,10):f.y1):f.y1<Math.max(N,10)?Math.max(N,10):f.y1;m=Math.round(f.x1+U+e);k=c&&0<c.length?Math.round(c[0]?c[0].lineCoordinates.y1:f.y2-T>n.height-Math.max(N,10)?n.height-Math.max(N,10):f.y2-T):f.y2>n.height-Math.max(N,10)?n.height-Math.max(N,10):f.y2;if(c&&0<c.length)for(N=0;N<
...
a[g].lineCoordinates.x1+a[g].lineThickness/2);"inside"===a[g].tickPlacement&&0<g&&(a[g].lineCoordinates.x1-=a[g].tickLength,a[g].lineCoordinates.x2=a[g].lineCoordinates.x1+a[g].lineThickness/2);a[g].bounds={x1:m-(E[g]+O),y1:h,x2:m-O,y2:k,height:k-h};a[g].bounds.width=a[g].bounds.x2-a[g].bounds.x1;a[g].title&&(a[g]._titleTextBlock.maxWidth=0<a[g].titleMaxWidth&&a[g].titleMaxWidth<a[g].lineCoordinates.height?a[g].titleMaxWidth:a[g].lineCoordinates.height);a[g].calculateValueToPixelConversionParameters();
a[g].calculateBreaksSizeInValues();O+=E[g]+a[g].margin}if(d&&0<d.length)for(g=0;g<d.length;g++){N=d[g]._labels&&0<d[g]._labels.length?d[g]._labels[0].textBlock.fontSize/2:0;l=Math.round(f.x1-e);h=b&&0<b.length?Math.round(b[0]?b[0].lineCoordinates.y2:f.y1<Math.max(N,10)?Math.max(N,10):f.y1):f.y1<Math.max(N,10)?Math.max(N,10):f.y1;m=Math.round(f.x2-W-V);k=c&&0<c.length?Math.round(c[0]?c[0].lineCoordinates.y1:f.y2-T>n.height-Math.max(N,10)?n.height-Math.max(N,10):f.y2-T):f.y2>n.height-Math.max(N,10)?
n.height-Math.max(N,10):f.y2;if(c&&0<c.length)for(N=0;N<c.length;N++)c[N]&&c[N].labelAutoFit&&(m=0>c[N].labelAngle?Math.max(m,x):0===c[N].labelAngle?Math.max(m,x/2):m,l=0>c[N].labelAngle||0===c[N].labelAngle?m-W:l);if(b&&0<b.length)for(N=0;N<b.length;N++)b[N]&&b[N].labelAutoFit&&(m=b[N].lineCoordinates.x2,l=m-W);d[g].lineCoordinates={x1:m+P,y1:h,x2:m+P,y2:k,height:Math.abs(k-h)};"inside"===d[g].labelPlacement&&0<g&&(d[g].lineCoordinates.x1=d[g].lineCoordinates.x1+(v[g]-(d[g]._titleTextBlock?d[g]._titleTextBlock.height:
0)-2)-d[g].tickLength,d[g].lineCoordinates.x2=d[g].lineCoordinates.x1+d[g].lineThickness/2);"inside"===d[g].tickPlacement&&0<g&&(d[g].lineCoordinates.x1+=d[g].tickLength,d[g].lineCoordinates.x2=d[g].lineCoordinates.x1+d[g].lineThickness/2);d[g].bounds={x1:d[g].lineCoordinates.x1,y1:h,x2:m+v[g]+P,y2:k,width:m-l,height:k-h};d[g].bounds.width=d[g].bounds.x2-d[g].bounds.x1;d[g].title&&(d[g]._titleTextBlock.maxWidth=0<d[g].titleMaxWidth&&d[g].titleMaxWidth<d[g].lineCoordinates.height?d[g].titleMaxWidth:
d[g].lineCoordinates.height);d[g].calculateValueToPixelConversionParameters();d[g].calculateBreaksSizeInValues();P+=v[g]+d[g].margin}for(g=0;g<q.length;g++)"axisY"===q[g].type&&(q[g].calculateValueToPixelConversionParameters(),q[g].calculateBreaksSizeInValues());if(0<w){if(a&&0<a.length)for(g=0;g<a.length;g++)r=M[w-1][g]===M[w][g]?!0:!1;else r=!0;if(d&&0<d.length)for(g=0;g<d.length;g++)G=Q[w-1][g]===Q[w][g]?!0:!1;else G=!0;if(c&&0<c.length)for(g=0;g<c.length;g++)J=B[w-1][g]===B[w][g]?!0:!1;else J=
!0;if(b&&0<b.length)for(g=0;g<b.length;g++)K=t[w-1][g]===t[w][g]?!0:!1;else K=!0}if(r&&G&&J&&K)break;w++}if(c&&0<c.length)for(g=0;g<c.length;g++)c[g].calculateStripLinesThicknessInValues(),c[g].calculateBreaksInPixels();if(b&&0<b.length)for(g=0;g<b.length;g++)b[g].calculateStripLinesThicknessInValues(),b[g].calculateBreaksInPixels();if(a&&0<a.length)for(g=0;g<a.length;g++)a[g].calculateStripLinesThicknessInValues(),a[g].calculateBreaksInPixels();if(d&&0<d.length)for(g=0;g<d.length;g++)d[g].calculateStripLinesThicknessInValues(),
...
this.options.stripLines[b].labelMaxWidth?this.options.stripLines[b].labelMaxWidth:this.chart.plotArea.height-3,c.textBlock.measureText(),a.x-c.textBlock.height>this.chart.plotArea.x1?s(k.startValue)?a.x-=c.textBlock.height-c.textBlock.fontSize/2:a.x-=c.textBlock.height/2-c.textBlock.fontSize/2:(c.textBlock.angle=90,s(k.startValue)?a.x+=c.textBlock.height-c.textBlock.fontSize/2:a.x+=c.textBlock.height/2-c.textBlock.fontSize/2),a.y=-90===c.textBlock.angle?"near"===c.stripLine.labelAlign?this.chart.plotArea.y1+
...
a.y+=c.textBlock.fontSize/2+3:a.y-=c.textBlock.height/2-c.textBlock.fontSize/2:s(k.startValue)?a.y-=c.textBlock.height-c.textBlock.fontSize/2:a.y-=c.textBlock.height/2-c.textBlock.fontSize/2+3,a.x="near"===c.stripLine.labelAlign?this.chart.plotArea.x2-c.textBlock.width-3:"center"===c.stripLine.labelAlign?(this.chart.plotArea.x2+this.chart.plotArea.x1)/2-c.textBlock.width/2:this.chart.plotArea.x1+3);c.textBlock.x=a.x;c.textBlock.y=a.y;m.push(c)}if(!l){l=!1;this.ctx.save();this.ctx.beginPath();this.ctx.rect(this.chart.plotArea.x1,
this.chart.plotArea.y1,this.chart.plotArea.width,this.chart.plotArea.height);this.ctx.clip();for(b=0;b<h.length;b++)k=h[b],k.showOnTop?f||(f=!0,this.chart.addEventListener("dataAnimationIterationEnd",function(){this.ctx.save();this.ctx.beginPath();this.ctx.rect(this.chart.plotArea.x1,this.chart.plotArea.y1,this.chart.plotArea.width,this.chart.plotArea.height);this.ctx.clip();for(e=0;e<h.length;e++)k=h[e],k.showOnTop&&k.render();this.ctx.restore()},k)):k.render();for(b=0;b<m.length;b++)c=m[b],c.stripLine.showOnTop?
l||(l=!0,this.chart.addEventListener("dataAnimationIterationEnd",function(){for(e=0;e<m.length;e++)c=m[e],"inside"===c.stripLine.labelPlacement&&c.stripLine.showOnTop&&(d.ctx.save(),d.ctx.beginPath(),d.ctx.rect(d.chart.plotArea.x1,d.chart.plotArea.y1,d.chart.plotArea.width,d.chart.plotArea.height),d.ctx.clip(),c.textBlock.render(!0),d.ctx.restore())},c.textBlock)):"inside"===c.stripLine.labelPlacement&&c.textBlock.render(!0);this.ctx.restore();l=!0}if(l)for(l=!1,b=0;b<m.length;b++)c=m[b],"outside"===
...
0,0,this.chart.width,this.chart.height),this.chart._breaksCanvasCtx.restore())};A.prototype.createMask=function(){if(this.scaleBreaks&&0<this.scaleBreaks._appliedBreaks.length){var a=this.scaleBreaks._appliedBreaks;w?(this.maskCanvas=ua(this.chart.width,this.chart.height),this.maskCtx=this.maskCanvas.getContext("2d")):(this.maskCanvas=this.chart.plotArea.canvas,this.maskCtx=this.chart.plotArea.ctx);this.maskCtx.save();this.maskCtx.beginPath();this.maskCtx.rect(this.chart.plotArea.x1,this.chart.plotArea.y1,
this.chart.plotArea.width,this.chart.plotArea.height);this.maskCtx.clip();for(var d=0;d<a.length;d++)a[d].endValue<this.viewportMinimum||(a[d].startValue>this.viewportMaximum||isNaN(this.range))||a[d].render(this.maskCtx);this.maskCtx.restore()}};A.prototype.renderCrosshair=function(a,d){isFinite(this.minimum)&&isFinite(this.maximum)&&(this.crosshair.render(a,d),this.crosshair.dispatchEvent("updated",{chart:this.chart,crosshair:this.options,axis:this,value:this.crosshair.value},this))};A.prototype.showCrosshair=
function(a){s(a)||(a<this.viewportMinimum||a>this.viewportMaximum)||("top"===this._position||"bottom"===this._position?this.crosshair.render(this.convertValueToPixel(a),null,a):this.crosshair.render(null,this.convertValueToPixel(a),a))};A.prototype.renderGrid=function(){if(this.gridThickness&&0<this.gridThickness){var a=this.chart.ctx;a.save();var d,c=this.chart.plotArea;a.lineWidth=this.gridThickness;a.strokeStyle=this.gridColor;a.setLineDash&&a.setLineDash(J(this.gridDashType,this.gridThickness));
...
this._position||"top"===this._position){if(this.lineThickness){this.reversed?(e=this.lineCoordinates.x2,f=this.lineCoordinates.x1):(e=this.lineCoordinates.x1,f=this.lineCoordinates.x2);d.lineWidth=this.lineThickness;d.strokeStyle=this.lineColor?this.lineColor:"black";d.setLineDash&&d.setLineDash(J(this.lineDashType,this.lineThickness));var l=1===this.lineThickness%2?(this.lineCoordinates.y1<<0)+0.5:this.lineCoordinates.y1<<0;d.beginPath();if(this.scaleBreaks&&!s(this.scaleBreaks.firstBreakIndex))if(s(this.scaleBreaks.lastBreakIndex))e=
...
0.5};A.prototype.getApparentDifference=function(a,d,c,b){var e=this.scaleBreaks?this.scaleBreaks._appliedBreaks:[];if(this.logarithmic){c=s(c)?d/a:c;for(var f=0;f<e.length&&!(d<e[f].startValue);f++)a>e[f].endValue||(a<=e[f].startValue&&d>=e[f].endValue?c=c/e[f].endValue*e[f].startValue*e[f].size:a>=e[f].startValue&&d>=e[f].endValue?c=c/e[f].endValue*a*Math.pow(e[f].size,Math.log(e[f].endValue/a)/Math.log(e[f].endValue/e[f].startValue)):a<=e[f].startValue&&d<=e[f].endValue?c=c/d*e[f].startValue*Math.pow(e[f].size,
Math.log(d/e[f].startValue)/Math.log(e[f].endValue/e[f].startValue)):!b&&(a>e[f].startValue&&d<e[f].endValue)&&(c=a*Math.pow(e[f].size,Math.log(d/a)/Math.log(e[f].endValue/e[f].startValue))))}else for(c=s(c)?Math.abs(d-a):c,f=0;f<e.length&&!(d<e[f].startValue);f++)a>e[f].endValue||(a<=e[f].startValue&&d>=e[f].endValue?c=c-e[f].endValue+e[f].startValue+e[f].size:a>e[f].startValue&&d>=e[f].endValue?c=c-e[f].endValue+a+e[f].size*(e[f].endValue-a)/(e[f].endValue-e[f].startValue):a<=e[f].startValue&&d<
...
"bottom"===this._position&&(d=this.convertPixelToValue(a.x));return d};A.prototype.calculateValueToPixelConversionParameters=function(a){a=this.scaleBreaks?this.scaleBreaks._appliedBreaks:[];var d={pixelPerUnit:null,minimum:null,reference:null},c=this.lineCoordinates.width,b=this.lineCoordinates.height,c="bottom"===this._position||"top"===this._position?c:b,b=Math.abs(this.range);if(this.logarithmic)for(var e=0;e<a.length&&!(this.viewportMaximum<a[e].startValue);e++)this.viewportMinimum>a[e].endValue||
...
d=!1,c=!1;"bottom"===this._position||"top"===this._position?(this.maxWidth=a.width,this.maxHeight=a.height):(this.maxWidth=a.height,this.maxHeight=a.width);var a="axisX"===this.type?"xySwapped"===this.chart.plotInfo.axisPlacement?62:70:"xySwapped"===this.chart.plotInfo.axisPlacement?50:40,b=4;"axisX"===this.type&&(b=600>this.maxWidth?8:6);var a=Math.max(b,Math.floor(this.maxWidth/a)),e,f,l,b=0;!s(this.options.viewportMinimum)&&(!s(this.options.viewportMaximum)&&this.options.viewportMinimum>=this.options.viewportMaximum)&&
(this.viewportMinimum=this.viewportMaximum=null);if(s(this.options.viewportMinimum)&&!s(this.sessionVariables.newViewportMinimum)&&!isNaN(this.sessionVariables.newViewportMinimum))this.viewportMinimum=this.sessionVariables.newViewportMinimum;else if(null===this.viewportMinimum||isNaN(this.viewportMinimum))this.viewportMinimum=this.minimum;if(s(this.options.viewportMaximum)&&!s(this.sessionVariables.newViewportMaximum)&&!isNaN(this.sessionVariables.newViewportMaximum))this.viewportMaximum=this.sessionVariables.newViewportMaximum;
...
(!s(this.sessionVariables.newViewportMaximum)&&this.sessionVariables.newViewportMaximum<=this.scaleBreaks._appliedBreaks[b].endValue||!s(this.options.maximum)&&this.options.maximum<=this.scaleBreaks._appliedBreaks[b].endValue||!s(this.options.viewportMaximum)&&this.viewportMaximum<=this.scaleBreaks._appliedBreaks[b].endValue)){this.scaleBreaks._appliedBreaks.splice(b,1);break}if("axisX"===this.type){if(this.dataSeries&&0<this.dataSeries.length)for(e=0;e<this.dataSeries.length;e++)"dateTime"===this.dataSeries[e].xValueType&&
...
this.lineColor;this.ctx.fillStyle=this.color;this.ctx.beginPath();this.ctx.globalAlpha=1;X(this.id);var f,l,h,m,k,n;a=Math.max(this.spacing,3);var p=Math.max(0,this.lineThickness);this.ctx.lineWidth=p;this.ctx.setLineDash&&this.ctx.setLineDash(J(this.lineDashType,p));if("bottom"===this.scaleBreaks.parent._position||"top"===this.scaleBreaks.parent._position)if(b=1===p%2?(b.x<<0)+0.5:b.x<<0,l=1===p%2?(e.x<<0)+0.5:e.x<<0,"top"===this.scaleBreaks.parent._position?(e=this.chart.plotArea.y1,h=this.chart.plotArea.y2+
...
0,n=[];if("xySwapped"===this.chart.plotInfo.axisPlacement){var v=null;if("bottom"===this.parent._position||"top"===this.parent._position)r=this.parent.dataSeries[0].axisX.convertPixelToValue({y:d});else if("left"===this.parent._position||"right"===this.parent._position)r=this.parent.convertPixelToValue({y:d});for(var B=0;B<this.parent.dataSeries.length;B++)(v=this.parent.dataSeries[B].getDataPointAtX(r,!0))&&0<=v.index&&(v.dataSeries=this.parent.dataSeries[B],null!==v.dataPoint.y&&v.dataSeries.visible&&
n.push(v));v=null;if(0===n.length)return;n.sort(function(a,b){return a.distance-b.distance});v=Math.abs(a-this.parent.convertValueToPixel(n[0].dataPoint.y));B=0;if("rangeBar"===n[0].dataSeries.type||"error"===n[0].dataSeries.type)for(var v=Math.abs(a-this.parent.convertValueToPixel(n[B].dataPoint.y[0])),t=0,r=0;r<n.length;r++)if(n[r].dataPoint.y&&n[r].dataPoint.y.length)for(var x=0;x<n[r].dataPoint.y.length;x++)t=Math.abs(a-this.parent.convertValueToPixel(n[r].dataPoint.y[x])),t<v&&(v=t,B=r);else t=
Math.abs(a-this.parent.convertValueToPixel(n[r].dataPoint.y)),t<v&&(v=t,B=r);else if("stackedBar"===n[0].dataSeries.type)for(var v=Math.abs(a-this.parent.convertValueToPixel(n[0].dataPoint.y)),y=t=0,r=B=0;r<n.length;r++)if(n[r].dataPoint.y&&n[r].dataPoint.y.length)for(x=0;x<n[r].dataPoint.y.length;x++)t=Math.abs(a-this.parent.convertValueToPixel(n[r].dataPoint.y[x])),t<v&&(v=t,B=r);else y+=n[r].dataPoint.y,t=Math.abs(a-this.parent.convertValueToPixel(y)),t<v&&(v=t,B=r);else if("stackedBar100"===n[0].dataSeries.type)for(var v=
Math.abs(a-this.parent.convertValueToPixel(n[0].dataPoint.y)),z=y=t=0,r=0;r<n.length;r++)if(n[r].dataPoint.y&&n[r].dataPoint.y.length)for(x=0;x<n[r].dataPoint.y.length;x++)t=Math.abs(a-this.parent.convertValueToPixel(n[r].dataPoint.y[x])),t<v&&(v=t,B=r);else y+=n[r].dataPoint.y,z=n[r].dataPoint.x.getTime?n[r].dataPoint.x.getTime():n[r].dataPoint.x,z=100*(y/n[r].dataSeries.plotUnit.dataPointYSums[z]),t=Math.abs(a-this.parent.convertValueToPixel(z)),t<v&&(v=t,B=r);else for(v=Math.abs(a-this.parent.convertValueToPixel(n[0].dataPoint.y)),
r=B=t=0;r<n.length;r++)if(n[r].dataPoint.y&&n[r].dataPoint.y.length)for(x=0;x<n[r].dataPoint.y.length;x++)t=Math.abs(a-this.parent.convertValueToPixel(n[r].dataPoint.y[x])),t<v&&(v=t,B=r);else t=Math.abs(a-this.parent.convertValueToPixel(n[r].dataPoint.y)),t<v&&(v=t,B=r);x=n[B];if("bottom"===this.parent._position||"top"===this.parent._position){b=0;if("rangeBar"===this.parent.dataSeries[B].type||"error"===this.parent.dataSeries[B].type){v=Math.abs(a-this.parent.convertValueToPixel(x.dataPoint.y[0]));
for(r=t=0;r<x.dataPoint.y.length;r++)t=Math.abs(a-this.parent.convertValueToPixel(x.dataPoint.y[r])),t<v&&(v=t,b=r);m=1===q.lineWidth%2?(this.parent.convertValueToPixel(x.dataPoint.y[b])<<0)+0.5:this.parent.convertValueToPixel(x.dataPoint.y[b])<<0;this.value=x.dataPoint.y[b];k.text=this.labelFormatter?this.labelFormatter({chart:this.chart,axis:this.parent.options,crosshair:this.options,value:x.dataPoint.y[b]}):s(this.options.label)?ca(s(c)?x.dataPoint.y[b]:c,this.valueFormatString,this.chart._cultureInfo):
this.label}else if("stackedBar"===this.parent.dataSeries[B].type){v=Math.abs(a-this.parent.convertValueToPixel(n[0].dataPoint.y));y=t=0;for(r=B;0<=r;r--)y+=n[r].dataPoint.y,t=Math.abs(a-this.parent.convertValueToPixel(y)),t<v&&(v=t,b=r);m=1===q.lineWidth%2?(this.parent.convertValueToPixel(y)<<0)+0.5:this.parent.convertValueToPixel(y)<<0;this.value=y;k.text=this.labelFormatter?this.labelFormatter({chart:this.chart,axis:this.parent.options,crosshair:this.options,value:x.dataPoint.y}):s(this.options.label)?
ca(s(c)?x.dataPoint.y:c,this.valueFormatString,this.chart._cultureInfo):this.label}else if("stackedBar100"===this.parent.dataSeries[B].type){v=Math.abs(a-this.parent.convertValueToPixel(n[0].dataPoint.y));z=y=t=0;for(r=B;0<=r;r--)y+=n[r].dataPoint.y,z=n[r].dataPoint.x.getTime?n[r].dataPoint.x.getTime():n[r].dataPoint.x,z=100*(y/n[r].dataSeries.plotUnit.dataPointYSums[z]),t=Math.abs(a-this.parent.convertValueToPixel(z)),t<v&&(v=t,b=r);m=1===q.lineWidth%2?(this.parent.convertValueToPixel(z)<<0)+0.5:
this.parent.convertValueToPixel(z)<<0;this.value=z;k.text=this.labelFormatter?this.labelFormatter({chart:this.chart,axis:this.parent.options,crosshair:this.options,value:z}):s(this.options.label)?ca(s(c)?z:c,this.valueFormatString,this.chart._cultureInfo):this.label}else m=1===q.lineWidth%2?(this.parent.convertValueToPixel(x.dataPoint.y)<<0)+0.5:this.parent.convertValueToPixel(x.dataPoint.y)<<0,this.value=x.dataPoint.y,k.text=this.labelFormatter?this.labelFormatter({chart:this.chart,axis:this.parent.options,
crosshair:this.options,value:x.dataPoint.y}):s(this.options.label)?ca(s(c)?x.dataPoint.y:c,this.valueFormatString,this.chart._cultureInfo):this.label;b=e=m;f=this.chart.plotArea.y1;h=this.chart.plotArea.y2;this.bounds={x1:b-p/2,y1:f,x2:e+p/2,y2:h};k.x=b-k.measureText().width/2;k.x+k.width>this.chart.bounds.x2?k.x=this.chart.bounds.x2-k.width:k.x<this.chart.bounds.x1&&(k.x=this.chart.bounds.x1);k.y=this.parent.lineCoordinates.y2+("top"===this.parent._position?-k.height+this.parent.tickLength:k.fontSize/
...
n)if(this.parent.labels[r])z=!0;else{z=!1;break}if(z){if("axisX"===this.parent.type)for(r=this.parent.convertPixelToValue({y:d}),v=null,B=0;B<this.parent.dataSeries.length;B++)(v=this.parent.dataSeries[B].getDataPointAtX(r,!0))&&0<=v.index&&(k.text=this.labelFormatter?this.labelFormatter({chart:this.chart,axis:this.parent.options,crosshair:this.options,value:x.dataPoint.x}):s(this.options.label)?v.dataPoint.label:this.label)}else k.text="dateTime"!==this.parent.valueType||this.parent.logarithmic?
this.labelFormatter?this.labelFormatter({chart:this.chart,axis:this.parent.options,crosshair:this.options,value:x.dataPoint.x}):s(this.options.label)?ca(x.dataPoint.x,this.valueFormatString,this.chart._cultureInfo):this.label:this.labelFormatter?this.labelFormatter({chart:this.chart,axis:this.parent.options,crosshair:this.options,value:x.dataPoint.x}):s(this.options.label)?Aa(x.dataPoint.x,this.valueFormatString,this.chart._cultureInfo):this.label;this.value=x.dataPoint.x;k.y=h+k.fontSize/2-k.measureText().height/
...
this.parent.dataSeries[B].getDataPointAtX(r,!0))&&0<=v.index&&(v.dataSeries=this.parent.dataSeries[B],null!==v.dataPoint.y&&v.dataSeries.visible&&n.push(v));if(0===n.length)return;n.sort(function(a,b){return a.distance-b.distance});x=n[0];b=e=m=1===q.lineWidth%2?(this.parent.convertValueToPixel(x.dataPoint.x)<<0)+0.5:this.parent.convertValueToPixel(x.dataPoint.x)<<0;f=this.chart.plotArea.y1;h=this.chart.plotArea.y2;this.bounds={x1:b-p/2,y1:f,x2:e+p/2,y2:h};z=!1;if(this.parent.labels)for(n=Math.ceil(this.parent.interval),
r=0;r<this.parent.viewportMaximum;r+=n)if(this.parent.labels[r])z=!0;else{z=!1;break}if(z){if("axisX"===this.parent.type)for(r=this.parent.convertPixelToValue({x:a}),v=null,B=0;B<this.parent.dataSeries.length;B++)(v=this.parent.dataSeries[B].getDataPointAtX(r,!0))&&0<=v.index&&(k.text=this.labelFormatter?this.labelFormatter({chart:this.chart,axis:this.parent.options,crosshair:this.options,value:x.dataPoint.x}):s(this.options.label)?v.dataPoint.label:this.label)}else k.text="dateTime"!==this.parent.valueType||
this.parent.logarithmic?this.labelFormatter?this.labelFormatter({chart:this.chart,axis:this.parent.options,crosshair:this.options,value:x.dataPoint.x}):s(this.options.label)?ca(x.dataPoint.x,this.valueFormatString,this.chart._cultureInfo):this.label:this.labelFormatter?this.labelFormatter({chart:this.chart,axis:this.parent.options,crosshair:this.options,value:x.dataPoint.x}):s(this.options.label)?Aa(x.dataPoint.x,this.valueFormatString,this.chart._cultureInfo):this.label;this.value=x.dataPoint.x;
...
for(B=0;B<this.parent.dataSeries.length;B++)(v=this.parent.dataSeries[B].getDataPointAtX(r,!0))&&0<=v.index&&(v.dataSeries=this.parent.dataSeries[B],null!==v.dataPoint.y&&v.dataSeries.visible&&n.push(v));if(0===n.length)return;n.sort(function(a,b){return a.distance-b.distance});B=0;if("rangeColumn"===n[0].dataSeries.type||"rangeArea"===n[0].dataSeries.type||"error"===n[0].dataSeries.type||"rangeSplineArea"===n[0].dataSeries.type||"candlestick"===n[0].dataSeries.type||"ohlc"===n[0].dataSeries.type||
"boxAndWhisker"===n[0].dataSeries.type)for(v=Math.abs(d-this.parent.convertValueToPixel(n[0].dataPoint.y[0])),r=t=0;r<n.length;r++)if(n[r].dataPoint.y&&n[r].dataPoint.y.length)for(x=0;x<n[r].dataPoint.y.length;x++)t=Math.abs(d-this.parent.convertValueToPixel(n[r].dataPoint.y[x])),t<v&&(v=t,B=r);else t=Math.abs(d-this.parent.convertValueToPixel(n[r].dataPoint.y)),t<v&&(v=t,B=r);else if("stackedColumn"===n[0].dataSeries.type||"stackedArea"===n[0].dataSeries.type)for(v=Math.abs(d-this.parent.convertValueToPixel(n[0].dataPoint.y)),
r=y=t=0;r<n.length;r++)if(n[r].dataPoint.y&&n[r].dataPoint.y.length)for(x=0;x<n[r].dataPoint.y.length;x++)t=Math.abs(d-this.parent.convertValueToPixel(n[r].dataPoint.y[x])),t<v&&(v=t,B=r);else y+=n[r].dataPoint.y,t=Math.abs(d-this.parent.convertValueToPixel(y)),t<v&&(v=t,B=r);else if("stackedColumn100"===n[0].dataSeries.type||"stackedArea100"===n[0].dataSeries.type)for(v=Math.abs(d-this.parent.convertValueToPixel(n[0].dataPoint.y)),r=z=y=t=0;r<n.length;r++)if(n[r].dataPoint.y&&n[r].dataPoint.y.length)for(x=
0;x<n[r].dataPoint.y.length;x++)t=Math.abs(d-this.parent.convertValueToPixel(n[r].dataPoint.y[x])),t<v&&(v=t,B=r);else y+=n[r].dataPoint.y,z=n[r].dataPoint.x.getTime?n[r].dataPoint.x.getTime():n[r].dataPoint.x,z=100*(y/n[r].dataSeries.plotUnit.dataPointYSums[z]),t=Math.abs(d-this.parent.convertValueToPixel(z)),t<v&&(v=t,B=r);else for(v=Math.abs(d-this.parent.convertValueToPixel(n[0].dataPoint.y)),r=t=0;r<n.length;r++)if(n[r].dataPoint.y&&n[r].dataPoint.y.length)for(x=0;x<n[r].dataPoint.y.length;x++)t=
Math.abs(d-this.parent.convertValueToPixel(n[r].dataPoint.y[x])),t<v&&(v=t,B=r);else t=Math.abs(d-this.parent.convertValueToPixel(n[r].dataPoint.y)),t<v&&(v=t,B=r);x=n[B];b=0;if("rangeColumn"===this.parent.dataSeries[B].type||"rangeArea"===this.parent.dataSeries[B].type||"error"===this.parent.dataSeries[B].type||"rangeSplineArea"===this.parent.dataSeries[B].type||"candlestick"===this.parent.dataSeries[B].type||"ohlc"===this.parent.dataSeries[B].type||"boxAndWhisker"===this.parent.dataSeries[B].type){v=
Math.abs(d-this.parent.convertValueToPixel(x.dataPoint.y[0]));for(r=t=0;r<x.dataPoint.y.length;r++)t=Math.abs(d-this.parent.convertValueToPixel(x.dataPoint.y[r])),t<v&&(v=t,b=r);w=1===q.lineWidth%2?(this.parent.convertValueToPixel(x.dataPoint.y[b])<<0)+0.5:this.parent.convertValueToPixel(x.dataPoint.y[b])<<0;k.text=this.labelFormatter?this.labelFormatter({chart:this.chart,axis:this.parent.options,crosshair:this.options,value:x.dataPoint.y[b]}):s(this.options.label)?ca(s(c)?x.dataPoint.y[b]:c,this.valueFormatString,
this.chart._cultureInfo):this.label;this.value=x.dataPoint.y[b]}else if("stackedColumn"===this.parent.dataSeries[B].type||"stackedArea"===this.parent.dataSeries[B].type){v=Math.abs(d-this.parent.convertValueToPixel(n[0].dataPoint.y));y=t=0;for(r=B;0<=r;r--)y+=n[r].dataPoint.y,t=Math.abs(d-this.parent.convertValueToPixel(y)),t<v&&(v=t,b=r);w=1===q.lineWidth%2?(this.parent.convertValueToPixel(y)<<0)+0.5:this.parent.convertValueToPixel(y)<<0;k.text=this.labelFormatter?this.labelFormatter({chart:this.chart,
axis:this.parent.options,crosshair:this.options,value:x.dataPoint.y}):s(this.options.label)?ca(s(c)?x.dataPoint.y:c,this.valueFormatString,this.chart._cultureInfo):this.label;this.value=y}else if("stackedColumn100"===this.parent.dataSeries[B].type||"stackedArea100"===this.parent.dataSeries[B].type){v=Math.abs(d-this.parent.convertValueToPixel(n[0].dataPoint.y));y=t=0;for(r=B;0<=r;r--)y+=n[r].dataPoint.y,z=n[r].dataPoint.x.getTime?n[r].dataPoint.x.getTime():n[r].dataPoint.x,z=100*(y/n[r].dataSeries.plotUnit.dataPointYSums[z]),
t=Math.abs(d-this.parent.convertValueToPixel(z)),t<v&&(v=t,b=r);w=1===q.lineWidth%2?(this.parent.convertValueToPixel(z)<<0)+0.5:this.parent.convertValueToPixel(z)<<0;k.text=this.labelFormatter?this.labelFormatter({chart:this.chart,axis:this.parent.options,crosshair:this.options,value:z}):s(this.options.label)?ca(s(c)?z:c,this.valueFormatString,this.chart._cultureInfo):this.label;this.value=z}else"waterfall"===this.parent.dataSeries[B].type?(w=1===q.lineWidth%2?(this.parent.convertValueToPixel(x.dataSeries.dataPointEOs[x.index].cumulativeSum)<<
0)+0.5:this.parent.convertValueToPixel(x.dataSeries.dataPointEOs[x.index].cumulativeSum)<<0,k.text=this.labelFormatter?this.labelFormatter({chart:this.chart,axis:this.parent.options,crosshair:this.options,value:x.dataSeries.dataPointEOs[x.index].cumulativeSum}):s(this.options.label)?ca(s(c)?x.dataSeries.dataPointEOs[x.index].cumulativeSum:c,this.valueFormatString,this.chart._cultureInfo):this.label,this.value=x.dataSeries.dataPointEOs[x.index].cumulativeSum):(w=1===q.lineWidth%2?(s(a)?d:this.parent.convertValueToPixel(x.dataPoint.y)<<
0)+0.5:s(a)?d:this.parent.convertValueToPixel(x.dataPoint.y)<<0,k.text=this.labelFormatter?this.labelFormatter({chart:this.chart,axis:this.parent.options,crosshair:this.options,value:s(c)?x.dataPoint.y:c}):s(this.options.label)?ca(s(c)?x.dataPoint.y:c,this.valueFormatString,this.chart._cultureInfo):this.label,this.value=x.dataPoint.y);f=h=w;b=this.chart.plotArea.x1;e=this.chart.plotArea.x2;this.bounds={x1:b,y1:f-p/2,x2:e,y2:h+p/2};k.y=h+k.fontSize/2-k.measureText().height/2+2;k.y-k.fontSize/2<this.chart.bounds.y1?
...
this.parent._position||"right"===this.parent._position){z=!1;if(this.parent.labels)for(n=Math.ceil(this.parent.interval),r=0;r<this.parent.viewportMaximum;r+=n)if(this.parent.labels[r])z=!0;else{z=!1;break}if(z){if("axisX"===this.parent.type)for(r=this.parent.convertPixelToValue({y:d}),v=null,B=0;B<this.parent.dataSeries.length;B++)(v=this.parent.dataSeries[B].getDataPointAtX(r,!0))&&0<=v.index&&(k.text=this.labelFormatter?this.labelFormatter({chart:this.chart,axis:this.parent.options,crosshair:this.options,
value:s(c)?this.parent.convertPixelToValue(a):c}):s(this.options.label)?v.dataPoint.label:this.label)}else k.text="dateTime"!==this.parent.valueType||this.parent.logarithmic?this.labelFormatter?this.labelFormatter({chart:this.chart,axis:this.parent.options,crosshair:this.options,value:s(c)?this.parent.convertPixelToValue(d):c}):s(this.options.label)?ca(s(c)?this.parent.convertPixelToValue(d):c,this.valueFormatString,this.chart._cultureInfo):this.label:this.labelFormatter?this.labelFormatter({chart:this.chart,
axis:this.parent.options,crosshair:this.options,value:s(c)?this.parent.convertPixelToValue(d):c}):s(this.options.label)?Aa(s(c)?this.parent.convertPixelToValue(d):c,this.valueFormatString,this.chart._cultureInfo):this.label;k.y=d+k.fontSize/2-k.measureText().height/2+2;k.y-k.fontSize/2<this.chart.bounds.y1?k.y=this.chart.bounds.y1+k.fontSize/2+2:k.y+k.measureText().height-k.fontSize/2>this.chart.bounds.y2&&(k.y=this.chart.bounds.y2-k.measureText().height+k.fontSize/2);"left"===this.parent._position?
k.x=this.parent.lineCoordinates.x1-k.measureText().width:"right"===this.parent._position&&(k.x=this.parent.lineCoordinates.x2)}else{if("bottom"===this.parent._position||"top"===this.parent._position)k.text=this.labelFormatter?this.labelFormatter({chart:this.chart,axis:this.parent.options,crosshair:this.options,value:s(c)?this.parent.convertPixelToValue(a):c}):s(this.options.label)?ca(s(c)?this.parent.convertPixelToValue(a):c,this.valueFormatString,this.chart._cultureInfo):this.label,k.x=b-k.measureText().width/
...
this.labelFormatter?this.labelFormatter({chart:this.chart,axis:this.parent.options,crosshair:this.options,value:s(c)?0<this.parent.dataSeries.length?this.parent.convertPixelToValue(a):"":c}):s(this.options.label)?ca(s(c)?this.parent.convertPixelToValue(a):c,this.valueFormatString,this.chart._cultureInfo):this.label:this.labelFormatter?this.labelFormatter({chart:this.chart,axis:this.parent.options,crosshair:this.options,value:s(c)?this.parent.convertPixelToValue(a):c}):s(this.options.label)?Aa(s(c)?
...
this.labelFormatter?this.labelFormatter({chart:this.chart,axis:this.parent.options,crosshair:this.options,value:s(c)?this.parent.convertPixelToValue(d):c}):s(this.options.label)?ca(s(c)?this.parent.convertPixelToValue(d):c,this.valueFormatString,this.chart._cultureInfo):this.label,k.y=d+k.fontSize/2-k.measureText().height/2+2,k.y-k.fontSize/2<this.chart.bounds.y1?k.y=this.chart.bounds.y1+k.fontSize/2+2:k.y+k.measureText().height-k.fontSize/2>this.chart.bounds.y2&&(k.y=this.chart.bounds.y2-k.measureText().height+
...
"right"===this.parent._position)this._updatedValue=this.parent.convertPixelToValue(w);this._textBlock=k;s(c)||this.renderLabel();q.globalAlpha=g};ba.prototype.renderLabel=function(){s(this._textBlock)||(s(this._textBlock.text)||!("number"===typeof this._textBlock.text.valueOf()||0<this._textBlock.text.length)||this._hidden)||this._textBlock.render(!0)};oa(U,G);U.prototype._initialize=function(){this.updateOption("updated");this.updateOption("hidden");if(this.enabled){this.container=document.createElement("div");
...
dataSeriesIndex:f[b].dataSeries._index});d={chart:this.chart,toolTip:this.options,content:c,entries:d};this._entries=f;this.dispatchEvent("updated",d,this)}}else this.hide(),this.enabled&&this.dispatchEvent("hidden",{chart:this.chart,toolTip:this},this)}};U.prototype.highlightObjects=function(a){var d=this.chart.overlaidCanvasCtx;if(s(this.chart.clearedOverlayedCanvas)||"toolTip"===this.chart.clearedOverlayedCanvas)this.chart.resetOverlayedCanvas(),d.clearRect(0,0,this.chart.width,this.chart.height),
...
la);c.restore()}},easing:{linear:function(a,d,c,b){return c*a/b+d},easeOutQuad:function(a,d,c,b){return-c*(a/=b)*(a-2)+d},easeOutQuart:function(a,d,c,b){return-c*((a=a/b-1)*a*a*a-1)+d},easeInQuad:function(a,d,c,b){return c*(a/=b)*a+d},easeInQuart:function(a,d,c,b){return c*(a/=b)*a*a*a+d}}},W={drawMarker:function(a,d,c,b,e,f,h,m){if(c){var s=1;c.fillStyle=f?f:"#000000";c.strokeStyle=h?h:"#000000";c.lineWidth=m?m:0;c.setLineDash&&c.setLineDash(J("solid",m));"circle"===b?(c.moveTo(a,d),c.beginPath(),
...
"black",c.stroke(),c.globalAlpha=s)),c.beginPath()):"cross"===b&&(c.strokeStyle=f,c.lineWidth=e/4,c.beginPath(),c.moveTo(a-e/2,d-e/2),c.lineTo(a+e/2,d+e/2),c.stroke(),c.moveTo(a+e/2,d-e/2),c.lineTo(a-e/2,d+e/2),c.stroke())}},drawMarkers:function(a){for(var d=0;d<a.length;d++){var c=a[d];W.drawMarker(c.x,c.y,c.ctx,c.type,c.size,c.color,c.borderColor,c.borderThickness)}}};return m}();B.version="v3.7.16 GA";window.CanvasJS&&(B&&!window.CanvasJS.Chart)&&(window.CanvasJS.Chart=B)})();
